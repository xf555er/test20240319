...
public class CoreDocumentImpl extends ParentNode implements Document {
   ...
   protected void cloneNode(CoreDocumentImpl var1, boolean var2) {
      ...
      if (var2) {
         ...
         if (this.identifiers != null) {
            var3 = new HashMap();
            Iterator var4 = this.identifiers.entrySet().iterator();
         ...
         for(ChildNode var8 = this.firstChild; var8 != null; var8 = var8.nextSibling) {
            var1.appendChild(var1.importNode(var8, true, true, var3));
         }
      }
   ...
   public Node renameNode(Node var1, String var2, String var3) throws DOMException {
      ...
      if (this.errorChecking && var1.getOwnerDocument() != this && var1 != this) {
         var10 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "WRONG_DOCUMENT_ERR", (Object[])null);
         throw new DOMException((short)4, var10);
      } else {
         switch (var1.getNodeType()) {
            case 1:
               ElementImpl var9 = (ElementImpl)var1;
               if (var9 instanceof ElementNSImpl) {
                  if (this.canRenameElements(var2, var3, var9)) {
                     ((ElementNSImpl)var9).rename(var2, var3);
                     this.callUserDataHandlers(var9, (Node)null, (short)4);
                  } else {
                     var9 = this.replaceRenameElement(var9, var2, var3);
                  }
               } else if (var2 == null && this.canRenameElements((String)null, var3, var9)) {
                  var9.rename(var3);
                  this.callUserDataHandlers(var9, (Node)null, (short)4);
               } else {
                  var9 = this.replaceRenameElement(var9, var2, var3);
               ...
               this.renamedElement((Element)var1, var9);
               return var9;
            case 2:
               Object var4 = (AttrImpl)var1;
               ...
               if (var1 instanceof AttrNSImpl) {
                  ...
                  AttrNSImpl var6 = (AttrNSImpl)this.createAttributeNS(var2, var3);
                  this.copyEventListeners((NodeImpl)var4, var6);
                  Hashtable var7 = this.removeUserDataTable((Node)var4);

                  for(Node var8 = ((AttrImpl)var4).getFirstChild(); var8 != null; var8 = ((AttrImpl)var4).getFirstChild()) {
   ...
   private ElementImpl replaceRenameElement(ElementImpl var1, String var2, String var3) {
      ElementNSImpl var4 = (ElementNSImpl)this.createElementNS(var2, var3);
      this.copyEventListeners(var1, var4);
      Hashtable var5 = this.removeUserDataTable(var1);
      Node var6 = var1.getParentNode();
      Node var7 = var1.getNextSibling();
      if (var6 != null) {
         var6.removeChild(var1);
      }

      for(Node var8 = var1.getFirstChild(); var8 != null; var8 = var1.getFirstChild()) {
         var1.removeChild(var8);
         var4.appendChild(var8);
      }

      var4.moveSpecifiedAttributes(var1);
      this.setUserDataTable(var4, var5);
      this.callUserDataHandlers(var1, var4, (short)4);
      if (var6 != null) {
         var6.insertBefore(var4, var7);
      }
   ...
   public Node importNode(Node var1, boolean var2) throws DOMException {
      return this.importNode(var1, var2, false, (HashMap)null);
   }

   private Node importNode(Node var1, boolean var2, boolean var3, HashMap var4) throws DOMException {
      Object var5 = null;
      Hashtable var6 = null;
      ...
      switch (var7) {
         ...
         case 10:
            ...
            var18.setInternalSubset(var15.getInternalSubset());
   ...
   public Node adoptNode(Node var1) {
      ...
      if (var1 == null) {
         ...
         if (var1 != null && var1.getOwnerDocument() != null) {
            ...
            } else if (var5 instanceof DeferredDOMImplementationImpl) {
               this.undeferChildren(var2);
            }
         }
   ...
   protected void undeferChildren(Node var1) {
      Node var6;
      label51:
      for(Node var2 = var1; null != var1; var1 = var6) {
         ...
         if (var3 != null) {
            ...
            for(int var5 = 0; var5 < var4; ++var5) {
               this.undeferChildren(var3.item(var5));
            }
         }

         var6 = null;
         var6 = var1.getFirstChild();

         do {
            do {
               if (null != var6 || var2.equals(var1)) {
                  continue label51;
               }

               var6 = var1.getNextSibling();
            } while(null != var6);
   ...
   protected void callUserDataHandlers(Node var1, Node var2, short var3) {
      if (this.userData != null) {
         if (var1 instanceof NodeImpl) {
   ...
   void callUserDataHandlers(Node var1, Node var2, short var3, Hashtable var4) {
      if (var4 != null && !var4.isEmpty()) {
         ...
         while(var5.hasNext()) {
            ...
            ParentNode.UserDataRecord var8 = (ParentNode.UserDataRecord)var6.getValue();
            if (var8.fHandler != null) {
               var8.fHandler.handle(var3, var7, var8.fData, var1, var2);
            }
         }
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Map var2 = this.userData;
      Map var3 = this.nodeTable;

      try {
         if (var2 != null) {
            this.userData = new Hashtable(var2);
         }

         if (var3 != null) {
            this.nodeTable = new Hashtable(var3);
         }
