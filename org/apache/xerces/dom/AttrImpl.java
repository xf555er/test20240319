...
public class AttrImpl extends NodeImpl implements Attr, TypeInfo {
   ...
   public void setValue(String var1) {
      ...
      if (var2.errorChecking && this.isReadOnly()) {
         String var7 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NO_MODIFICATION_ALLOWED_ERR", (Object[])null);
         throw new DOMException((short)7, var7);
      } else {
         ...
         if (this.value != null) {
            if (var2.getMutationEvents()) {
               if (this.hasStringValue()) {
                  ...
                  var5 = (TextImpl)var2.createTextNode((String)this.value);
                  this.value = var5;
                  var5.isFirstChild(true);
                  var5.previousSibling = var5;
                  var5.ownerNode = this;
                  var5.isOwned(true);
                  this.hasStringValue(false);
                  this.internalRemoveChild(var5, true);
               } else {
                  var4 = this.getValue();
               ...
               if (this.hasStringValue()) {
                  ...
                  var4 = this.getValue();
                  ChildNode var6 = (ChildNode)this.value;
                  var6.previousSibling = null;
                  var6.isFirstChild(false);
                  var6.ownerNode = var2;
               }
         ...
         if (var2.getMutationEvents()) {
            if (var5 == null) {
               var5 = (TextImpl)var2.createTextNode(var1);
            } else {
               var5.data = var1;
            }

            this.internalInsertBefore(var5, (Node)null, true);
            this.hasStringValue(false);
