...
public class TreeWalkerImpl implements TreeWalker {
   ...
   public TreeWalkerImpl(Node var1, int var2, NodeFilter var3, boolean var4) {
      ...
      this.fRoot = var1;
      this.fUseIsSameNode = this.useIsSameNode(var1);
   ...
   Node getParentNode(Node var1) {
      if (var1 != null && !this.isSameNode(var1, this.fRoot)) {
   ...
   Node getNextSibling(Node var1, Node var2) {
      if (var1 != null && !this.isSameNode(var1, var2)) {
         Node var3 = var1.getNextSibling();
         short var4;
         if (var3 == null) {
            var3 = var1.getParentNode();
            if (var3 != null && !this.isSameNode(var3, var2)) {
   ...
   private boolean useIsSameNode(Node var1) {
      if (var1 instanceof NodeImpl) {
         return false;
      } else {
         Document var2 = var1.getNodeType() == 9 ? (Document)var1 : var1.getOwnerDocument();
         return var2 != null && var2.getImplementation().hasFeature("Core", "3.0");
      }
   }

   private boolean isSameNode(Node var1, Node var2) {
      return this.fUseIsSameNode ? var1.isSameNode(var2) : var1 == var2;
   }
}
