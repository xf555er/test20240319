   ...
   protected String getEntityRefValue() {
      ...
      if (this.firstChild != null) {
         if (this.firstChild.getNodeType() == 5) {
            var1 = ((EntityReferenceImpl)this.firstChild).getEntityRefValue();
         } else {
            if (this.firstChild.getNodeType() != 3) {
               return null;
            }

            var1 = this.firstChild.getNodeValue();
         }
         ...
         if (this.firstChild.nextSibling == null) {
            ...
            for(ChildNode var3 = this.firstChild.nextSibling; var3 != null; var3 = var3.nextSibling) {
