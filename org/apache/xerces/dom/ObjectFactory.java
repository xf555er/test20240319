...
final class ObjectFactory {
   ...
   static Object createObject(String var0, String var1, String var2) throws ConfigurationError {
      ...
      if (var1 == null) {
         ...
         Class var53 = class$org$apache$xerces$dom$ObjectFactory == null ? (class$org$apache$xerces$dom$ObjectFactory = class$("org.apache.xerces.dom.ObjectFactory")) : class$org$apache$xerces$dom$ObjectFactory;
         synchronized(var53) {
            boolean var8 = false;
   ...
   static ClassLoader findClassLoader() throws ConfigurationError {
      ...
      ClassLoader var3 = (class$org$apache$xerces$dom$ObjectFactory == null ? (class$org$apache$xerces$dom$ObjectFactory = class$("org.apache.xerces.dom.ObjectFactory")) : class$org$apache$xerces$dom$ObjectFactory).getClassLoader();
   ...
   static Class findProviderClass(String var0, ClassLoader var1, boolean var2) throws ClassNotFoundException, ConfigurationError {
      ...
      if (var1 == null) {
         ...
         try {
            ...
            ClassLoader var6 = (class$org$apache$xerces$dom$ObjectFactory == null ? (class$org$apache$xerces$dom$ObjectFactory = class$("org.apache.xerces.dom.ObjectFactory")) : class$org$apache$xerces$dom$ObjectFactory).getClassLoader();
            if (var6 == null) {
               var8 = Class.forName(var0);
            } else {
               if (var1 == var6) {
   ...
   private static Object findJarServiceProvider(String var0) throws ConfigurationError {
      ...
      if (var2 == null) {
         ClassLoader var4 = (class$org$apache$xerces$dom$ObjectFactory == null ? (class$org$apache$xerces$dom$ObjectFactory = class$("org.apache.xerces.dom.ObjectFactory")) : class$org$apache$xerces$dom$ObjectFactory).getClassLoader();
         if (var3 != var4) {
            var3 = var4;
