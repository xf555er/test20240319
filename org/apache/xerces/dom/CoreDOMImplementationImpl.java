...
public class CoreDOMImplementationImpl implements DOMImplementation, DOMImplementationLS {
   ...
   public LSParser createLSParser(short var1, String var2) throws DOMException {
      if (var1 == 1 && (var2 == null || "http://www.w3.org/2001/XMLSchema".equals(var2) || "http://www.w3.org/TR/REC-xml".equals(var2))) {
         return var2 != null && var2.equals("http://www.w3.org/TR/REC-xml") ? new DOMParserImpl("org.apache.xerces.parsers.XML11DTDConfiguration", var2) : new DOMParserImpl("org.apache.xerces.parsers.XIncludeAwareParserConfiguration", var2);
      } else {
   ...
   public LSSerializer createLSSerializer() {
      try {
         Class var1 = ObjectFactory.findProviderClass("org.apache.xml.serializer.dom3.LSSerializerImpl", ObjectFactory.findClassLoader(), true);
