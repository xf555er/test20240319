...
public class DeferredDocumentImpl extends DocumentImpl implements DeferredNode {
   ...
   public void setTypeInfo(int var1, Object var2) {
      int var3 = var1 >> 11;
      int var4 = var1 & 2047;
      this.setChunkValue(this.fNodeValue, var2, var3, var4);
   }
   ...
   public int setDeferredAttribute(int var1, String var2, String var3, String var4, boolean var5, boolean var6, Object var7) {
      ...
      int var14 = this.getChunkIndex(this.fNodeExtra, var9, var10);
      if (var6) {
         var14 |= 512;
         this.setChunkIndex(this.fNodeExtra, var14, var9, var10);
         String var15 = this.getChunkValue(this.fNodeValue, var9, var10);
         this.putIdentifier(var15, var1);
      }

      if (var7 != null) {
         int var18 = this.createNode((short)20);
         int var16 = var18 >> 11;
         int var17 = var18 & 2047;
         this.setChunkIndex(this.fNodeLastChild, var18, var9, var10);
      ...
      if (var1 == -1) {
         ...
         switch (var4) {
            ...
            case 10:
               ...
               this.docType = (DocumentTypeImpl)var5;
               break;
            case 11:
            case 13:
            case 14:
            ...
            if (var6 == 3) {
               ...
               if (var7 != -1 && this.getNodeType(var7, false) == 3) {
                  ...
                  for(int var9 = var8 - 1; var9 >= 0; --var9) {
                     this.fBufferStr.append((String)this.fStrChunks.get(var9));
                  }
               ...
               if (var7 != -1) {
                  ...
                  for(var8 = this.fStrChunks.size() - 1; var8 >= 0; --var8) {
                     this.fBufferStr.append((String)this.fStrChunks.get(var8));
                  }
   ...
   protected void synchronizeChildren() {
      ...
      boolean var1 = this.mutationEvents;
      ...
      for(int var4 = this.getLastChild(0); var4 != -1; var4 = this.getPrevSibling(var4)) {
         ...
         if (var6 == 1) {
            this.docElement = (ElementImpl)var5;
         } else if (var6 == 10) {
            this.docType = (DocumentTypeImpl)var5;
         }
      }
   ...
   private final int setChunkIndex(int[][] var1, int var2, int var3, int var4) {
      if (var2 == -1) {
         ...
         int[] var5 = var1[var3];
         if (var5 == null) {
            this.createChunk(var1, var3);
            var5 = var1[var3];
         }

         int var6 = var5[var4];
         if (var6 == -1) {
            int var10002 = var5[2048]++;
         }
   ...
   private final String setChunkValue(Object[][] var1, Object var2, int var3, int var4) {
      if (var2 == null) {
         ...
         String var6 = (String)var5[var4];
         if (var6 == null) {
            RefCount var7 = (RefCount)var5[2048];
            ++var7.fCount;
         }
