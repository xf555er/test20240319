...
public class RangeImpl implements Range {
   ...
   public Node getCommonAncestorContainer() {
      if (this.fDetach) {
         ...
         Object var6;
         for(var6 = null; var4 >= 0 && var5 >= 0 && var1.get(var4) == var3.get(var5); --var5) {
            var6 = var1.get(var4);
            --var4;
         }
   ...
   void receiveDeletedText(CharacterDataImpl var1, int var2, int var3) {
      if (var1 != null) {
         if (this.fDeleteNode != var1) {
            if (var1 == this.fStartContainer) {
   ...
   void receiveInsertedText(CharacterDataImpl var1, int var2, int var3) {
      if (var1 != null) {
         if (this.fInsertNode != var1) {
            if (var1 == this.fStartContainer && var2 < this.fStartOffset) {
               this.fStartOffset += var3;
            }

            if (var1 == this.fEndContainer && var2 < this.fEndOffset) {
               this.fEndOffset += var3;
            }
   ...
   void receiveReplacedText(CharacterDataImpl var1) {
      if (var1 != null) {
         if (var1 == this.fStartContainer) {
            this.fStartOffset = 0;
         }
   ...
   private DocumentFragment traverseSameContainer(int var1) {
      ...
      if (this.fStartOffset == this.fEndOffset) {
         ...
         short var3 = this.fStartContainer.getNodeType();
         if (var3 != 3 && var3 != 4 && var3 != 8 && var3 != 7) {
            Node var8 = this.getSelectedNode(this.fStartContainer, this.fStartOffset);

            Node var6;
            for(int var9 = this.fEndOffset - this.fStartOffset; var9 > 0; var8 = var6) {
               var6 = var8.getNextSibling();
               Node var7 = this.traverseFullySelected(var8, var1);
               if (var2 != null) {
            ...
            String var4 = this.fStartContainer.getNodeValue();
            String var5 = var4.substring(this.fStartOffset, this.fEndOffset);
            if (var1 != 2) {
            ...
            if (var1 == 3) {
               ...
               if (var3 == 3) {
                  var2.appendChild(this.fDocument.createTextNode(var5));
               } else if (var3 == 4) {
                  var2.appendChild(this.fDocument.createCDATASection(var5));
               } else if (var3 == 8) {
                  var2.appendChild(this.fDocument.createComment(var5));
               } else {
                  var2.appendChild(this.fDocument.createProcessingInstruction(this.fStartContainer.getNodeName(), var5));
               }
   ...
   private Node traverseNode(Node var1, boolean var2, boolean var3, int var4) {
      if (var2) {
         ...
         return var5 != 3 && var5 != 4 && var5 != 8 && var5 != 7 ? this.traversePartiallySelected(var1, var4) : this.traverseCharacterDataNode(var1, var3, var4);
      }
   }
   ...
   private Node traverseCharacterDataNode(Node var1, boolean var2, int var3) {
