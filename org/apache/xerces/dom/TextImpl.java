...
public class TextImpl extends CharacterDataImpl implements CharacterData, Text {
   ...
   public String getWholeText() {
      ...
      this.getWholeTextBackward(this.getPreviousSibling(), var1, this.getParentNode());
      String var2 = var1.toString();
      var1.setLength(0);
      this.getWholeTextForward(this.getNextSibling(), var1, this.getParentNode());
   ...
   public Text replaceWholeText(String var1) throws DOMException {
      ...
      if (var1 != null && var1.length() != 0) {
         ...
         for(Node var6 = ((Text)var3).getPreviousSibling(); var6 != null && (var6.getNodeType() == 3 || var6.getNodeType() == 4 || var6.getNodeType() == 5 && this.hasTextOnlyChildren(var6)); var6 = ((Node)var3).getPreviousSibling()) {
            var2.removeChild(var6);
         }

         for(Node var5 = ((Text)var3).getNextSibling(); var5 != null && (var5.getNodeType() == 3 || var5.getNodeType() == 4 || var5.getNodeType() == 5 && this.hasTextOnlyChildren(var5)); var5 = ((Node)var3).getNextSibling()) {
   ...
   public Text splitText(int var1) throws DOMException {
      if (this.isReadOnly()) {
         ...
         if (var1 >= 0 && var1 <= this.data.length()) {
            Text var2 = this.getOwnerDocument().createTextNode(this.data.substring(var1));
            this.setNodeValue(this.data.substring(0, var1));
            Node var3 = this.getParentNode();
            if (var3 != null) {
               var3.insertBefore(var2, this.nextSibling);
            }
