...
public abstract class NodeImpl implements Node, NodeList, EventTarget, Cloneable, Serializable {
   ...
   public short compareDocumentPosition(Node var1) throws DOMException {
      if (this == var1) {
         return 0;
      } else if (var1 != null && !(var1 instanceof NodeImpl)) {
         String var16 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_SUPPORTED_ERR", (Object[])null);
         ...
         if (var1.getNodeType() == 9) {
            ...
            var3 = var1.getOwnerDocument();
         }

         if (var2 != var3 && var2 != null && var3 != null) {
            int var18 = ((CoreDocumentImpl)var3).getNodeNumber();
            int var19 = ((CoreDocumentImpl)var2).getNodeNumber();
            return (short)(var18 > var19 ? 37 : 35);
         } else {
            Object var5 = this;
            Object var6 = var1;
            int var7 = 0;
            ...
            for(Node var17 = var1; var17 != null; var17 = var17.getParentNode()) {
               ++var8;
               if (var17 == this) {
                  return 20;
               }
            ...
            int var20;
            if (var5 != var6) {
               var20 = ((NodeImpl)var5).getNodeNumber();
               int var21 = ((NodeImpl)var6).getNodeNumber();
               return (short)(var20 > var21 ? 37 : 35);
            } else {
               if (var7 > var8) {
                  for(var20 = 0; var20 < var7 - var8; ++var20) {
                  ...
                  for(var20 = 0; var20 < var8 - var7; ++var20) {
               ...
               Node var22 = ((Node)var11).getParentNode();

               for(Node var14 = ((Node)var12).getParentNode(); var22 != var14; var14 = var14.getParentNode()) {
                  var11 = var22;
                  var12 = var14;
                  var22 = var22.getParentNode();
               }

               for(Node var15 = var22.getFirstChild(); var15 != null; var15 = var15.getNextSibling()) {
                  if (var15 == var12) {
                     return 2;
                  }
   ...
   public boolean isDefaultNamespace(String var1) {
      ...
      switch (var2) {
         case 1:
            String var8 = this.getNamespaceURI();
            ...
            if (var4 != null && var4.length() != 0) {
               ...
               NodeImpl var10 = (NodeImpl)this.getElementAncestor(this);
               if (var10 != null) {
                  return var10.isDefaultNamespace(var1);
               }
         ...
         case 12:
            return false;
         case 9:
            Element var3 = ((Document)this).getDocumentElement();
            return var3 != null ? var3.isDefaultNamespace(var1) : false;
      }
   }
   ...
   public String lookupPrefix(String var1) {
      if (var1 == null) {
         ...
         switch (var2) {
            ...
            case 9:
               Element var3 = ((Document)this).getDocumentElement();
               return var3 != null ? var3.lookupPrefix(var1) : null;
         }
      }
   }
   ...
   public String lookupNamespaceURI(String var1) {
      ...
      switch (var2) {
         case 1:
            String var11 = this.getNamespaceURI();
            String var4 = this.getPrefix();
            if (var11 != null) {
            ...
            if (this.hasAttributes()) {
               ...
               for(int var7 = 0; var7 < var6; ++var7) {
                  ...
                  var11 = var8.getNamespaceURI();
                  if (var11 != null && var11.equals("http://www.w3.org/2000/xmlns/")) {
                     String var9 = var8.getPrefix();
                     String var10 = var8.getNodeValue();
                     if (var1 == null && var8.getNodeName().equals("xmlns")) {
                        return var10.length() > 0 ? var10 : null;
                     }
            ...
            NodeImpl var13 = (NodeImpl)this.getElementAncestor(this);
            if (var13 != null) {
               return var13.lookupNamespaceURI(var1);
            }
         ...
         case 9:
            Element var3 = ((Document)this).getDocumentElement();
            return var3 != null ? var3.lookupNamespaceURI(var1) : null;
      }
   }
      ...
      if (this.hasAttributes()) {
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            ...
            if (var3 != null && var3.equals("http://www.w3.org/2000/xmlns/")) {
               String var9 = var8.getPrefix();
               String var10 = var8.getNodeValue();
               if (var8.getNodeName().equals("xmlns") || var9 != null && var9.equals("xmlns") && var10.equals(var1)) {
