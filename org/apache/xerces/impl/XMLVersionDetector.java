...
public class XMLVersionDetector {
   ...
   public short determineDocVersion(XMLInputSource var1) throws IOException {
      ...
      } catch (MalformedByteSequenceException var6) {
         this.fErrorReporter.reportError(var6.getDomain(), var6.getKey(), var6.getArguments(), (short)2, var6);
         return -1;
      } catch (CharConversionException var7) {
         this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "CharConversionFailure", (Object[])null, (short)2, var7);
         return -1;
