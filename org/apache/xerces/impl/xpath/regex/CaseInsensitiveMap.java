...
final class CaseInsensitiveMap {
   ...
   private static void buildCaseInsensitiveMap() {
      ...
      for(int var2 = 0; var2 < 65536; ++var2) {
         char var0 = Character.toLowerCase((char)var2);
         char var1 = Character.toUpperCase((char)var2);
         if (var0 != var1 || var0 != var2) {
            ...
            if (var0 != var2) {
               ...
               var5 = getMapping(var0);
               if (var5 != null) {
                  var3 = updateMap(var2, var3, var0, var5, LOWER_CASE_MATCH);
               }
            }
            ...
            if (var1 != var2) {
               ...
               if (var5 != null) {
                  var3 = updateMap(var2, var3, var1, var5, UPPER_CASE_MATCH);
               }
            }
