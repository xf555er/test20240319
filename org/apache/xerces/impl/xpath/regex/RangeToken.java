...
final class RangeToken extends Token implements Serializable {
   ...
   synchronized RangeToken getCaseInsensitiveToken() {
      if (this.icaseCache != null) {
         ...
         RangeToken var1 = this.type == 4 ? Token.createRange() : Token.createNRange();
         ...
         RangeToken var7 = this.type == 4 ? Token.createRange() : Token.createNRange();
         ...
         for(var4 = 0; var4 < var1.ranges.length; var4 += 2) {
            for(int var5 = var1.ranges[var4]; var5 <= var1.ranges[var4 + 1]; ++var5) {
               if (var5 > 65535) {
                  ...
                  char var6 = Character.toLowerCase((char)var5);
   ...
   private void createMap() {
      ...
      int var3 = this.ranges.length;

      for(int var4 = 0; var4 < var1; ++var4) {
         var2[var4] = 0;
      }

      for(int var5 = 0; var5 < this.ranges.length; var5 += 2) {
         int var6 = this.ranges[var5];
         int var7 = this.ranges[var5 + 1];
         if (var6 >= 256) {
            var3 = var5;
            break;
         }

         for(int var8 = var6; var8 <= var7 && var8 < 256; ++var8) {
            var2[var8 / 32] |= 1 << (var8 & 31);
         }
