...
class RegexParser {
   ...
   protected final boolean isSet(int var1) {
   ...
   Token processCondition() throws ParseException {
      if (this.offset + 1 >= this.regexlen) {
         ...
         if ('1' <= var3 && var3 <= '9') {
            var1 = var3 - 48;
            int var4 = var1;
            if (this.parennumber <= var1) {
               throw this.ex("parser.parse.2", this.offset);
            }

            while(this.offset + 1 < this.regexlen) {
               var3 = this.regex.charAt(this.offset + 1);
               if ('0' > var3 || var3 > '9') {
                  break;
               }

               var1 = var1 * 10 + (var3 - 48);
               if (var1 >= this.parennumber) {
                  break;
               }
            ...
            this.references.addElement(new ReferencePosition(var4, this.offset));
            ++this.offset;
         ...
         if (var6.type == 2) {
            ...
            var5 = var6.getChild(1);
            var6 = var6.getChild(0);
         }
         ...
         if (this.read() != 7) {
            ...
            this.next();
            return Token.createCondition(var1, var2, var6, var5);
         }
      }
   }
   ...
   Token processBackreference() throws ParseException {
      ...
      if (this.parennumber <= var1) {
         ...
         Token.StringToken var4 = Token.createBackReference(var2);
         this.hasBackReferences = true;
         if (this.references == null) {
            this.references = new Vector();
         }

         this.references.addElement(new ReferencePosition(var2, this.offset - 2));
         this.next();
         return var4;
      }
   }
   ...
   protected RangeToken parseCharacterClass(boolean var1) throws ParseException {
      ...
      int var5;
      for(boolean var6 = true; (var5 = this.read()) != 1 && (var5 != 0 || this.chardata != 93 || var6); var6 = false) {
         ...
         if (var5 == 10) {
            switch (var7) {
               ...
               case 112:
                  var13 = this.offset;
                  RangeToken var14 = this.processBacksolidus_pP(var7);
                  if (var14 == null) {
                     throw this.ex("parser.atom.5", var13);
                  }

                  var4.mergeRanges(var14);
                  var8 = true;
                  break;
               default:
            ...
            var13 = this.regex.indexOf(58, this.offset);
            if (var13 < 0) {
            ...
            String var11 = this.regex.substring(this.offset, var13);
            ...
            var8 = true;
            if (var13 + 1 >= this.regexlen || this.regex.charAt(var13 + 1) != ']') {
               throw this.ex("parser.cc.1", var13);
            }

            this.offset = var13 + 2;
         } else if (var5 == 24 && !var6) {
            if (var2) {
               var2 = false;
               if (var1) {
                  var4 = (RangeToken)Token.complementRanges(var4);
               } else {
            ...
            RangeToken var9 = this.parseCharacterClass(false);
            var4.subtractRanges(var9);
         ...
         if (!var8) {
            if (this.read() == 0 && this.chardata == 45) {
               ...
               if (var5 == 0 && this.chardata == 93) {
                  if (this.isSet(2) && var7 <= 65535) {
                     addCaseInsensitiveChar(var4, var7);
                  } else {
                  ...
                  if (this.isSet(2) && (var7 <= 65535 || var13 <= 65535)) {
                     addCaseInsensitiveCharRange(var4, var7, var13);
                  } else {
                     var4.addRange(var7, var13);
                  }
               }
            } else if (this.isSet(2) && var7 <= 65535) {
               addCaseInsensitiveChar(var4, var7);
            } else {
               var4.addRange(var7, var7);
            }
   ...
   protected static final void addCaseInsensitiveChar(RangeToken var0, int var1) {
      int[] var2 = CaseInsensitiveMap.get(var1);
      var0.addRange(var1, var1);
      if (var2 != null) {
         for(int var3 = 0; var3 < var2.length; var3 += 2) {
            var0.addRange(var2[var3], var2[var3]);
         }
      }

   }

   protected static final void addCaseInsensitiveCharRange(RangeToken var0, int var1, int var2) {
      int var4;
      int var5;
      if (var1 <= var2) {
         var4 = var1;
      ...
      var0.addRange(var4, var5);

      for(int var6 = var4; var6 <= var5; ++var6) {
         int[] var3 = CaseInsensitiveMap.get(var6);
         if (var3 != null) {
            for(int var7 = 0; var7 < var3.length; var7 += 2) {
               var0.addRange(var3[var7], var3[var7]);
            }
         }
      }
