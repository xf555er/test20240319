...
class Token implements Serializable {
   ...
   protected static RangeToken getRange(String var0, boolean var1) {
      if (categories.size() == 0) {
         ...
         synchronized(var2) {
            ...
            var3[35].addRange(65536, 1114111);
   ...
   static synchronized Token getGraphemePattern() {
      if (token_grapheme != null) {
         ...
         RangeToken var3 = createRange();
         var3.mergeRanges(getRange("M", true));
         var3.addRange(4448, 4607);
         var3.addRange(65438, 65439);
         ...
         var5.addChild(var3);
         ClosureToken var6 = createClosure(var5);
         ConcatToken var7 = createConcat(var4, var6);
         token_grapheme = var7;
         return token_grapheme;
      }
   }
