...
public class XPath {
   ...
   public XPath(String var1, SymbolTable var2, NamespaceContext var3) throws XPathException {
      ...
      this.fLocationPaths = this.parseExpression(var3);
   }
   ...
   private LocationPath[] parseExpression(NamespaceContext var1) throws XPathException {
      ...
      Scanner var3 = new Scanner(this.fSymbolTable) {
         protected void addToken(Tokens var1, int var2) throws XPathException {
            if (var2 != 6 && var2 != 11 && var2 != 21 && var2 != 4 && var2 != 9 && var2 != 10 && var2 != 22 && var2 != 23 && var2 != 36 && var2 != 35 && var2 != 8) {
               throw new XPathException("c-general-xpath");
            } else {
      ...
      if (!var5) {
         ...
         while(var2.hasMore()) {
            ...
            switch (var9) {
               ...
               case 23:
                  check(!var8);
                  var7.add(this.buildLocationPath(var6));
                  var8 = true;
                  break;
               case 35:
                  check(var8);
               ...
               case 36:
                  ...
                  var10 = new Step(new Axis((short)1), this.parseNodeTest(var2.nextToken(), var2, var1));
                  var6.addElement(var10);
                  var8 = false;
            }
         }
         ...
         check(!var8);
         var7.add(this.buildLocationPath(var6));
         return (LocationPath[])var7.toArray(new LocationPath[var7.size()]);
      }
   }
               ...
               if (var4 != var5) {
                  ...
                  switch (var11) {
                     ...
                     case 25:
                        ...
                        if (var16 || var10 == 58 && var4 + 1 < var5 && var3.charAt(var4 + 1) == ':') {
