...
public class XMLDocumentFragmentScannerImpl extends XMLScanner implements XMLDocumentScanner, XMLComponent, XMLEntityHandler {
   ...
   public void setInputSource(XMLInputSource var1) throws IOException {
      ...
      this.fEntityManager.startEntity("$fragment$", var1, false, true);
   }
   ...
   public void startEntity(String var1, XMLResourceIdentifier var2, String var3, Augmentations var4) throws XNIException {
      ...
      if (this.fStandalone && this.fEntityManager.isEntityDeclInExternalSubset(var1)) {
         this.reportFatalError("MSG_REFERENCE_TO_EXTERNALLY_DECLARED_ENTITY_WHEN_STANDALONE", new Object[]{var1});
      }

      if (this.fDocumentHandler != null && !this.fScanningAttribute && !var1.equals("[xml]")) {
   ...
   protected void scanXMLDeclOrTextDecl(boolean var1) throws IOException, XNIException {
      ...
      if (var3 != null && !this.fEntityScanner.fCurrentEntity.isEncodingExternallySpecified()) {
   ...
   protected void scanAttribute(XMLAttributes var1) throws IOException, XNIException {
      ...
      boolean var4 = this.scanAttributeValue(this.fTempString, this.fTempString2, this.fAttributeQName.rawname, this.fIsEntityDeclaredVC, this.fCurrentElement.rawname);
   ...
   protected int scanContent() throws IOException, XNIException {
      ...
      int var2 = this.fEntityScanner.scanContent((XMLString)var1);
      if (var2 == 13) {
         this.fEntityScanner.scanChar();
      ...
      while(true) {
         while(true) {
            ...
            if (!this.fEntityScanner.scanData("]]", this.fStringBuffer)) {
               ...
               for(var2 = 0; this.fEntityScanner.skipChar(93); ++var2) {
               }
               ...
               var2 = this.fEntityScanner.peekChar();
   ...
   protected void scanEntityReference() throws IOException, XNIException {
      ...
      if (var1 == null) {
         ...
         if (var1 == XMLScanner.fAmpSymbol) {
         ...
         } else if (this.fEntityManager.isUnparsedEntity(var1)) {
            this.reportFatalError("ReferenceToUnparsedEntity", new Object[]{var1});
         } else {
            if (!this.fEntityManager.isDeclaredEntity(var1)) {
            ...
            this.fEntityManager.startEntity(var1, false);
         }
   ...
   protected class FragmentContentDispatcher implements Dispatcher {
      public boolean dispatch(boolean var1) throws IOException, XNIException {
         try {
                  ...
                  case 16:
                     if (XMLDocumentFragmentScannerImpl.this.fEntityScanner.skipString("<?xml")) {
                        ...
                        if (!XMLDocumentFragmentScannerImpl.this.isValidNameChar(XMLDocumentFragmentScannerImpl.this.fEntityScanner.peekChar())) {
                           ...
                           String var3 = XMLDocumentFragmentScannerImpl.this.fSymbolTable.addSymbol(XMLDocumentFragmentScannerImpl.this.fStringBuffer.ch, XMLDocumentFragmentScannerImpl.this.fStringBuffer.offset, XMLDocumentFragmentScannerImpl.this.fStringBuffer.length);
            ...
            XMLDocumentFragmentScannerImpl.this.fErrorReporter.reportError(var5.getDomain(), var5.getKey(), var5.getArguments(), (short)2, var5);
            return false;
         } catch (CharConversionException var6) {
            XMLDocumentFragmentScannerImpl.this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "CharConversionFailure", (Object[])null, (short)2, var6);
            return false;
