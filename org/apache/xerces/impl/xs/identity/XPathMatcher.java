...
public class XPathMatcher {
   ...
   public void endElement(QName var1, XSTypeDefinition var2, boolean var3, Object var4, short var5, ShortList var6) {
      for(int var7 = 0; var7 < this.fLocationPaths.length; ++var7) {
         ...
         if (this.fNoMatchDepth[var7] > 0) {
            ...
            if (var8 >= var7 && this.fMatched[var8] != 0) {
               if ((this.fMatched[var8] & 3) == 3) {
   ...
   private static boolean matches(XPath.NodeTest var0, QName var1) {
      if (var0.type == 1) {
         return var0.name.equals(var1);
      } else if (var0.type == 4) {
         return var0.name.uri == var1.uri;
      } else {
         return true;
      }
   }
