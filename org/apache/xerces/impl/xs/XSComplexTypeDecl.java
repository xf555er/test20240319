...
public class XSComplexTypeDecl implements XSComplexTypeDefinition, TypeInfo {
   ...
   public XSCMValidator getContentModel(CMBuilder var1) {
      return this.getContentModel(var1, false);
   }

   public synchronized XSCMValidator getContentModel(CMBuilder var1, boolean var2) {
      if (this.fCMValidator == null) {
         if (var2) {
            if (this.fUPACMValidator == null) {
               this.fUPACMValidator = var1.getContentModel(this, true);
         ...
         this.fCMValidator = var1.getContentModel(this, false);
      }
   ...
   void appendTypeInfo(StringBuffer var1) {
      ...
      var1.append("Complex type name='").append(this.fTargetNamespace).append(',').append(this.getTypeName()).append("', ");
      if (this.fBaseType != null) {
         var1.append(" base type name='").append(this.fBaseType.getName()).append("', ");
      }

      var1.append(" content type='").append(var2[this.fContentType]).append("', ");
      var1.append(" isAbstract='").append(this.getAbstract()).append("', ");
      var1.append(" hasTypeId='").append(this.containsTypeID()).append("', ");
      var1.append(" final='").append(this.fFinal).append("', ");
      var1.append(" block='").append(this.fBlock).append("', ");
      if (this.fParticle != null) {
         var1.append(" particle='").append(this.fParticle.toString()).append("', ");
      }

      var1.append(" derivedBy='").append(var3[this.fDerivedBy]).append("'. ");
   }
   ...
   public boolean derivedFrom(String var1, String var2, short var3) {
      if (var2 == null) {
         ...
         Object var4;
         for(var4 = this; (!var2.equals(((XSTypeDefinition)var4).getName()) || (var1 != null || ((XSTypeDefinition)var4).getNamespace() != null) && (var1 == null || !var1.equals(((XSTypeDefinition)var4).getNamespace()))) && var4 != SchemaGrammar.fAnySimpleType && var4 != SchemaGrammar.fAnyType; var4 = ((XSTypeDefinition)var4).getBaseType()) {
         }
