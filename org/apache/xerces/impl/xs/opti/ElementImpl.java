...
public class ElementImpl extends DefaultElement {
   ...
   public String getAttributeNS(String var1, String var2) {
      for(int var3 = 0; var3 < this.attrs.length; ++var3) {
         if (this.attrs[var3].getLocalName().equals(var2) && nsEquals(this.attrs[var3].getNamespaceURI(), var1)) {
   ...
   public Attr getAttributeNodeNS(String var1, String var2) {
      for(int var3 = 0; var3 < this.attrs.length; ++var3) {
         if (this.attrs[var3].getName().equals(var2) && nsEquals(this.attrs[var3].getNamespaceURI(), var1)) {
   ...
   private static boolean nsEquals(String var0, String var1) {
      if (var0 == null) {
         return var1 == null;
      } else {
