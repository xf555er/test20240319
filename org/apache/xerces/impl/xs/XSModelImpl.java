...
public final class XSModelImpl extends AbstractList implements XSModel, XSNamespaceItemList {
   ...
   public XSModelImpl(SchemaGrammar[] var1, short var2) {
      ...
      for(var12 = 0; var12 < var3; ++var12) {
         var9 = var6[var12];
         Vector var11 = var9.getImportedGrammars();

         for(int var13 = var11 == null ? -1 : var11.size() - 1; var13 >= 0; --var13) {
            SchemaGrammar var17 = (SchemaGrammar)var11.elementAt(var13);
      ...
      for(var12 = 0; var12 < var3; ++var12) {
         this.fGrammarMap.put(null2EmptyString(this.fNamespaces[var12]), this.fGrammarList[var12]);
         if (this.fGrammarList[var12].hasIDConstraints()) {
            var18 = true;
         }
      }
   ...
   private SymbolHash buildSubGroups_Org() {
      ...
      for(int var8 = 0; var8 < var4; ++var8) {
         XSElementDecl var6 = (XSElementDecl)var3.item(var8);
         XSElementDecl[] var7 = var1.getSubstitutionGroup(var6);
         var5.put(var6, var7.length > 0 ? new XSObjectListImpl(var7, var7.length) : XSObjectListImpl.EMPTY_LIST);
      }
