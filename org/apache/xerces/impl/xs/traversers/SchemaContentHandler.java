   ...
   private void addNamespaceDeclarations(int var1) {
      ...
      for(int var7 = 0; var7 < var1; ++var7) {
         ...
         if (var5.length() > 0) {
            ...
            this.fStringBuffer.append(var5);
            var4 = this.fSymbolTable.addSymbol(this.fStringBuffer.ch, this.fStringBuffer.offset, this.fStringBuffer.length);
         } else {
         ...
         this.fAttributes.addAttribute(this.fAttributeQName, XMLSymbols.fCDATASymbol, var6 != null ? var6 : XMLSymbols.EMPTY_STRING);
      }
