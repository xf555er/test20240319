...
class XSDocumentInfo {
   ...
   XSDocumentInfo(Element var1, XSAttributeChecker var2, SymbolTable var3) throws XMLSchemaException {
      ...
      this.fNamespaceSupport = new SchemaNamespaceSupport(var1, var3);
   ...
   public String toString() {
      ...
      if (this.fTargetNamespace == null) {
         var1.append("no targetNamspace");
      } else {
         var1.append("targetNamespace is ");
         var1.append(this.fTargetNamespace);
      }

      Document var2 = this.fSchemaElement != null ? this.fSchemaElement.getOwnerDocument() : null;
      if (var2 instanceof SchemaDOM) {
         String var3 = var2.getDocumentURI();
         if (var3 != null && var3.length() > 0) {
            var1.append(" :: schemaLocation is ");
            var1.append(var3);
         }
      }
