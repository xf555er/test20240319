   ...
   protected final void startNamespaceScope(QName var1, XMLAttributes var2, Augmentations var3) throws XNIException {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if (var7 == XMLSymbols.PREFIX_XMLNS || var7 == XMLSymbols.EMPTY_STRING && var6 == XMLSymbols.PREFIX_XMLNS) {
            var8 = this.fSymbolTable.addSymbol(var2.getValue(var5));
            if (var7 == XMLSymbols.PREFIX_XMLNS && var6 == XMLSymbols.PREFIX_XMLNS) {
               this.fErrorReporter.reportError("http://www.w3.org/TR/1999/REC-xml-names-19990114", "CantBindXMLNS", new Object[]{var2.getQName(var5)}, (short)2);
            }
            ...
            if (var6 == XMLSymbols.PREFIX_XML) {
               if (var8 != NamespaceContext.XML_URI) {
                  this.fErrorReporter.reportError("http://www.w3.org/TR/1999/REC-xml-names-19990114", "CantBindXML", new Object[]{var2.getQName(var5)}, (short)2);
               }
            ...
            if (var8 == XMLSymbols.EMPTY_STRING && var6 != XMLSymbols.PREFIX_XMLNS) {
               this.fErrorReporter.reportError("http://www.w3.org/TR/1999/REC-xml-names-19990114", "EmptyPrefixedAttName", new Object[]{var2.getQName(var5)}, (short)2);
            } else {
               this.fNamespaceContext.declarePrefix(var7, var8.length() != 0 ? var8 : null);
            }
         }
      }

      var6 = var1.prefix != null ? var1.prefix : XMLSymbols.EMPTY_STRING;
      var1.uri = this.fNamespaceContext.getURI(var6);
      ...
      for(int var15 = 0; var15 < var4; ++var15) {
         ...
         if (var9 == XMLSymbols.PREFIX_XMLNS) {
            ...
            this.fAttributeQName.uri = this.fNamespaceContext.getURI(var8);
            if (this.fAttributeQName.uri == null) {
               this.fErrorReporter.reportError("http://www.w3.org/TR/1999/REC-xml-names-19990114", "AttributePrefixUnbound", new Object[]{var1.rawname, var9, var8}, (short)2);
            }
         ...
         if (var10 != null && var10 != NamespaceContext.XMLNS_URI) {
            ...
            for(int var12 = var17 + 1; var12 < var16; ++var12) {
               ...
               if (var11 == var13 && var10 == var14) {
                  this.fErrorReporter.reportError("http://www.w3.org/TR/1999/REC-xml-names-19990114", "AttributeNSNotUnique", new Object[]{var1.rawname, var11, var10}, (short)2);
               }
            }
         }
      }
