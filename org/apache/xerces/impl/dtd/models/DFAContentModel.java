...
public class DFAContentModel implements ContentModelValidator {
   ...
   private void buildDFA(CMNode var1) {
      ...
      int[] var25 = new int[this.fLeafCount + this.fElemMapSize];
      var6 = 0;
      ...
      CMStateSet[] var26 = new CMStateSet[var8];
      this.fFinalStateFlags = new boolean[var8];
      this.fTransTable = new int[var8][];
      CMStateSet var27 = this.fHeadNode.firstPos();
      int var11 = 0;
      int var12 = 0;
      ...
      while(var11 < var12) {
         ...
         this.fFinalStateFlags[var11] = var27.getBit(this.fEOCPos);
         ++var11;
         ...
         for(int var17 = 0; var17 < this.fElemMapSize; ++var17) {
            ...
            for(int var18 = var25[var16++]; var18 != -1; var18 = var25[var16++]) {
               if (var27.getBit(var18)) {
            ...
            if (!var15.isEmpty()) {
               ...
               if (var12 == var8) {
                  ...
                  System.arraycopy(var26, 0, var22, 0, var8);
                  System.arraycopy(this.fFinalStateFlags, 0, var23, 0, var8);
                  System.arraycopy(this.fTransTable, 0, var24, 0, var8);
                  var8 = var21;
                  var26 = var22;
