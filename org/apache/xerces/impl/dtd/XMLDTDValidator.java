...
public class XMLDTDValidator implements XMLComponent, XMLDocumentFilter, XMLDTDValidatorFilter, RevalidationHandler {
   ...
   public void reset(XMLComponentManager var1) throws XMLConfigurationException {
      ...
      if (!var2) {
         ...
         try {
            this.fBalanceSyntaxTrees = var1.getFeature("http://apache.org/xml/features/validation/balance-syntax-trees");
   ...
   public void startDocument(XMLLocator var1, String var2, NamespaceContext var3, Augmentations var4) throws XNIException {
      if (this.fGrammarPool != null) {
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            this.fGrammarBucket.putGrammar((DTDGrammar)var5[var7]);
         }
      }
   ...
   public void doctypeDecl(String var1, String var2, String var3, Augmentations var4) throws XNIException {
      ...
      if (this.fDTDGrammar == null) {
         if (!this.fBalanceSyntaxTrees) {
            ...
            this.fDTDGrammar = new BalancedDTDGrammar(this.fSymbolTable, var6);
         }
      } else {
   ...
   public void startGeneralEntity(String var1, XMLResourceIdentifier var2, String var3, Augmentations var4) throws XNIException {
      if (this.fPerformValidation && this.fElementDepth >= 0 && this.fDTDGrammar != null) {
         ...
         if (this.fGrammarBucket.getStandalone()) {
            XMLDTDLoader.checkStandaloneEntityRef(var1, this.fDTDGrammar, this.fEntityDecl, this.fErrorReporter);
         }
      }
   ...
   private void ensureStackCapacity(int var1) {
      if (var1 == this.fElementQNamePartsStack.length) {
         QName[] var2 = new QName[var1 * 2];
         System.arraycopy(this.fElementQNamePartsStack, 0, var2, 0, var1);
         this.fElementQNamePartsStack = var2;
         QName var3 = this.fElementQNamePartsStack[var1];
         if (var3 == null) {
            for(int var4 = var1; var4 < this.fElementQNamePartsStack.length; ++var4) {
               this.fElementQNamePartsStack[var4] = new QName();
            }
         }

         int[] var5 = new int[var1 * 2];
         System.arraycopy(this.fElementIndexStack, 0, var5, 0, var1);
         this.fElementIndexStack = var5;
         var5 = new int[var1 * 2];
         System.arraycopy(this.fContentSpecTypeStack, 0, var5, 0, var1);
         this.fContentSpecTypeStack = var5;
      }
   ...
   protected void handleEndElement(QName var1, Augmentations var2, boolean var3) throws XNIException {
      ...
      if (this.fElementDepth < -1) {
         ...
         this.fInElementContent = false;
         if (this.fPerformValidation) {
            Iterator var10 = this.fValidationState.checkIDRefID();
            if (var10 != null) {
               while(var10.hasNext()) {
                  this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_ELEMENT_WITH_ID_REQUIRED", new Object[]{var10.next()}, (short)1);
               }
            }
         }
