...
public abstract class XMLScanner implements XMLComponent {
   ...
   public String scanPseudoAttribute(boolean var1, XMLString var2) throws IOException, XNIException {
      String var3 = this.scanPseudoAttributeName();
   ...
   private String scanPseudoAttributeName() throws IOException, XNIException {
      int var1 = this.fEntityScanner.peekChar();
      switch (var1) {
         case 101:
            ...
            while(true) {
               ...
               if (!XMLChar.isMarkup(var7) && var7 != 93) {
                  if (XMLChar.isHighSurrogate(var7)) {
                     ...
                     this.reportFatalError("InvalidCharInSystemID", new Object[]{Integer.toHexString(var7)});
                     this.fEntityScanner.scanChar();
                  }
               } else {
