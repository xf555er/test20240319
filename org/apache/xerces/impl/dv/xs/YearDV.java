...
public class YearDV extends AbstractDateTimeDV {
   ...
   protected AbstractDateTimeDV.DateTimeData parse(String var1) throws SchemaDateTimeException {
      ...
      int var6 = (var5 == -1 ? var3 : var5) - var4;
      if (var6 < 4) {
         throw new RuntimeException("Year must have 'CCYY' format");
      } else if (var6 > 4 && var1.charAt(var4) == '0') {
   ...
   protected XMLGregorianCalendar getXMLGregorianCalendar(AbstractDateTimeDV.DateTimeData var1) {
      return AbstractDateTimeDV.datatypeFactory.newXMLGregorianCalendar(var1.unNormYear, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, var1.hasTimeZone() ? var1.timezoneHr * 60 + var1.timezoneMin : Integer.MIN_VALUE);
   }
}
