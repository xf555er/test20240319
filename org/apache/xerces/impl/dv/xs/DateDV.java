...
public class DateDV extends DateTimeDV {
   public Object getActualValue(String var1, ValidationContext var2) throws InvalidDatatypeValueException {
      try {
         ...
         throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{var1, "date"});
      }
   }
   ...
   protected AbstractDateTimeDV.DateTimeData parse(String var1) throws SchemaDateTimeException {
      ...
      int var4 = this.getDate(var1, 0, var3, var2);
   ...
   protected XMLGregorianCalendar getXMLGregorianCalendar(AbstractDateTimeDV.DateTimeData var1) {
      return AbstractDateTimeDV.datatypeFactory.newXMLGregorianCalendar(var1.unNormYear, var1.unNormMonth, var1.unNormDay, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, var1.hasTimeZone() ? var1.timezoneHr * 60 + var1.timezoneMin : Integer.MIN_VALUE);
   }
}
