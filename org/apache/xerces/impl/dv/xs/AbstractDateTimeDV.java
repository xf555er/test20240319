...
public abstract class AbstractDateTimeDV extends TypeValidator {
   ...
   protected final void append(StringBuffer var1, int var2, int var3) {
   ...
   protected final void append(StringBuffer var1, double var2) {
      if (var2 < 0.0) {
         var1.append('-');
         var2 = -var2;
      }
      ...
      this.append2(var1, var2);
   }

   protected final void append2(StringBuffer var1, double var2) {
      int var4 = (int)var2;
      if (var2 == (double)var4) {
         var1.append(var4);
      } else {
         this.append3(var1, var2);
      }

   }

   private void append3(StringBuffer var1, double var2) {
      String var4 = String.valueOf(var2);
      int var5 = var4.indexOf(69);
      if (var5 == -1) {
         var1.append(var4);
      } else {
         int var6;
         ...
         if (var2 < 1.0) {
            try {
               var6 = this.parseInt(var4, var5 + 2, var4.length());
            ...
            try {
               var6 = this.parseInt(var4, var5 + 1, var4.length());
            ...
            for(var9 = var7 - var5; var9 > 0; --var9) {
               var1.append('0');
            }
         }
   ...
   protected final BigDecimal getFractionalSecondsAsBigDecimal(DateTimeData var1) {
      StringBuffer var2 = new StringBuffer();
      this.append3(var2, var1.unNormSecond);
      ...
      if (var4 == -1) {
         ...
         BigDecimal var5 = new BigDecimal(var3);
         return var5.compareTo(BigDecimal.valueOf(0L)) == 0 ? null : var5;
      }
   }
