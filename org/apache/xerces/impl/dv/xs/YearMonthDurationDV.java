...
class YearMonthDurationDV extends DurationDV {
   ...
   protected Duration getDuration(AbstractDateTimeDV.DateTimeData var1) {
      ...
      return AbstractDateTimeDV.datatypeFactory.newDuration(var2 == 1, var1.year != Integer.MIN_VALUE ? BigInteger.valueOf((long)(var2 * var1.year)) : null, var1.month != Integer.MIN_VALUE ? BigInteger.valueOf((long)(var2 * var1.month)) : null, (BigInteger)null, (BigInteger)null, (BigInteger)null, (BigDecimal)null);
   }
}
