...
public class XMLDTDScannerImpl extends XMLScanner implements XMLDTDScanner, XMLComponent, XMLEntityHandler {
   ...
   protected String startPE(String var1, boolean var2) throws IOException, XNIException {
   ...
   private final void scanChildren(String var1) throws IOException, XNIException {
      ...
      while(true) {
         ...
         for(; !this.fEntityScanner.skipChar(40); this.skipSeparator(false, !this.scanningInternalSubset())) {
            this.skipSeparator(false, !this.scanningInternalSubset());
            String var4 = this.fEntityScanner.scanName();
            if (var4 == null) {
               this.reportFatalError("MSG_OPEN_PAREN_OR_ELEMENT_TYPE_REQUIRED_IN_CHILDREN", new Object[]{var1});
               return;
            }
   ...
   private final void scanEntityDecl() throws IOException, XNIException {
      ...
      int var8 = 0;
      if (var10 == null) {
         var8 = this.scanEntityValue(this.fLiteral, this.fLiteral2);
         this.fStringBuffer.clear();
      ...
      if (var10 != null) {
         String var9 = this.fEntityScanner.getBaseSystemId();
         if (var6 != null) {
            this.fEntityManager.addUnparsedEntity(var3, var5, var10, var9, var6);
         } else {
            this.fEntityManager.addExternalEntity(var3, var5, var10, var9);
         }

         if (this.fDTDHandler != null) {
            this.fResourceIdentifier.setValues(var5, var10, var9, XMLEntityManager.expandSystemId(var10, var9, false));
            if (var6 != null) {
         ...
         this.fEntityManager.addInternalEntity(var3, this.fStringBuffer.toString(), var8);
         if (this.fDTDHandler != null) {
   ...
   protected final int scanEntityValue(XMLString var1, XMLString var2) throws IOException, XNIException {
      ...
      if (this.fEntityScanner.scanLiteral(var3, this.fString) != var3) {
         ...
         do {
            ...
            if (this.fEntityScanner.skipChar(38)) {
               if (this.fEntityScanner.skipChar(35)) {
                  ...
                  this.fStringBuffer.append('&');
                  this.fStringBuffer2.append('&');
                  var10 = this.fEntityScanner.scanName();
                  if (var10 == null) {
                     this.reportFatalError("NameRequiredInReference", (Object[])null);
                  } else {
                     this.fStringBuffer.append(var10);
                     this.fStringBuffer2.append(var10);
                  }

                  if (!this.fEntityScanner.skipChar(59)) {
                     this.reportFatalError("SemicolonRequiredInReference", new Object[]{var10});
                  } else {
                     this.fStringBuffer.append(';');
                     this.fStringBuffer2.append(';');
                  }
               ...
               do {
                  ...
                  if (var10 == null) {
                     ...
                     this.reportFatalError("SemicolonRequiredInPEReference", new Object[]{var10});
                  } else {
                     if (this.scanningInternalSubset()) {
                        this.reportFatalError("PEReferenceWithinMarkup", new Object[]{var10});
                     }
                  ...
                  String var9 = this.startPE(var10, true);
                  var5 += this.fEntityManager.getParamEntityRefCount(var9) + 1;
                  this.fEntityScanner.skipSpaces();
               } while(this.fEntityScanner.skipChar(37));
            } else {
               int var8 = this.fEntityScanner.peekChar();
               if (XMLChar.isHighSurrogate(var8)) {
                  this.scanSurrogates(this.fStringBuffer2);
               } else if (this.isInvalidLiteral(var8)) {
                  this.reportFatalError("InvalidCharInLiteral", new Object[]{Integer.toHexString(var8)});
                  this.fEntityScanner.scanChar();
               } else if (var8 != var3 || var4 != this.fEntityDepth) {
         ...
         var7 = this.fStringBuffer2;
      }

      var1.setValues((XMLString)var6);
      var2.setValues((XMLString)var7);
