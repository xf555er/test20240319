...
public class XMLEntityScanner implements XMLLocator {
   ...
   public final void setEncoding(String var1) throws IOException {
   ...
   public final void setXMLVersion(String var1) {
   ...
   public String scanNmtoken() throws IOException {
      ...
      String var3 = null;
      if (var2 > 0) {
         var3 = this.fSymbolTable.addSymbol(this.fCurrentEntity.ch, var1, var2);
      }
      ...
      if (XMLChar.isNCNameStart(this.fCurrentEntity.ch[var2])) {
         ...
         if (var4 > 0) {
            ...
            if (var3 != -1) {
               ...
               var6 = this.fSymbolTable.addSymbol(this.fCurrentEntity.ch, var10, var9);
            } else {
               var6 = var7;
            }

            var1.setValues(var12, var6, var7, (String)null);
            return true;
         }
      }
   ...
   public final void setCurrentEntity(XMLEntityManager.ScannedEntity var1) {
   ...
   public final void reset(SymbolTable var1, XMLEntityManager var2, XMLErrorReporter var3) {
   ...
   final boolean load(int var1, boolean var2) throws IOException {
      XMLEntityManager.ScannedEntity var10000 = this.fCurrentEntity;
      var10000.baseCharOffset += this.fCurrentEntity.position - this.fCurrentEntity.startPosition;
      int var3 = this.fCurrentEntity.ch.length - var1;
      if (!this.fCurrentEntity.mayReadChunks && var3 > 64) {
         var3 = 64;
      }
   ...
   final void resizeBuffer(int var1, int var2) {
