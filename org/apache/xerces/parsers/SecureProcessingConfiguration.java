...
public final class SecureProcessingConfiguration extends XIncludeAwareParserConfiguration {
   ...
   private int getPropertyValue(String var1, int var2) {
      ...
      try {
         ...
         Class var38 = class$org$apache$xerces$parsers$SecureProcessingConfiguration == null ? (class$org$apache$xerces$parsers$SecureProcessingConfiguration = class$("org.apache.xerces.parsers.SecureProcessingConfiguration")) : class$org$apache$xerces$parsers$SecureProcessingConfiguration;
         synchronized(var38) {
            boolean var40 = false;
