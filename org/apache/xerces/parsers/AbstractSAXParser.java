...
public abstract class AbstractSAXParser extends AbstractXMLDocumentParser implements PSVIProvider, Parser, XMLReader {
   ...
   public void parse(String var1) throws SAXException, IOException {
      ...
      try {
         this.parse((XMLInputSource)var2);
      } catch (XMLParseException var6) {
         Exception var4 = var6.getException();
         if (var4 != null && !(var4 instanceof CharConversionException)) {
            if (var4 instanceof SAXException) {
            ...
            Locator2Impl var8 = new Locator2Impl();
            var8.setXMLVersion(this.fVersion);
            ...
            throw var4 == null ? new SAXParseException(var6.getMessage(), var8) : new SAXParseException(var6.getMessage(), var8, var4);
         }
   ...
   public void parse(InputSource var1) throws SAXException, IOException {
      try {
         ...
         if (var3 != null && !(var3 instanceof CharConversionException)) {
            if (var3 instanceof SAXException) {
            ...
            Locator2Impl var7 = new Locator2Impl();
            var7.setXMLVersion(this.fVersion);
            ...
            throw var3 == null ? new SAXParseException(var5.getMessage(), var7) : new SAXParseException(var5.getMessage(), var7, var3);
         }
   ...
   public void setEntityResolver(EntityResolver var1) {
      try {
         XMLEntityResolver var2 = (XMLEntityResolver)this.fConfiguration.getProperty("http://apache.org/xml/properties/internal/entity-resolver");
         if (this.fUseEntityResolver2 && var1 instanceof EntityResolver2) {
            if (var2 instanceof EntityResolver2Wrapper) {
               ...
               this.fConfiguration.setProperty("http://apache.org/xml/properties/internal/entity-resolver", new EntityResolver2Wrapper((EntityResolver2)var1));
            }
            ...
            this.fConfiguration.setProperty("http://apache.org/xml/properties/internal/entity-resolver", new EntityResolverWrapper(var1));
         }
   ...
   public void setErrorHandler(ErrorHandler var1) {
      try {
         XMLErrorHandler var2 = (XMLErrorHandler)this.fConfiguration.getProperty("http://apache.org/xml/properties/internal/error-handler");
         if (var2 instanceof ErrorHandlerWrapper) {
            ErrorHandlerWrapper var3 = (ErrorHandlerWrapper)var2;
            var3.setErrorHandler(var1);
         } else {
            this.fConfiguration.setProperty("http://apache.org/xml/properties/internal/error-handler", new ErrorHandlerWrapper(var1));
         }
      } catch (XMLConfigurationException var4) {
      }
      ...
      try {
         if (var1.startsWith("http://xml.org/sax/features/")) {
            ...
            if (var3 == "namespaces".length() && var1.endsWith("namespaces")) {
               this.fConfiguration.setFeature(var1, var2);
            ...
            if (var3 == "string-interning".length() && var1.endsWith("string-interning")) {
               if (!var2) {
                  throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "false-not-supported", new Object[]{var1}));
               }
            ...
            if (var3 == "unicode-normalization-checking".length() && var1.endsWith("unicode-normalization-checking")) {
               if (var2) {
                  throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "true-not-supported", new Object[]{var1}));
               }
            ...
            if (var3 == "is-standalone".length() && var1.endsWith("is-standalone") || var3 == "use-attributes2".length() && var1.endsWith("use-attributes2") || var3 == "use-locator2".length() && var1.endsWith("use-locator2") || var3 == "xml-1.1".length() && var1.endsWith("xml-1.1")) {
               throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "feature-read-only", new Object[]{var1}));
            }
         }
         ...
         if (var5.getType() == 0) {
            throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "feature-not-recognized", new Object[]{var4}));
         } else {
            throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "feature-not-supported", new Object[]{var4}));
         }
      }
   }
   ...
   public boolean getFeature(String var1) throws SAXNotRecognizedException, SAXNotSupportedException {
      try {
         ...
         return this.fConfiguration.getFeature(var1);
      } catch (XMLConfigurationException var4) {
         String var3 = var4.getIdentifier();
         if (var4.getType() == 0) {
            throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "feature-not-recognized", new Object[]{var3}));
         } else {
            throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "feature-not-supported", new Object[]{var3}));
         }
      }
   }
         ...
         if (var1.startsWith("http://xml.org/sax/properties/")) {
            ...
            if (var3 == "lexical-handler".length() && var1.endsWith("lexical-handler")) {
               try {
                  ...
                  throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "incompatible-class", new Object[]{var1, "org.xml.sax.ext.LexicalHandler"}));
               }
            }
            ...
            if (var3 == "declaration-handler".length() && var1.endsWith("declaration-handler")) {
               try {
                  ...
                  throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "incompatible-class", new Object[]{var1, "org.xml.sax.ext.DeclHandler"}));
               }
            }

            if (var3 == "dom-node".length() && var1.endsWith("dom-node") || var3 == "document-xml-version".length() && var1.endsWith("document-xml-version")) {
               throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "property-read-only", new Object[]{var1}));
            }
         }

         this.fConfiguration.setProperty(var1, var2);
      } catch (XMLConfigurationException var7) {
         String var4 = var7.getIdentifier();
         if (var7.getType() == 0) {
            throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "property-not-recognized", new Object[]{var4}));
         } else {
            throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "property-not-supported", new Object[]{var4}));
         }
      }
   }
   ...
   public Object getProperty(String var1) throws SAXNotRecognizedException, SAXNotSupportedException {
      try {
         ...
         return this.fConfiguration.getProperty(var1);
      } catch (XMLConfigurationException var4) {
         String var3 = var4.getIdentifier();
         if (var4.getType() == 0) {
            throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "property-not-recognized", new Object[]{var3}));
         } else {
            throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "property-not-supported", new Object[]{var3}));
         }
      }
   }
   ...
   protected static final class AttributesProxy implements AttributeList, Attributes2 {
      ...
      public String getType(String var1, String var2) {
         return var1.length() == 0 ? this.fAttributes.getType((String)null, var2) : this.fAttributes.getType(var1, var2);
      }
      ...
      public String getValue(String var1, String var2) {
         return var1.length() == 0 ? this.fAttributes.getValue((String)null, var2) : this.fAttributes.getValue(var1, var2);
      }
      ...
      public int getIndex(String var1, String var2) {
         return var1.length() == 0 ? this.fAttributes.getIndex((String)null, var2) : this.fAttributes.getIndex(var1, var2);
      }
