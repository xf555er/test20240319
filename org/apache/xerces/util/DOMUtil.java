...
public class DOMUtil {
   ...
   public static void copyInto(Node var0, Node var1) throws DOMException {
      ...
      while(var6 != null) {
         ...
         switch (var8) {
            ...
            case 6:
            default:
               throw new IllegalArgumentException("can't copy node type, " + var8 + " (" + var6.getNodeName() + ')');
            case 3:
   ...
   public static boolean isHidden(Node var0, Hashtable var1) {
      return var0 instanceof NodeImpl ? ((NodeImpl)var0).getReadOnly() : var1.containsKey(var0);
   }
   ...
   public static String getAnnotation(Node var0) {
      return var0 instanceof ElementImpl ? ((ElementImpl)var0).getAnnotation() : null;
   }
   ...
   public static DOMException createDOMException(short var0, Throwable var1) {
      DOMException var2 = new DOMException(var0, var1 != null ? var1.getMessage() : null);
      if (var1 != null && DOMUtil.ThrowableMethods.fgThrowableMethodsAvailable) {
         try {
            DOMUtil.ThrowableMethods.fgThrowableInitCauseMethod.invoke(var2, var1);
   ...
   public static LSException createLSException(short var0, Throwable var1) {
      LSException var2 = new LSException(var0, var1 != null ? var1.getMessage() : null);
      if (var1 != null && DOMUtil.ThrowableMethods.fgThrowableMethodsAvailable) {
         try {
            DOMUtil.ThrowableMethods.fgThrowableInitCauseMethod.invoke(var2, var1);
         } catch (Exception var4) {
   ...
   static class ThrowableMethods {
      ...
      static {
         try {
            fgThrowableInitCauseMethod = (class$java$lang$Throwable == null ? (class$java$lang$Throwable = class$("java.lang.Throwable")) : class$java$lang$Throwable).getMethod("initCause", class$java$lang$Throwable == null ? (class$java$lang$Throwable = class$("java.lang.Throwable")) : class$java$lang$Throwable);
