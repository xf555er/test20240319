...
public class EncodingMap {
   ...
   /** @deprecated */
   public static void putIANA2JavaMapping(String var0, String var1) {
      fIANA2JavaMap.put(var0, var1);
   }

   public static String getIANA2JavaMapping(String var0) {
      return (String)fIANA2JavaMap.get(var0);
   }

   /** @deprecated */
   public static String removeIANA2JavaMapping(String var0) {
      return (String)fIANA2JavaMap.remove(var0);
   }

   /** @deprecated */
   public static void putJava2IANAMapping(String var0, String var1) {
      fJava2IANAMap.put(var0, var1);
   }

   public static String getJava2IANAMapping(String var0) {
      return (String)fJava2IANAMap.get(var0);
   }

   /** @deprecated */
   public static String removeJava2IANAMapping(String var0) {
      return (String)fJava2IANAMap.remove(var0);
   }
