...
public class XMLChar {
   ...
   public static String trim(String var0) {
      ...
      int var1;
      for(var1 = 0; var1 <= var3 && isSpace(var0.charAt(var1)); ++var1) {
      }

      int var2;
      for(var2 = var3; var2 >= var1 && isSpace(var0.charAt(var2)); --var2) {
      }

      if (var1 == 0 && var2 == var3) {
         return var0;
      } else {
         return var1 > var3 ? "" : var0.substring(var1, var2 + 1);
      }
   }
