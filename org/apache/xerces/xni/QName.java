...
public class QName implements Cloneable {
   ...
   public String toString() {
      ...
      boolean var2 = false;
      if (this.prefix != null) {
         var1.append("prefix=\"").append(this.prefix).append('"');
         var2 = true;
      }
      ...
      if (this.localpart != null) {
         ...
         var1.append("localpart=\"").append(this.localpart).append('"');
         var2 = true;
      }
      ...
      if (this.rawname != null) {
         ...
         var1.append("rawname=\"").append(this.rawname).append('"');
         var2 = true;
      }
      ...
      if (this.uri != null) {
         ...
         var1.append("uri=\"").append(this.uri).append('"');
      }
