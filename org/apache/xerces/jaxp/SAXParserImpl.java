...
public class SAXParserImpl extends SAXParser implements JAXPConstants, PSVIProvider {
   ...
   SAXParserImpl(SAXParserFactoryImpl var1, Hashtable var2, boolean var3) throws SAXException {
      ...
      if (this.grammar != null) {
         ...
         if (this.grammar instanceof XSGrammarPoolContainer) {
            ...
            var4.setDTDHandler(this.fUnparsedEntityHandler);
   ...
   private void setFeatures(Hashtable var1) throws SAXNotSupportedException, SAXNotRecognizedException {
      if (var1 != null) {
         ...
         while(var2.hasNext()) {
            ...
            this.xmlReader.setFeature0(var4, var5);
         }
      }
   ...
   public void parse(InputSource var1, DefaultHandler var2) throws SAXException, IOException {
      if (var1 == null) {
         ...
         if (var2 != null) {
            this.xmlReader.setContentHandler(var2);
            this.xmlReader.setEntityResolver(var2);
            this.xmlReader.setErrorHandler(var2);
            this.xmlReader.setDTDHandler(var2);
   ...
   public void parse(InputSource var1, HandlerBase var2) throws SAXException, IOException {
      if (var1 == null) {
         ...
         if (var2 != null) {
            this.xmlReader.setDocumentHandler(var2);
            this.xmlReader.setEntityResolver(var2);
            this.xmlReader.setErrorHandler(var2);
            this.xmlReader.setDTDHandler(var2);
            ...
            if (this.fSAXParser != null) {
               if ("http://java.sun.com/xml/jaxp/properties/schemaLanguage".equals(var1)) {
                  if (this.fSAXParser.grammar != null) {
                     throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(this.fConfiguration.getLocale(), "schema-already-specified", new Object[]{var1}));
                  }
