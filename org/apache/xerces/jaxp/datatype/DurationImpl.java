...
class DurationImpl extends Duration implements Serializable {
   ...
   protected DurationImpl(boolean var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      this(var1, wrap(var2), wrap(var3), wrap(var4), wrap(var5), wrap(var6), var7 != 0 ? BigDecimal.valueOf((long)var7) : null);
   }

   private static BigInteger wrap(int var0) {
      return var0 == Integer.MIN_VALUE ? null : BigInteger.valueOf((long)var0);
   }
   ...
   public int compare(Duration var1) {
      ...
      if (this.years != null && this.years.compareTo(var2) == 1) {
         ...
         throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage((Locale)null, "TooLarge", new Object[]{this.getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.SECONDS.toString(), this.toString(this.seconds)}));
      } else {
         BigInteger var3 = (BigInteger)var1.getField(DatatypeConstants.YEARS);
         if (var3 != null && var3.compareTo(var2) == 1) {
            throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage((Locale)null, "TooLarge", new Object[]{this.getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.YEARS.toString(), var3.toString()}));
         } else {
            BigInteger var4 = (BigInteger)var1.getField(DatatypeConstants.MONTHS);
            if (var4 != null && var4.compareTo(var2) == 1) {
               throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage((Locale)null, "TooLarge", new Object[]{this.getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.MONTHS.toString(), var4.toString()}));
            } else {
               BigInteger var5 = (BigInteger)var1.getField(DatatypeConstants.DAYS);
               if (var5 != null && var5.compareTo(var2) == 1) {
                  throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage((Locale)null, "TooLarge", new Object[]{this.getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.DAYS.toString(), var5.toString()}));
               } else {
                  BigInteger var6 = (BigInteger)var1.getField(DatatypeConstants.HOURS);
                  if (var6 != null && var6.compareTo(var2) == 1) {
                     throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage((Locale)null, "TooLarge", new Object[]{this.getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.HOURS.toString(), var6.toString()}));
                  } else {
                     BigInteger var7 = (BigInteger)var1.getField(DatatypeConstants.MINUTES);
                     if (var7 != null && var7.compareTo(var2) == 1) {
                        throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage((Locale)null, "TooLarge", new Object[]{this.getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.MINUTES.toString(), var7.toString()}));
                     } else {
                        BigDecimal var8 = (BigDecimal)var1.getField(DatatypeConstants.SECONDS);
                        BigInteger var9 = null;
                        if (var8 != null) {
                           var9 = var8.toBigInteger();
                        }

                        if (var9 != null && var9.compareTo(var2) == 1) {
                           throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage((Locale)null, "TooLarge", new Object[]{this.getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.SECONDS.toString(), var9.toString()}));
                        } else {
                           GregorianCalendar var10 = new GregorianCalendar(1970, 1, 1, 0, 0, 0);
                           var10.add(1, this.getYears() * this.getSign());
                           var10.add(2, this.getMonths() * this.getSign());
                           var10.add(6, this.getDays() * this.getSign());
                           var10.add(11, this.getHours() * this.getSign());
                           var10.add(12, this.getMinutes() * this.getSign());
                           var10.add(13, this.getSeconds() * this.getSign());
                           GregorianCalendar var11 = new GregorianCalendar(1970, 1, 1, 0, 0, 0);
                           var11.add(1, var1.getYears() * var1.getSign());
                           var11.add(2, var1.getMonths() * var1.getSign());
                           var11.add(6, var1.getDays() * var1.getSign());
                           var11.add(11, var1.getHours() * var1.getSign());
                           var11.add(12, var1.getMinutes() * var1.getSign());
                           var11.add(13, var1.getSeconds() * var1.getSign());
                           return var10.equals(var11) ? 0 : this.compareDates(this, var1);
                        }
                     }
                  }
               }
   ...
   public String toString() {
      ...
      if (this.hours != null || this.minutes != null || this.seconds != null) {
         var1.append('T');
         if (this.hours != null) {
            var1.append(this.hours).append('H');
         }

         if (this.minutes != null) {
            var1.append(this.minutes).append('M');
         }

         if (this.seconds != null) {
            var1.append(this.toString(this.seconds)).append('S');
         }
      }
