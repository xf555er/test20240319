...
class XMLGregorianCalendarImpl extends XMLGregorianCalendar implements Serializable, Cloneable {
   ...
   private XMLGregorianCalendarImpl(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      ...
      if (var7 != Integer.MIN_VALUE) {
         var9 = BigDecimal.valueOf((long)var7, 3);
      }

      this.setFractionalSecond(var9);
      if (!this.isValid()) {
   ...
   public void setYear(BigInteger var1) {
      if (var1 == null) {
         ...
         BigInteger var2 = var1.remainder(BILLION_B);
   ...
   public void setYear(int var1) {
      if (var1 == Integer.MIN_VALUE) {
         this.year = Integer.MIN_VALUE;
         this.eon = null;
      } else if (Math.abs(var1) < 1000000000) {
         this.year = var1;
         this.eon = null;
      } else {
         BigInteger var2 = BigInteger.valueOf((long)var1);
         BigInteger var3 = var2.remainder(BILLION_B);
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (var1 instanceof XMLGregorianCalendar) {
         return this.compare((XMLGregorianCalendar)var1) == 0;
      } else {
         return false;
      }
   }
   ...
   public void add(Duration var1) {
      ...
      while(true) {
         ...
         if (var30 < 0) {
            var30 = 12 + var30 + 1;
            var29 = BigDecimal.valueOf((long)(var27 - 1)).divide(new BigDecimal(TWELVE), 0).intValue();
         } else {
            var29 = (var27 - 1) / 12;
            ++var30;
         }
   ...
   private static int maximumDayInMonthFor(BigInteger var0, int var1) {
      if (var1 != 2) {
         return XMLGregorianCalendarImpl.DaysInMonth.table[var1];
      } else {
         return !var0.mod(FOUR_HUNDRED).equals(BigInteger.ZERO) && (var0.mod(HUNDRED).equals(BigInteger.ZERO) || !var0.mod(FOUR).equals(BigInteger.ZERO)) ? XMLGregorianCalendarImpl.DaysInMonth.table[var1] : 29;
      }
   }
   ...
   private static int maximumDayInMonthFor(int var0, int var1) {
      if (var1 != 2) {
         ...
         return var0 % 400 != 0 && (var0 % 100 == 0 || var0 % 4 != 0) ? XMLGregorianCalendarImpl.DaysInMonth.table[2] : 29;
      }
   }
   ...
   public GregorianCalendar toGregorianCalendar() {
      ...
      if (this.year != Integer.MIN_VALUE) {
         if (this.eon == null) {
            var1.set(0, this.year < 0 ? 0 : 1);
            var1.set(1, Math.abs(this.year));
         } else {
   ...
   public GregorianCalendar toGregorianCalendar(TimeZone var1, Locale var2, XMLGregorianCalendar var3) {
      ...
      if (this.year != Integer.MIN_VALUE) {
         if (this.eon == null) {
            var4.set(0, this.year < 0 ? 0 : 1);
            var4.set(1, Math.abs(this.year));
         } else {
            BigInteger var8 = this.getEonAndYear();
         ...
         if (var6 != Integer.MIN_VALUE) {
            if (var3.getEon() == null) {
               var4.set(0, var6 < 0 ? 0 : 1);
               var4.set(1, Math.abs(var6));
            } else {
               BigInteger var7 = var3.getEonAndYear();
      ...
      if (this.month != Integer.MIN_VALUE) {
         ...
         var6 = var3 != null ? var3.getMonth() : Integer.MIN_VALUE;
         if (var6 != Integer.MIN_VALUE) {
            var4.set(2, var6 - 1);
         }
      }
      ...
      if (this.day != Integer.MIN_VALUE) {
         ...
         var6 = var3 != null ? var3.getDay() : Integer.MIN_VALUE;
         if (var6 != Integer.MIN_VALUE) {
            var4.set(5, var6);
         }
      }
      ...
      if (this.hour != Integer.MIN_VALUE) {
         ...
         var6 = var3 != null ? var3.getHour() : Integer.MIN_VALUE;
         if (var6 != Integer.MIN_VALUE) {
            var4.set(11, var6);
         }
      }
      ...
      if (this.minute != Integer.MIN_VALUE) {
         ...
         var6 = var3 != null ? var3.getMinute() : Integer.MIN_VALUE;
         if (var6 != Integer.MIN_VALUE) {
            var4.set(12, var6);
         }
      }
      ...
      if (this.second != Integer.MIN_VALUE) {
         ...
         var6 = var3 != null ? var3.getSecond() : Integer.MIN_VALUE;
         if (var6 != Integer.MIN_VALUE) {
            var4.set(13, var6);
         }
      }
      ...
      if (this.fractionalSecond != null) {
         ...
         BigDecimal var9 = var3 != null ? var3.getFractionalSecond() : null;
         if (var9 != null) {
   ...
   public void setMillisecond(int var1) {
      if (var1 == Integer.MIN_VALUE) {
         ...
         this.fractionalSecond = BigDecimal.valueOf((long)var1, 3);
      }
            ...
            switch (var1.charAt(var3++)) {
               ...
               case 's':
                  ...
                  if (this.getFractionalSecond() != null) {
                     String var7 = this.toString(this.getFractionalSecond());
                     var2.append(var7.substring(1, var7.length()));
                  }
                  break;
               case 'z':
                  var6 = this.getTimezone();
                  if (var6 == 0) {
                     var2.append('Z');
   ...
   private final class Parser {
      ...
      private void parseYear() throws IllegalArgumentException {
         ...
         int var3 = this.vidx - var1 - var2;
         if (var3 < 4) {
            throw new IllegalArgumentException(this.value);
         } else {
            String var4 = this.value.substring(var1, this.vidx);
            if (var3 < 10) {
               XMLGregorianCalendarImpl.this.setYear(Integer.parseInt(var4));
            } else {
               XMLGregorianCalendarImpl.this.setYear(new BigInteger(var4));
            }
