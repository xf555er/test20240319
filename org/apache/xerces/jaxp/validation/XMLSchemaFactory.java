...
public final class XMLSchemaFactory extends SchemaFactory {
   ...
   public boolean isSchemaLanguageSupported(String var1) {
      if (var1 == null) {
         ...
         return var1.equals("http://www.w3.org/2001/XMLSchema") || var1.equals(Constants.W3C_XML_SCHEMA10_NS_URI);
      }
   }
   ...
   public Schema newSchema(Source[] var1) throws SAXException {
      ...
      for(int var6 = 0; var6 < var1.length; ++var6) {
         ...
         if (var7 instanceof StreamSource) {
            var8 = (StreamSource)var7;
            String var9 = var8.getPublicId();
            var10 = var8.getSystemId();
            InputStream var4 = var8.getInputStream();
            Reader var5 = var8.getReader();
            XMLInputSource var11 = new XMLInputSource(var9, var10, (String)null);
            var11.setByteStream(var4);
            var11.setCharacterStream(var5);
            var3[var6] = var11;
         } else if (var7 instanceof SAXSource) {
            SAXSource var15 = (SAXSource)var7;
            ...
            var3[var6] = new SAXInputSource(var15.getXMLReader(), var18);
         } else if (var7 instanceof DOMSource) {
            DOMSource var16 = (DOMSource)var7;
            Node var20 = var16.getNode();
            var10 = var16.getSystemId();
            var3[var6] = new DOMInputSource(var20, var10);
         } else {
            if (!(var7 instanceof StAXSource)) {
               if (var7 == null) {
               ...
               throw new IllegalArgumentException(JAXPValidationMessageFormatter.formatMessage(this.fXMLSchemaLoader.getLocale(), "SchemaFactorySourceUnrecognized", new Object[]{var7.getClass().getName()}));
            }

            StAXSource var17 = (StAXSource)var7;
            XMLEventReader var21 = var17.getXMLEventReader();
            if (var21 != null) {
               var3[var6] = new StAXInputSource(var21);
            } else {
               var3[var6] = new StAXInputSource(var17.getXMLStreamReader());
            }
         }
      }
