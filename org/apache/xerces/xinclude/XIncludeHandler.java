...
public class XIncludeHandler implements XMLComponent, XMLDocumentFilter, XMLDTDFilter {
   ...
   public void reset(XMLComponentManager var1) throws XNIException {
      ...
      try {
         if (var1.getFeature("http://apache.org/xml/features/validation/schema")) {
            ...
            if (Constants.NS_XMLSCHEMA.equals(var1.getProperty("http://java.sun.com/xml/jaxp/properties/schemaLanguage"))) {
               this.fSettings.setFeature("http://xml.org/sax/features/validation", false);
            } else if (var1.getFeature("http://xml.org/sax/features/validation")) {
   ...
   public void setDocumentHandler(XMLDocumentHandler var1) {
      if (this.fDocumentHandler != var1) {
         this.fDocumentHandler = var1;
         if (this.fXIncludeChildConfig != null) {
            this.fXIncludeChildConfig.setDocumentHandler(var1);
         }

         if (this.fXPointerChildConfig != null) {
            this.fXPointerChildConfig.setDocumentHandler(var1);
         }
      }
   ...
   public void startDocument(XMLLocator var1, String var2, NamespaceContext var3, Augmentations var4) throws XNIException {
      ...
      if (this.isRootDocument() && this.fDocumentHandler != null) {
         this.fDocumentHandler.startDocument(this.fXIncludeLocator, var2, var3, (Augmentations)var4);
      }
      ...
      if (this.getState() == 2) {
         ...
         if (this.fEntityResolver != null) {
            try {
               ...
               this.reportResourceError("XMLResourceError", new Object[]{var2, var56.getMessage()}, var56);
               return false;
            }
         }
         ...
         if (var3.equals(XINCLUDE_PARSE_XML)) {
            if (var4 != null && this.fXPointerChildConfig == null || var4 == null && this.fXIncludeChildConfig == null) {
               ...
               if (var4 != null) {
                  ...
                  var62.setHref(var2);
                  var62.setXIncludeLocator(this.fXIncludeLocator);
                  ...
                  var63.setHref(var2);
                  var63.setXIncludeLocator(this.fXIncludeLocator);
            ...
            try {
               ...
               if (this.fHasIncludeReportedContent) {
                  throw new XNIException(var50);
               }

               this.reportResourceError("XMLResourceError", new Object[]{var2, var50.getMessage()}, var50);
               var11 = false;
            } finally {
            ...
            try {
               ...
               this.fErrorReporter.reportError(var52.getDomain(), var52.getKey(), var52.getArguments(), (short)2, var52);
               return true;
            } catch (CharConversionException var53) {
               this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "CharConversionFailure", (Object[])null, (short)2, var53);
               return true;
            } catch (IOException var54) {
               if (this.fHasIncludeReportedContent) {
                  throw new XNIException(var54);
               }

               this.reportResourceError("TextResourceError", new Object[]{var2, var54.getMessage()}, var54);
               var14 = false;
            } finally {
               if (var10 != null) {
                  try {
                     ...
                     this.reportResourceError("TextResourceError", new Object[]{var2, var46.getMessage()}, var46);
                     return false;
                  }
               }
   ...
   protected void setupCurrentBaseURI(XMLLocator var1) {
      this.fCurrentBaseURI.setBaseSystemId(var1.getBaseSystemId());
      if (var1.getLiteralSystemId() != null) {
      ...
      if (var2 == null) {
         try {
            var2 = XMLEntityManager.expandSystemId(this.fCurrentBaseURI.getLiteralSystemId(), this.fCurrentBaseURI.getBaseSystemId(), false);
            if (var2 == null) {
      ...
      this.fCurrentBaseURI.setExpandedSystemId(var2);
   }

   protected boolean searchForRecursiveIncludes(String var1) {
      if (var1.equals(this.fCurrentBaseURI.getExpandedSystemId())) {
         return true;
      } else {
   ...
   protected void reportResourceError(String var1) {
      this.reportResourceError(var1, (Object[])null);
   }

   protected void reportResourceError(String var1, Object[] var2) {
      this.reportResourceError(var1, var2, (Exception)null);
   }

   protected void reportResourceError(String var1, Object[] var2, Exception var3) {
      this.reportError(var1, var2, (short)0, var3);
   }
   ...
   protected void reportFatalError(String var1, Object[] var2) {
      this.reportFatalError(var1, var2, (Exception)null);
   }

   protected void reportFatalError(String var1, Object[] var2, Exception var3) {
      this.reportError(var1, var2, (short)2, var3);
   }

   private void reportError(String var1, Object[] var2, short var3, Exception var4) {
      if (this.fErrorReporter != null) {
         this.fErrorReporter.reportError("http://www.w3.org/TR/xinclude", var1, var2, var3, var4);
      }
   ...
   protected void setHref(String var1) {
      this.fHrefFromParent = var1;
   }

   protected void setXIncludeLocator(XMLLocatorWrapper var1) {
      this.fXIncludeLocator = var1;
   }
