...
public class XIncludeTextReader {
      ...
      if (var1.getCharacterStream() != null) {
         ...
         if (var1.getByteStream() != null) {
            ...
            if (var6 instanceof HttpURLConnection && var1 instanceof HTTPInputSource) {
               ...
               Iterator var9 = var8.getHTTPRequestProperties();
               ...
               if (!var17) {
                  var7.setInstanceFollowRedirects(var17);
               }
            }
         ...
         if (var3.equals("UTF-8")) {
            return this.createUTF8Reader((InputStream)var2);
         } else if (var3.equals("UTF-16BE")) {
            return this.createUTF16Reader((InputStream)var2, true);
         } else if (var3.equals("UTF-16LE")) {
            return this.createUTF16Reader((InputStream)var2, false);
         } else {
            ...
            } else if (var4.equals("ASCII")) {
               return this.createASCIIReader((InputStream)var2);
            } else {
               return (Reader)(var4.equals("ISO8859_1") ? this.createLatin1Reader((InputStream)var2) : new InputStreamReader((InputStream)var2, var4));
            }
         }
      }
   }
   ...
   private Reader createUTF8Reader(InputStream var1) {
      return new UTF8Reader(var1, this.fTempString.ch.length, this.fErrorReporter.getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210"), this.fErrorReporter.getLocale());
   }

   private Reader createUTF16Reader(InputStream var1, boolean var2) {
      return new UTF16Reader(var1, this.fTempString.ch.length << 1, var2, this.fErrorReporter.getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210"), this.fErrorReporter.getLocale());
   }

   private Reader createASCIIReader(InputStream var1) {
      return new ASCIIReader(var1, this.fTempString.ch.length, this.fErrorReporter.getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210"), this.fErrorReporter.getLocale());
   }

   private Reader createLatin1Reader(InputStream var1) {
      return new Latin1Reader(var1, this.fTempString.ch.length);
   }
   ...
   public void parse() throws IOException {
      ...
      this.fSource = null;
      int var1 = this.fReader.read(this.fTempString.ch, 0, this.fTempString.ch.length - 1);

      for(this.fHandler.fHasIncludeReportedContent = true; var1 != -1; var1 = this.fReader.read(this.fTempString.ch, 0, this.fTempString.ch.length - 1)) {
