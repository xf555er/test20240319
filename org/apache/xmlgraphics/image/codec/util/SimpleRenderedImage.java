...
public abstract class SimpleRenderedImage implements RenderedImage {
   ...
   public String[] getPropertyNames(String prefix) {
      ...
      String[] prefixNames = propertyNames;
      int var5 = propertyNames.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         String propertyName = prefixNames[var6];
      ...
      if (names.size() == 0) {
         ...
         prefixNames = new String[names.size()];
   ...
   public int convertXToTileX(int x) {
      return convertXToTileX(x, this.getTileGridXOffset(), this.getTileWidth());
   }

   public int convertYToTileY(int y) {
      return convertYToTileY(y, this.getTileGridYOffset(), this.getTileHeight());
   }
