...
public final class PSProcSets {
   ...
   private static class EPSProcSet extends PSProcSet {
      ...
      public void writeTo(PSGenerator gen) throws IOException {
         ...
         gen.writeDSCComment("Copyright", (Object)"Copyright 2002-2003 The Apache Software Foundation. License terms: http://www.apache.org/licenses/LICENSE-2.0");
         gen.writeDSCComment("Title", (Object)"EPS procedures used by the Apache XML Graphics project (Batik and FOP)");
   ...
   private static class StdProcSet extends PSProcSet implements PSCommandMap {
      ...
      public void writeTo(PSGenerator gen) throws IOException {
         gen.writeDSCComment("BeginResource", new Object[]{"procset", this.getName(), Float.toString(this.getVersion()), Integer.toString(this.getRevision())});
         gen.writeDSCComment("Version", new Object[]{Float.toString(this.getVersion()), Integer.toString(this.getRevision())});
         gen.writeDSCComment("Copyright", (Object)"Copyright 2001-2003,2010 The Apache Software Foundation. License terms: http://www.apache.org/licenses/LICENSE-2.0");
         gen.writeDSCComment("Title", (Object)"Basic set of procedures used by the XML Graphics project (Batik and FOP)");
         gen.writeln("/bd{bind def}bind def");
         gen.writeln("/ld{load def}bd");
         Iterator var2 = STANDARD_MACROS.entrySet().iterator();
