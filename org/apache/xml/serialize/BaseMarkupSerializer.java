...
public abstract class BaseMarkupSerializer implements ContentHandler, DocumentHandler, LexicalHandler, DTDHandler, DeclHandler, DOMSerializer, Serializer {
      ...
      try {
         ...
         if (!var4.inCData && !var4.doCData) {
            ...
            for(int var8 = var2; var8 < var7; ++var8) {
               ...
               } else if ((var6 < ' ' || !this._encodingInfo.isPrintable(var6) || var6 == 127) && var6 != '\n' && var6 != '\r' && var6 != '\t') {
   ...
   protected void serializeNode(Node var1) throws IOException {
      ...
      switch (var1.getNodeType()) {
         ...
         default:
            break;
         case 3:
            var12 = var1.getNodeValue();
            if (var12 != null) {
               if (this.fDOMFilter != null && (this.fDOMFilter.getWhatToShow() & 4) != 0) {
                  var14 = this.fDOMFilter.acceptNode(var1);
                  switch (var14) {
                     case 2:
                     case 3:
                        break;
                     default:
                        this.characters(var12);
                  }
               } else if (!this._indenting || this.getElementState().preserveSpace || var12.replace('\n', ' ').trim().length() != 0) {
                  this.characters(var12);
               }
            }
            break;
         ...
         case 5:
            ...
            if ((this.features & 4) == 0 && var1.getFirstChild() != null) {
               for(var11 = var1.getFirstChild(); var11 != null; var11 = var11.getNextSibling()) {
                  this.serializeNode(var11);
               }
         ...
         case 9:
            ...
            if (var2 != null) {
               try {
                  ...
                  String var3 = var2.getInternalSubset();
                  ...
                  java.lang.reflect.Method var7;
                  try {
                     var7 = var4.getMethod("getPublicId", (Class[])null);
                     if (var7.getReturnType().equals(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String)) {
                        var5 = (String)var7.invoke(var2, (Object[])null);
                     }
                  } catch (Exception var9) {
                  }

                  try {
                     var7 = var4.getMethod("getSystemId", (Class[])null);
                     if (var7.getReturnType().equals(class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String)) {
                        var6 = (String)var7.invoke(var2, (Object[])null);
                     }
                  } catch (Exception var8) {
                  }

                  this._printer.enterDTD();
                  this._docTypePublicId = var5;
                  this._docTypeSystemId = var6;
                  this.endDTD();
               }
            }
         case 11:
   ...
   protected void characters(String var1) throws IOException {
      ...
      if (!var2.inCData && !var2.doCData) {
         if (var2.preserveSpace) {
            var3 = this._printer.getNextIndent();
            this._printer.setNextIndent(0);
   ...
   protected void printCDATAText(String var1) throws IOException {
      ...
      for(int var4 = 0; var4 < var2; ++var4) {
         ...
         } else if ((var3 < ' ' || !this._encodingInfo.isPrintable(var3) || var3 == 127) && var3 != '\n' && var3 != '\r' && var3 != '\t') {
            this._printer.printText("]]>&#x");
   ...
   protected void surrogates(int var1, int var2, boolean var3) throws IOException {
   ...
   protected void printEscaped(int var1) throws IOException {
      ...
      if (var2 != null) {
         ...
         this._printer.printText(var2);
         this._printer.printText(';');
      } else if ((var1 < 32 || !this._encodingInfo.isPrintable((char)var1) || var1 == 127) && var1 != 10 && var1 != 13 && var1 != 9) {
         this.printHex(var1);
      } else if (var1 < 65536) {
