   ...
   public boolean equals(String ns, String localPart) {
      ...
      label35: {
         ...
         if (this.getLocalName().equals(localPart)) {
            if (null != thisnamespace && null != ns) {
               if (thisnamespace.equals(ns)) {
                  break label35;
               }
            } else if (null == thisnamespace && null == ns) {
               break label35;
            }
         }
      ...
      if (object == this) {
         ...
         label46: {
            ...
            if (this.getLocalName().equals(qname.getLocalName())) {
               if (null != thisnamespace && null != thatnamespace) {
                  if (thisnamespace.equals(thatnamespace)) {
                     break label46;
                  }
               } else if (null == thisnamespace && null == thatnamespace) {
                  break label46;
               }
            }
