...
public class DOMBuilder implements ContentHandler, LexicalHandler {
   ...
   public void startElement(String ns, String localName, String name, Attributes atts) throws SAXException {
      ...
      try {
         ...
         i = this.m_prefixMappings.size();

         for(int i = 0; i < i; i += 2) {
            attrNS = (String)this.m_prefixMappings.elementAt(i);
            if (attrNS != null) {
               attrQName = (String)this.m_prefixMappings.elementAt(i + 1);
               elem.setAttributeNS("http://www.w3.org/2000/xmlns/", attrNS, attrQName);
            }
         }
