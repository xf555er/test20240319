...
public class ExpandedNameTable {
   ...
   public final int getLocalNameID(int ExpandedNameID) {
      return this.m_extendedTypes[ExpandedNameID].getLocalName().length() == 0 ? 0 : ExpandedNameID;
   }
   ...
   public final int getNamespaceID(int ExpandedNameID) {
      return this.m_extendedTypes[ExpandedNameID].getNamespace().length() == 0 ? 0 : ExpandedNameID;
   }
