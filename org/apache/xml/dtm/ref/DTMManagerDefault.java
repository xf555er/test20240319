            ...
            try {
               ...
               if (this.m_incremental && incremental) {
                  ...
                  try {
                     ...
                     ((SAX2DTM)dtm).clearCoRoutine();
                     throw new WrappedRuntimeException(var39);
                  }
               } else {
                  if (null == reader) {
                     coParser = dtm;
                  ...
                  } catch (SAXNotRecognizedException var36) {
                  } catch (SAXNotSupportedException var37) {
                  }
                  ...
                  try {
                     ...
                     ((SAX2DTM)dtm).clearCoRoutine();
                     throw new WrappedRuntimeException(var35);
                  }
               }
