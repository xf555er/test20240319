...
public class DTMNodeProxy implements Node, Document, Text, Element, Attr, ProcessingInstruction, Comment, DocumentFragment {
   ...
   public final Document getOwnerDocument() {
      return (Document)((Document)this.dtm.getNode(this.dtm.getOwnerDocument(this.node)));
   }
   ...
   public final Element getDocumentElement() {
      ...
      if (elementhandle == -1) {
         ...
         return (Element)((Element)this.dtm.getNode(elementhandle));
      }
   }
   ...
   public final Element getOwnerElement() {
      if (this.getNodeType() != 2) {
         ...
         int newnode = this.dtm.getParent(this.node);
         return newnode == -1 ? null : (Element)((Element)this.dtm.getNode(newnode));
      }
   }
