...
public class XML11Char {
   ...
   public static boolean isXML11Valid(int c) {
      return c < 65536 && (XML11CHARS[c] & 1) != 0 || 65536 <= c && c <= 1114111;
   }
   ...
   public static boolean isXML11ValidLiteral(int c) {
      return c < 65536 && (XML11CHARS[c] & 1) != 0 && (XML11CHARS[c] & 16) == 0 || 65536 <= c && c <= 1114111;
   }

   public static boolean isXML11Content(int c) {
      return c < 65536 && (XML11CHARS[c] & 32) != 0 || 65536 <= c && c <= 1114111;
   }

   public static boolean isXML11InternalEntityContent(int c) {
      return c < 65536 && (XML11CHARS[c] & 48) != 0 || 65536 <= c && c <= 1114111;
   }
   ...
   public static boolean isXML11NCNameStart(int c) {
      return c < 65536 && (XML11CHARS[c] & 64) != 0 || 65536 <= c && c < 983040;
   }

   public static boolean isXML11NCName(int c) {
      return c < 65536 && (XML11CHARS[c] & 128) != 0 || 65536 <= c && c < 983040;
   }
