...
final class URI {
   ...
   public URI(String p_scheme, String p_userinfo, String p_host, int p_port, String p_path, String p_queryString, String p_fragment) throws MalformedURIException {
      ...
      if (p_scheme != null && p_scheme.trim().length() != 0) {
         if (p_host == null) {
            if (p_userinfo != null) {
               throw new MalformedURIException(Utils.messages.createMessage("ER_NO_USERINFO_IF_NO_HOST", (Object[])null));
            }

            if (p_port != -1) {
               throw new MalformedURIException(Utils.messages.createMessage("ER_NO_PORT_IF_NO_HOST", (Object[])null));
            }
         }

         if (p_path != null) {
            if (p_path.indexOf(63) != -1 && p_queryString != null) {
               throw new MalformedURIException(Utils.messages.createMessage("ER_NO_QUERY_STRING_IN_PATH", (Object[])null));
            }

            if (p_path.indexOf(35) != -1 && p_fragment != null) {
               throw new MalformedURIException(Utils.messages.createMessage("ER_NO_FRAGMENT_STRING_IN_PATH", (Object[])null));
            }
         }
         ...
         throw new MalformedURIException(Utils.messages.createMessage("ER_SCHEME_REQUIRED", (Object[])null));
      }
   }
   ...
   private void initialize(URI p_base, String p_uriSpec) throws MalformedURIException {
      if (p_base != null || p_uriSpec != null && p_uriSpec.trim().length() != 0) {
         ...
         throw new MalformedURIException(Utils.messages.createMessage("ER_CANNOT_INIT_URI_EMPTY_PARMS", (Object[])null));
      }
   }
   ...
   private void initializeScheme(String p_uriSpec) throws MalformedURIException {
      ...
      if (scheme.length() == 0) {
         throw new MalformedURIException(Utils.messages.createMessage("ER_NO_SCHEME_INURI", (Object[])null));
      } else {
               ...
               if (testChar != '?' && testChar != '#') {
                  if (testChar == '%') {
                     if (index + 2 >= end || !isHex(p_uriSpec.charAt(index + 1)) || !isHex(p_uriSpec.charAt(index + 2))) {
                        throw new MalformedURIException(Utils.messages.createMessage("ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE", (Object[])null));
                     }
   ...
   public void setScheme(String p_scheme) throws MalformedURIException {
      if (p_scheme == null) {
         throw new MalformedURIException(Utils.messages.createMessage("ER_SCHEME_FROM_NULL_STRING", (Object[])null));
      } else if (!isConformantSchemeName(p_scheme)) {
         throw new MalformedURIException(Utils.messages.createMessage("ER_SCHEME_NOT_CONFORMANT", (Object[])null));
      } else {
   ...
   public void setHost(String p_host) throws MalformedURIException {
      if (p_host != null && p_host.trim().length() != 0) {
         if (!isWellFormedAddress(p_host)) {
            throw new MalformedURIException(Utils.messages.createMessage("ER_HOST_ADDRESS_NOT_WELLFORMED", (Object[])null));
         }
      } else {
         this.m_host = p_host;
         this.m_userinfo = null;
   ...
   public void setPort(int p_port) throws MalformedURIException {
      if (p_port >= 0 && p_port <= 65535) {
         if (this.m_host == null) {
            throw new MalformedURIException(Utils.messages.createMessage("ER_PORT_WHEN_HOST_NULL", (Object[])null));
         }
      } else if (p_port != -1) {
         throw new MalformedURIException(Utils.messages.createMessage("ER_INVALID_PORT", (Object[])null));
      }
   ...
   public void setFragment(String p_fragment) throws MalformedURIException {
      if (p_fragment == null) {
         ...
         if (!this.isGenericURI()) {
            throw new MalformedURIException(Utils.messages.createMessage("ER_FRAG_FOR_GENERIC_URI", (Object[])null));
         }

         if (this.getPath() == null) {
            throw new MalformedURIException(Utils.messages.createMessage("ER_FRAG_WHEN_PATH_NULL", (Object[])null));
         }

         if (!isURIString(p_fragment)) {
            throw new MalformedURIException(Utils.messages.createMessage("ER_FRAG_INVALID_CHAR", (Object[])null));
         }
