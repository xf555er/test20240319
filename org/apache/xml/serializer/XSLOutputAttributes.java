...
interface XSLOutputAttributes {
   ...
   String getOutputProperty(String var1);

   String getOutputPropertyDefault(String var1);

   void setOutputProperty(String var1, String var2);

   void setOutputPropertyDefault(String var1, String var2);
}
