...
final class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         synchronized(class$org$apache$xpath$functions$ObjectFactory == null ? (class$org$apache$xpath$functions$ObjectFactory = class$("org.apache.xpath.functions.ObjectFactory")) : class$org$apache$xpath$functions$ObjectFactory) {
