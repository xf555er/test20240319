...
public class NodeSetDTM extends NodeVector implements DTMIterator, Cloneable {
   ...
   public int previousNode() {
      if (!this.m_cacheNodes) {
         throw new RuntimeException(XSLMessages.createXPATHMessage("ER_NODESETDTM_CANNOT_ITERATE", (Object[])null));
   ...
   public void runTo(int index) {
      if (!this.m_cacheNodes) {
         throw new RuntimeException(XSLMessages.createXPATHMessage("ER_NODESETDTM_CANNOT_INDEX", (Object[])null));
      } else {
   ...
   public void addNode(int n) {
      if (!this.m_mutable) {
         throw new RuntimeException(XSLMessages.createXPATHMessage("ER_NODESETDTM_NOT_MUTABLE", (Object[])null));
      } else {
         this.addElement(n);
      }
   }
   ...
   public void setShouldCacheNodes(boolean b) {
      if (!this.isFresh()) {
         throw new RuntimeException(XSLMessages.createXPATHMessage("ER_CANNOT_CALL_SETSHOULDCACHENODE", (Object[])null));
      } else {
         this.m_cacheNodes = b;
         this.m_mutable = true;
      }
