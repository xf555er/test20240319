...
public class Compiler extends OpMap {
   ...
   Expression compileFunction(int opPos) throws TransformerException {
      ...
      if (-1 == funcID) {
         ...
         try {
            ...
            this.m_errorHandler.fatalError(new TransformerException(XSLMessages.createXPATHMessage("ER_ONLY_ALLOWS", new Object[]{name, var7.getMessage()}), this.m_locator));
         }
   ...
   public void assertion(boolean b, java.lang.String msg) {
      if (!b) {
         java.lang.String fMsg = XSLMessages.createXPATHMessage("ER_INCORRECT_PROGRAMMER_ASSERTION", new Object[]{msg});
