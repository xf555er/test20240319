...
public class XPathContext extends DTMManager {
   ...
   public void setErrorListener(ErrorListener listener) throws IllegalArgumentException {
      if (listener == null) {
         throw new IllegalArgumentException(XSLMessages.createXPATHMessage("ER_NULL_ERROR_HANDLER", (Object[])null));
      } else {
   ...
   public void pushRTFContext() {
      ...
      if (null != this.m_rtfdtm_stack) {
         ((SAX2RTFDTM)((SAX2RTFDTM)this.getRTFDTM())).pushRewindMark();
      }
   ...
   public void popRTFContext() {
      ...
      if (null != this.m_rtfdtm_stack) {
         ...
         if (this.m_which_rtfdtm == previous) {
            if (previous >= 0) {
               isEmpty = ((SAX2RTFDTM)((SAX2RTFDTM)this.m_rtfdtm_stack.elementAt(previous))).popRewindMark();
            }
         } else {
            while(this.m_which_rtfdtm != previous) {
               isEmpty = ((SAX2RTFDTM)((SAX2RTFDTM)this.m_rtfdtm_stack.elementAt(this.m_which_rtfdtm))).popRewindMark();
               --this.m_which_rtfdtm;
            }
         }
