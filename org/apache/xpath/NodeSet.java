...
public class NodeSet implements NodeList, NodeIterator, Cloneable, ContextNodeList {
   ...
   public Node previousNode() throws DOMException {
      if (!this.m_cacheNodes) {
         throw new RuntimeException(XSLMessages.createXPATHMessage("ER_NODESET_CANNOT_ITERATE", (Object[])null));
   ...
   public void runTo(int index) {
      if (!this.m_cacheNodes) {
         throw new RuntimeException(XSLMessages.createXPATHMessage("ER_NODESET_CANNOT_INDEX", (Object[])null));
      } else {
   ...
   public void addNode(Node n) {
      if (!this.m_mutable) {
         throw new RuntimeException(XSLMessages.createXPATHMessage("ER_NODESET_NOT_MUTABLE", (Object[])null));
      } else {
         this.addElement(n);
      }
   }
