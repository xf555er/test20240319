...
public class XPath implements Serializable, ExpressionOwner {
   ...
   public XObject execute(XPathContext xctxt, int contextNode, PrefixResolver namespaceContext) throws TransformerException {
      ...
      try {
         ...
         var13.setLocator(this.getLocator());
         ...
         Exception e;
         for(e = var14; e instanceof WrappedRuntimeException; e = ((WrappedRuntimeException)e).getException()) {
         }

         String msg = e.getMessage();
         if (msg == null || msg.length() == 0) {
            msg = XSLMessages.createXPATHMessage("ER_XPATH_ERROR", (Object[])null);
         }
   ...
   public boolean bool(XPathContext xctxt, int contextNode, PrefixResolver namespaceContext) throws TransformerException {
      ...
      try {
         boolean var15 = this.m_mainExp.bool(xctxt);
         return var15;
      } catch (TransformerException var12) {
         var12.setLocator(this.getLocator());
         ErrorListener el = xctxt.getErrorListener();
         if (null == el) {
            throw var12;
         }
         ...
         Exception e;
         for(e = var13; e instanceof WrappedRuntimeException; e = ((WrappedRuntimeException)e).getException()) {
         }
