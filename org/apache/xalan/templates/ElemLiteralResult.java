...
public class ElemLiteralResult extends ElemUse {
   ...
   public class LiteralElementAttributes implements NamedNodeMap {
      ...
      public Node item(int i) {
         return this.getLength() != 0 && i < ElemLiteralResult.this.m_avts.size() ? ElemLiteralResult.this.new Attribute((AVT)ElemLiteralResult.this.m_avts.get(i), ElemLiteralResult.this) : null;
      }
