...
public class ElemNumber extends ElemTemplateElement {
   ...
   protected String tradAlphaCount(long val, XResourceBundle thisBundle) {
      if (val > Long.MAX_VALUE) {
         ...
         StringArrayWrapper tables = (StringArrayWrapper)((StringArrayWrapper)thisBundle.getObject("tables"));
         ...
         if (numbering.equals("multiplicative-additive")) {
            ...
            LongArrayWrapper multiplier = (LongArrayWrapper)((LongArrayWrapper)thisBundle.getObject("multiplier"));
               ...
               if (val < multiplier.getLong(i)) {
                  ...
                  for(int k = 0; k < groups.getLength(); ++k) {
                     ...
                     if (mult / (long)groups.getInt(k) > 0L) {
                        ...
                        char multiplierChar = ((CharArrayWrapper)((CharArrayWrapper)thisBundle.getObject("multiplierChar"))).getChar(i);
