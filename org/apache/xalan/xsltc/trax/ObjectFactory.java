...
final class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         synchronized(class$org$apache$xalan$xsltc$trax$ObjectFactory == null ? (class$org$apache$xalan$xsltc$trax$ObjectFactory = class$("org.apache.xalan.xsltc.trax.ObjectFactory")) : class$org$apache$xalan$xsltc$trax$ObjectFactory) {
