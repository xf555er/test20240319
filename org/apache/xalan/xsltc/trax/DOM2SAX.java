      ...
      if (node != null) {
         ...
         switch (node.getNodeType()) {
            case 1:
               ...
               for(i = 0; i < length; ++i) {
                  ...
                  if (!localName.startsWith("xmlns")) {
                     ...
                     localNameAttr = getLocalName(attr);
                     if (uriAttr != null) {
                        int colon = localName.lastIndexOf(58);
            ...
            default:
               break;
            case 3:
               localNameAttr = node.getNodeValue();
               this._sax.characters(localNameAttr.toCharArray(), 0, localNameAttr.length());
               break;
            case 4:
