...
public final class Transform {
   ...
   private void doTransform() {
      ...
      try {
         ...
         System.err.println(new ErrorMsg("RUNTIME_ERROR_KEY") + var15.getMessage());
         ...
         err = new ErrorMsg("FILE_NOT_FOUND_ERR", this._fileName);
         ...
         err = new ErrorMsg("INVALID_URI_ERR", this._fileName);
         System.err.println(new ErrorMsg("RUNTIME_ERROR_KEY") + err.toString());
         ...
         err = new ErrorMsg("CLASS_NOT_FOUND_ERR", this._className);
         System.err.println(new ErrorMsg("RUNTIME_ERROR_KEY") + err.toString());
         ...
         Exception ex = var21.getException();
         if (this._debug) {
            if (ex != null) {
               ex.printStackTrace();
            }
         ...
         System.err.println(new ErrorMsg("RUNTIME_ERROR_KEY") + var22.getMessage());
      }
