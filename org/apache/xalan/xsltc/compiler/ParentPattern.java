...
final class ParentPattern extends RelativePathPattern {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (this._right.isWildcard()) {
         ...
         local.setStart(il.append((org.apache.bcel.generic.Instruction)storeLocal));
      ...
      if (p != null && !(p instanceof Instruction) && !(p instanceof TopLevelElement)) {
         il.append((org.apache.bcel.generic.Instruction)DUP);
         InstructionHandle storeInst = il.append((org.apache.bcel.generic.Instruction)storeLocal);
