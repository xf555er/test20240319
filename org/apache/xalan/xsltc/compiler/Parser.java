...
public class Parser implements Constants, ContentHandler {
   ...
   public QName getQName(String namespace, String prefix, String localname) {
      if (namespace != null && !namespace.equals("")) {
         ...
         String lexicalQName = prefix != null && prefix.length() != 0 ? prefix + ':' + localname : localname;
         QName name;
         if (space == null) {
            ...
            name = (QName)space.get(lexicalQName);
            if (name == null) {
               name = new QName(namespace, prefix, localname);
               space.put(lexicalQName, name);
            }
   ...
   public SyntaxTreeNode parse(XMLReader reader, InputSource input) {
      try {
         ...
         this.reportError(3, new ErrorMsg(var5));
      } catch (SAXException var6) {
         Throwable ex = var6.getException();
         if (this._xsltc.debug()) {
         ...
         this.reportError(3, new ErrorMsg(var6));
         ...
         if (uri != null) {
            ...
            if (uri.equals("http://www.w3.org/1999/XSL/Transform")) {
               ...
               if (sheet != null && sheet.isExtension(uri) && sheet != (SyntaxTreeNode)this._parentStack.peek()) {
                  ...
                  ErrorMsg msg = new ErrorMsg("UNSUPPORTED_EXT_ERR", this.getLineNumber(), prefix + ":" + local);
   ...
   private void checkForSuperfluousAttributes(SyntaxTreeNode node, Attributes attrs) {
      ...
      String[] legal = (String[])((String[])this._instructionAttrs.get(qname));
