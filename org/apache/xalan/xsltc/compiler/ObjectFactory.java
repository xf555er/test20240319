...
final class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         synchronized(class$org$apache$xalan$xsltc$compiler$ObjectFactory == null ? (class$org$apache$xalan$xsltc$compiler$ObjectFactory = class$("org.apache.xalan.xsltc.compiler.ObjectFactory")) : class$org$apache$xalan$xsltc$compiler$ObjectFactory) {
