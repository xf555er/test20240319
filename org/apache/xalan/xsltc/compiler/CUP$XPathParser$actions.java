   ...
   public final Symbol CUP$XPathParser$do_action(int CUP$XPathParser$act_num, lr_parser CUP$XPathParser$parser, Stack CUP$XPathParser$stack, int CUP$XPathParser$top) throws Exception {
      ...
      switch (CUP$XPathParser$act_num) {
         ...
         case 108:
            ...
            if (this.parser.getQNameIgnoreDefaultNs("current").equals(fname)) {
               RESULT = new CurrentCall(fname);
            } else {
               XPathParser var10003;
               if (this.parser.getQNameIgnoreDefaultNs("number").equals(fname)) {
                  var10003 = this.parser;
               ...
               } else if (this.parser.getQNameIgnoreDefaultNs("concat").equals(fname)) {
                  var10003 = this.parser;
                  RESULT = new ConcatCall(fname, XPathParser.EmptyArgs);
               } else if (this.parser.getQNameIgnoreDefaultNs("true").equals(fname)) {
                  RESULT = new BooleanExpr(true);
               } else if (this.parser.getQNameIgnoreDefaultNs("false").equals(fname)) {
               ...
               } else if (this.parser.getQNameIgnoreDefaultNs("position").equals(fname)) {
                  RESULT = new PositionCall(fname);
               } else if (this.parser.getQNameIgnoreDefaultNs("last").equals(fname)) {
