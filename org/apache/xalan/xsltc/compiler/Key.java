...
final class Key extends TopLevelElement {
   ...
   public void traverseNodeSet(ClassGenerator classGen, MethodGenerator methodGen, int buildKeyIndex) {
      ...
      parentNode.setStart(il.append((org.apache.bcel.generic.Instruction)(new ISTORE(parentNode.getIndex()))));
      ...
      parentNode.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ILOAD(parentNode.getIndex()))));
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (this._useType instanceof NodeSetType) {
         ...
         il.append((org.apache.bcel.generic.Instruction)DUP);
         il.append((CompoundInstruction)(new PUSH(cpg, this._name.toString())));
         il.append((org.apache.bcel.generic.Instruction)DUP_X1);
         il.append(methodGen.loadCurrentNode());
         this._use.translate(classGen, methodGen);
