...
public class MethodGenerator extends MethodGen implements Constants {
   ...
   private Method outline(InstructionHandle first, InstructionHandle last, String outlinedMethodName, ClassGenerator classGen) {
      if (this.getExceptionHandlers().length != 0) {
         ...
         org.apache.bcel.generic.Type[] argTypes = new org.apache.bcel.generic.Type[]{(new ObjectType(argTypeName)).toJCType()};
         ...
         MethodGenerator outlinedMethodGen = new MethodGenerator(methodAttributes, org.apache.bcel.generic.Type.VOID, argTypes, argNames, outlinedMethodName, this.getClassName(), newIL, cpg);
         ...
         String varName;
         org.apache.bcel.generic.Type varType;
   ...
   private static Instruction loadLocal(int index, org.apache.bcel.generic.Type type) {
      if (type == org.apache.bcel.generic.Type.BOOLEAN) {
         ...
         return (Instruction)(type == org.apache.bcel.generic.Type.DOUBLE ? new DLOAD(index) : new ALOAD(index));
      }
   }

   private static Instruction storeLocal(int index, org.apache.bcel.generic.Type type) {
      if (type == org.apache.bcel.generic.Type.BOOLEAN) {
         ...
         return (Instruction)(type == org.apache.bcel.generic.Type.DOUBLE ? new DSTORE(index) : new ASTORE(index));
      }
   }
