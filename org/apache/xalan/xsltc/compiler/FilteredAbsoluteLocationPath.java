...
final class FilteredAbsoluteLocationPath extends Expression {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (this._path != null) {
         ...
         LocalVariableGen pathTemp = methodGen.addLocalVariable("filtered_absolute_location_path_tmp", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
