...
class StepPattern extends RelativePathPattern {
   ...
   private void translateSimpleContext(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      match.setStart(il.append((org.apache.bcel.generic.Instruction)(new ISTORE(match.getIndex()))));
      if (!this._isEpsilon) {
      ...
      LocalVariableGen stepIteratorTemp = methodGen.addLocalVariable("step_pattern_tmp2", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      stepIteratorTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(stepIteratorTemp.getIndex()))));
      ...
      il.append((org.apache.bcel.generic.Instruction)(new ILOAD(match.getIndex())));
      stepIteratorTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(stepIteratorTemp.getIndex()))));
      ...
      match.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ILOAD(match.getIndex()))));
      il.append(methodGen.storeCurrentNode());
   ...
   private void translateGeneralContext(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      node.setStart(il.append((org.apache.bcel.generic.Instruction)(new ISTORE(node.getIndex()))));
      LocalVariableGen iter = methodGen.addLocalVariable("step_pattern_tmp2", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      if (!classGen.isExternal()) {
         ...
         il.append((org.apache.bcel.generic.Instruction)DUP);
         iter.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(iter.getIndex()))));
         ifBlock = il.append((BranchInstruction)(new IFNONNULL((InstructionHandle)null)));
         il.append(classGen.loadTranslet());
      }

      this._step.translate(classGen, methodGen);
      InstructionHandle iterStore = il.append((org.apache.bcel.generic.Instruction)(new ASTORE(iter.getIndex())));
      if (!classGen.isExternal()) {
      ...
      node2.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ILOAD(node2.getIndex()))));
      node.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ILOAD(node.getIndex()))));
