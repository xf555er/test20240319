   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this._disabled) {
         ...
         if (this._compiled && this.isNamed()) {
            ...
            il.append((org.apache.bcel.generic.Instruction)(new INVOKEVIRTUAL(cpg.addMethodref(className, methodName, "(Lorg/apache/xalan/xsltc/DOM;Lorg/apache/xml/dtm/DTMAxisIterator;" + TRANSLET_OUTPUT_SIG + "I)V"))));
