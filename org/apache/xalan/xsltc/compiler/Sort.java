...
final class Sort extends Instruction implements Closure {
   ...
   public static void translateSortIterator(ClassGenerator classGen, MethodGenerator methodGen, Expression nodeSet, Vector sortObjects) {
      ...
      LocalVariableGen nodesTemp = methodGen.addLocalVariable("sort_tmp1", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      LocalVariableGen sortRecordFactoryTemp = methodGen.addLocalVariable("sort_tmp2", Util.getJCRefType("Lorg/apache/xalan/xsltc/dom/NodeSortRecordFactory;"), (InstructionHandle)null, (InstructionHandle)null);
      if (nodeSet == null) {
      ...
      nodesTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(nodesTemp.getIndex()))));
      compileSortRecordFactory(sortObjects, classGen, methodGen);
      sortRecordFactoryTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(sortRecordFactoryTemp.getIndex()))));
      ...
      nodesTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(nodesTemp.getIndex()))));
      sortRecordFactoryTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(sortRecordFactoryTemp.getIndex()))));
   ...
   public static void compileSortRecordFactory(Vector sortObjects, ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      for(int level = 0; level < nsorts; ++level) {
         ...
         il.append((org.apache.bcel.generic.Instruction)AASTORE);
      }

      sortOrderTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(sortOrderTemp.getIndex()))));
      ...
      sortTypeTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(sortTypeTemp.getIndex()))));
      ...
      sortLangTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(sortLangTemp.getIndex()))));
      ...
      sortCaseOrderTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(sortCaseOrderTemp.getIndex()))));
      ...
      sortOrderTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(sortOrderTemp.getIndex()))));
      sortTypeTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(sortTypeTemp.getIndex()))));
      sortLangTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(sortLangTemp.getIndex()))));
      sortCaseOrderTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(sortCaseOrderTemp.getIndex()))));
   ...
   public static String compileSortRecordFactory(Vector sortObjects, ClassGenerator classGen, MethodGenerator methodGen, String sortRecordClass) {
      ...
      il.append((org.apache.bcel.generic.Instruction)ALOAD_1);
      il.append((org.apache.bcel.generic.Instruction)ALOAD_2);
      ...
      il.append((org.apache.bcel.generic.Instruction)RETURN);
      ...
      il.append((org.apache.bcel.generic.Instruction)ALOAD_0);
      il.append((org.apache.bcel.generic.Instruction)ILOAD_1);
      il.append((org.apache.bcel.generic.Instruction)ILOAD_2);
      ...
      il.append((org.apache.bcel.generic.Instruction)POP);
      il.append((org.apache.bcel.generic.Instruction)ARETURN);
