...
public final class Stylesheet extends SyntaxTreeNode {
   ...
   private void compileStaticInitializer(ClassGenerator classGen) {
      ...
      il.append((org.apache.bcel.generic.Instruction)(new PUTSTATIC(i)));
      ...
      for(urisArrayRef = 0; urisArrayRef < size; ++urisArrayRef) {
         ...
         staticConst.markChunkStart();
         il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(i)));
      ...
      il.append((org.apache.bcel.generic.Instruction)(new PUTSTATIC(urisArrayRef)));
      staticConst.markChunkEnd();
      ...
      for(typesArrayRef = 0; typesArrayRef < size; ++typesArrayRef) {
         ...
         staticConst.markChunkStart();
         il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(urisArrayRef)));
      ...
      staticConst.markChunkStart();
      il.append((CompoundInstruction)(new PUSH(cpg, size)));
      il.append((org.apache.bcel.generic.Instruction)(new NEWARRAY(BasicType.INT)));
      typesArrayRef = cpg.addFieldref(this._className, "_sTypesArray", "[I");
      il.append((org.apache.bcel.generic.Instruction)(new PUTSTATIC(typesArrayRef)));
      staticConst.markChunkEnd();
      ...
      for(int i = 0; i < size; ++i) {
         ...
         staticConst.markChunkStart();
         il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(typesArrayRef)));
         il.append((CompoundInstruction)(new PUSH(cpg, i)));
         il.append((CompoundInstruction)(new PUSH(cpg, namespaceArrayRef)));
         il.append((org.apache.bcel.generic.Instruction)IASTORE);
         staticConst.markChunkEnd();
      }
      ...
      il.append((org.apache.bcel.generic.Instruction)(new PUTSTATIC(namespaceArrayRef)));
      staticConst.markChunkEnd();

      for(int i = 0; i < namespaces.size(); ++i) {
         String ns = (String)namespaces.elementAt(i);
         staticConst.markChunkStart();
         il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(namespaceArrayRef)));
         il.append((CompoundInstruction)(new PUSH(cpg, i)));
      ...
      if (namespaceAncestors != null && namespaceAncestors.size() != 0) {
         ...
         il.append((org.apache.bcel.generic.Instruction)(new PUTSTATIC(namespaceAncestorsArrayRef)));
         staticConst.markChunkEnd();
         ...
         for(prefixURIPairsIdxArrayRef = 0; prefixURIPairsIdxArrayRef < namespaceAncestors.size(); ++prefixURIPairsIdxArrayRef) {
            ...
            staticConst.markChunkStart();
            il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(namespaceAncestorsArrayRef)));
      ...
      if (prefixURIPairsIdx != null && prefixURIPairsIdx.size() != 0) {
         ...
         il.append((org.apache.bcel.generic.Instruction)(new PUTSTATIC(prefixURIPairsIdxArrayRef)));
         staticConst.markChunkEnd();
         ...
         for(prefixURIPairsRef = 0; prefixURIPairsRef < prefixURIPairsIdx.size(); ++prefixURIPairsRef) {
            ...
            staticConst.markChunkStart();
            il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(prefixURIPairsIdxArrayRef)));
            il.append((CompoundInstruction)(new PUSH(cpg, prefixURIPairsRef)));
      ...
      if (prefixURIPairs != null && prefixURIPairs.size() != 0) {
         ...
         il.append((org.apache.bcel.generic.Instruction)(new PUTSTATIC(prefixURIPairsRef)));
         staticConst.markChunkEnd();

         for(toCharArray = 0; toCharArray < prefixURIPairs.size(); ++toCharArray) {
            String prefixOrURI = (String)prefixURIPairs.get(toCharArray);
            staticConst.markChunkStart();
            il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(prefixURIPairsRef)));
            il.append((CompoundInstruction)(new PUSH(cpg, toCharArray)));
   ...
   private String compileTopLevel(ClassGenerator classGen) {
      ...
      LocalVariableGen current = toplevel.addLocalVariable("current", org.apache.bcel.generic.Type.INT, (InstructionHandle)null, (InstructionHandle)null);
      ...
      il.append((org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(gitr, 1)));
      il.append(toplevel.nextNode());
      current.setStart(il.append((org.apache.bcel.generic.Instruction)(new ISTORE(current.getIndex()))));
   ...
   private void compileTransform(ClassGenerator classGen) {
      ...
      LocalVariableGen current = transf.addLocalVariable("current", org.apache.bcel.generic.Type.INT, (InstructionHandle)null, (InstructionHandle)null);
      ...
      int gitr;
      if (this.isMultiDocument()) {
         gitr = cpg.addMethodref("org.apache.xalan.xsltc.dom.MultiDOM", "<init>", "(Lorg/apache/xalan/xsltc/DOM;)V");
         il.append((org.apache.bcel.generic.Instruction)(new INVOKESPECIAL(gitr)));
      }

      il.append((org.apache.bcel.generic.Instruction)(new PUTFIELD(domField)));
      gitr = cpg.addInterfaceMethodref("org.apache.xalan.xsltc.DOM", "getIterator", "()Lorg/apache/xml/dtm/DTMAxisIterator;");
      il.append(transf.loadDOM());
      il.append((org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(gitr, 1)));
