...
final class XslElement extends Instruction {
   ...
   public void translateLiteral(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this._ignore) {
         ...
         il.append((org.apache.bcel.generic.Instruction)DUP2);
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (this._isLiteralName) {
         ...
         if (!this._ignore) {
            ...
            this._name.translate(classGen, methodGen);
            nameValue.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(nameValue.getIndex()))));
            ...
            il.append(methodGen.loadHandler());
            nameValue.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(nameValue.getIndex()))));
            if (this._namespace != null) {
               this._namespace.translate(classGen, methodGen);
            } else {
               ...
               il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(cpg.addFieldref(transletClassName, "_sNamespaceAncestorsArray", "[I"))));
               il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(cpg.addFieldref(transletClassName, "_sPrefixURIsIdxArray", "[I"))));
               il.append((org.apache.bcel.generic.Instruction)(new GETSTATIC(cpg.addFieldref(transletClassName, "_sPrefixURIPairsArray", "[Ljava/lang/String;"))));
               il.append(ICONST_0);
               il.append((org.apache.bcel.generic.Instruction)(new INVOKESTATIC(cpg.addMethodref("org.apache.xalan.xsltc.runtime.BasisLibrary", "lookupStylesheetQNameNamespace", "(Ljava/lang/String;I[I[I[Ljava/lang/String;Z)Ljava/lang/String;"))));
            }

            il.append(methodGen.loadHandler());
            il.append(methodGen.loadDOM());
            il.append(methodGen.loadCurrentNode());
            il.append((org.apache.bcel.generic.Instruction)(new INVOKESTATIC(cpg.addMethodref("org.apache.xalan.xsltc.runtime.BasisLibrary", "startXslElement", "(Ljava/lang/String;Ljava/lang/String;" + TRANSLET_OUTPUT_SIG + "Lorg/apache/xalan/xsltc/DOM;" + "I)" + "Ljava/lang/String;"))));
         }
