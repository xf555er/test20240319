...
final class DecimalFormatting extends TopLevelElement {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      nAttributes = this._attributes.getLength();

      int put;
      for(put = 0; put < nAttributes; ++put) {
         String name = this._attributes.getQName(put);
         String value = this._attributes.getValue(put);
         boolean valid = true;
         int method = 0;
      ...
      put = cpg.addMethodref("org.apache.xalan.xsltc.runtime.AbstractTranslet", "addDecimalFormat", "(Ljava/lang/String;Ljava/text/DecimalFormatSymbols;)V");
