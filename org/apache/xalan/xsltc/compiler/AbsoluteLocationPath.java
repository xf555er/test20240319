...
final class AbsoluteLocationPath extends Expression {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (this._path != null) {
         ...
         LocalVariableGen relPathIterator = methodGen.addLocalVariable("abs_location_path_tmp", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
         relPathIterator.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(relPathIterator.getIndex()))));
         ...
         relPathIterator.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(relPathIterator.getIndex()))));
