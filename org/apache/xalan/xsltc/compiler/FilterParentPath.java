...
final class FilterParentPath extends Expression {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      LocalVariableGen filterTemp = methodGen.addLocalVariable("filter_parent_path_tmp1", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      filterTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(filterTemp.getIndex()))));
      this._path.translate(classGen, methodGen);
      LocalVariableGen pathTemp = methodGen.addLocalVariable("filter_parent_path_tmp2", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      pathTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(pathTemp.getIndex()))));
      ...
      filterTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(filterTemp.getIndex()))));
      pathTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(pathTemp.getIndex()))));
