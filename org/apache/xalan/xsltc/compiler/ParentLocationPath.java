...
final class ParentLocationPath extends RelativeLocationPath {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      LocalVariableGen pathTemp = methodGen.addLocalVariable("parent_location_path_tmp1", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      ...
      LocalVariableGen stepTemp = methodGen.addLocalVariable("parent_location_path_tmp2", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      stepTemp.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(stepTemp.getIndex()))));
      ...
      stepTemp.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(stepTemp.getIndex()))));
