...
final class CopyOf extends Instruction {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (tselect instanceof NodeSetType) {
         ...
         this._select.translate(classGen, methodGen);
         il.append(methodGen.loadHandler());
         il.append((org.apache.bcel.generic.Instruction)(new INVOKEVIRTUAL(cpg.addMethodref("org.apache.xalan.xsltc.runtime.AbstractTranslet", "characters", CHARACTERSW_SIG))));
      }
