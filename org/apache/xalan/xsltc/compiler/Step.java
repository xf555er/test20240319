      ...
      if (this._predicates.size() == 0) {
         ...
         if (predicate.isNodeValueTest()) {
            ...
            if (predicate.isNthPositionFilter()) {
               ...
               this.translatePredicates(classGen, methodGen);
               iteratorTemp = methodGen.addLocalVariable("step_tmp1", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
               ...
               predicateValueTemp = methodGen.addLocalVariable("step_tmp2", Util.getJCRefType("Lorg/apache/xalan/xsltc/dom/CurrentNodeListFilter;"), (InstructionHandle)null, (InstructionHandle)null);
