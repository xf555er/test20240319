...
final class Copy extends Instruction {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      name.setStart(il.append((org.apache.bcel.generic.Instruction)(new ASTORE(name.getIndex()))));
      ...
      length.setStart(il.append((org.apache.bcel.generic.Instruction)(new ISTORE(length.getIndex()))));
      if (this._useSets != null) {
      ...
      length.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ILOAD(length.getIndex()))));
      BranchHandle ifBlock3 = il.append((BranchInstruction)(new IFEQ((InstructionHandle)null)));
      il.append(methodGen.loadHandler());
      name.setEnd(il.append((org.apache.bcel.generic.Instruction)(new ALOAD(name.getIndex()))));
