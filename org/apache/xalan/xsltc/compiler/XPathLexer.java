...
class XPathLexer implements Scanner {
   ...
   Symbol disambiguateAxisOrFunction(int ss) throws Exception {
      ...
      if (index >= this.yy_buffer_read) {
         ...
         return (this.yy_buffer[index] != ':' || this.yy_buffer[index + 1] != ':') && this.yy_buffer[index] != '(' ? this.newSymbol(28, (String)this.yytext()) : this.newSymbol(ss);
      }
   }
   ...
   Symbol disambiguateOperator(int ss) throws Exception {
      switch (this.last) {
         ...
         case 33:
         case 34:
            return this.newSymbol(28, (String)this.yytext());
         case 0:
         case 1:
         case 3:
         case 5:
      ...
      while(true) {
         ...
         if (-1 != yy_next_state) {
            ...
            switch (yy_last_accept_state) {
               ...
               case 21:
                  return this.newSymbol(52, (Long)(new Long(this.yytext())));
               case 22:
               ...
               case 28:
                  return this.newSymbol(51, (Double)(new Double(this.yytext())));
               case 29:
               ...
               case 32:
                  return this.newSymbol(27, (String)this.yytext().substring(1, this.yytext().length() - 1));
               case 33:
                  return this.newSymbol(27, (String)this.yytext().substring(1, this.yytext().length() - 1));
               case 34:
                  return this.newSymbol(51, (Double)(new Double(this.yytext())));
