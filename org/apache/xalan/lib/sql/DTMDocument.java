...
public class DTMDocument extends DTMDefaultBaseIterators {
   ...
   protected int addAttributeToNode(Object o, int extendedType, int pnode) {
      ...
      try {
         ...
         this.error("Error in addAttributeToNode: " + var7.getMessage());
      }
   ...
   public XMLString getStringValue(int nodeHandle) {
      ...
      if (o == "#element") {
         ...
         return o != null ? this.m_xstrf.newstr(o.toString()) : this.m_xstrf.emptystr();
      }
   }
   ...
   public int getNextAttribute(int parm1) {
      ...
      return nodeIdx != -1 ? this.makeNodeHandle(this.m_nextsib.elementAt(nodeIdx)) : -1;
   }
