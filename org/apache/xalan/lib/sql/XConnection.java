   ...
   public DTM query(ExpressionContext exprContext, String queryString) {
      ...
      try {
         try {
            ...
            query = this.m_QueryParser.parse(this, queryString, 1);
            ...
            if (doc != null) {
               if (doc.hasErrors()) {
                  this.setError(var8, doc, doc.checkWarnings());
               }
   ...
   public DTM pquery(ExpressionContext exprContext, String queryString, String typeInfo) {
      ...
      try {
         try {
            ...
            query = this.m_QueryParser.parse(this, queryString, 0);
            ...
            if (doc != null) {
               if (doc.hasErrors()) {
                  this.setError(var9, doc, doc.checkWarnings());
               }
