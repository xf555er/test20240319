...
final class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         synchronized(class$org$apache$xalan$lib$sql$ObjectFactory == null ? (class$org$apache$xalan$lib$sql$ObjectFactory = class$("org.apache.xalan.lib.sql.ObjectFactory")) : class$org$apache$xalan$lib$sql$ObjectFactory) {
