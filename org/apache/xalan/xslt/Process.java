...
public class Process {
   ...
   public static void main(String[] argv) {
      ...
      ResourceBundle resbundle = XSLMessages.loadResourceBundle("org.apache.xalan.res.XSLTErrorResources");
      String flavor = "s2s";
      if (argv.length < 1) {
         ...
         } catch (TransformerFactoryConfigurationError var64) {
            var64.printStackTrace(diagnosticsWriter);
            ...
            if (!"-XSLTC".equalsIgnoreCase(argv[i])) {
               if ("-TT".equalsIgnoreCase(argv[i])) {
                  ...
                  if (i + 1 < argv.length && argv[i + 1].charAt(0) != '-') {
                     ++i;
                     int var71 = Integer.parseInt(argv[i]);
                  } else {
                     boolean var70 = false;
                  }
                  ...
                  if ("-V".equalsIgnoreCase(argv[i])) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ObjectFactory.ConfigurationError var63) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ObjectFactory.ConfigurationError var62) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ObjectFactory.ConfigurationError var61) {
                     ...
                     } catch (TransformerConfigurationException var60) {
                     }
                  } else {
         ...
         try {
            ...
            if (null != xslFileName) {
               if (flavor.equals("d2d")) {
                  ...
                  if (isSecureProcessing) {
                     ...
                     } catch (ParserConfigurationException var59) {
                     }
                  }
               ...
               if (null != inFileName) {
                  if (flavor.equals("d2d")) {
                     ...
                     if (isSecureProcessing) {
                        try {
                           dfactory.setFeature("http://javax.xml.XMLConstants/feature/secure-processing", true);
                        } catch (ParserConfigurationException var58) {
                        }
                     }
                     ...
                     for(i = 0; i < 1; ++i) {
                        ...
                        } catch (ParserConfigurationException var54) {
                           throw new SAXException(var54);
                        } catch (FactoryConfigurationError var55) {
                           throw new SAXException(var55.toString());
                        } catch (NoSuchMethodError var56) {
                        } catch (AbstractMethodError var57) {
                        }
            ...
            Object throwable;
            for(throwable = var65; throwable instanceof WrappedRuntimeException; throwable = ((WrappedRuntimeException)throwable).getException()) {
            }
