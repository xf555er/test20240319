...
public class HTMLDocumentImpl extends DocumentImpl implements HTMLDocument {
   ...
   public synchronized Element getElementById(String var1) {
      Element var2 = super.getElementById(var1);
      return var2 != null ? var2 : this.getElementById(var1, this);
   }
   ...
   protected boolean canRenameElements(String var1, String var2, ElementImpl var3) {
      if (var3.getNamespaceURI() != null) {
         ...
         Class var4 = (Class)_elementTypesHTML.get(var2.toUpperCase(Locale.ENGLISH));
         Class var5 = (Class)_elementTypesHTML.get(var3.getTagName());
         return var4 == var5;
      }
   }
   ...
   private static void populateElementType(String var0, String var1) {
      try {
         ...
         throw new RuntimeException("HTM019 OpenXML Error: Could not find or execute class " + var1 + " implementing HTML element " + var0 + "\n" + var1 + "\t" + var0);
      }
   }
