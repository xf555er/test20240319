...
public class HTMLBuilder implements DocumentHandler {
   ...
   public void characters(String var1) throws SAXException {
      if (this._current == null) {
         ...
         this._current.appendChild(this._document.createTextNode(var1));
      }
   }
   ...
   public void characters(char[] var1, int var2, int var3) throws SAXException {
      if (this._current == null) {
         ...
         this._current.appendChild(this._document.createTextNode(new String(var1, var2, var3)));
      }
   }
   ...
   public void processingInstruction(String var1, String var2) throws SAXException {
      if (this._current == null && this._document == null) {
         ...
         this._document.appendChild(this._document.createProcessingInstruction(var1, var2));
      } else {
         this._current.appendChild(this._document.createProcessingInstruction(var1, var2));
      }
