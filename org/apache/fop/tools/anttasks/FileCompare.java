...
public class FileCompare {
   ...
   public void setFilenames(String filenames) {
      ...
      this.filenameList = (String[])((String[])filenameListTmp.toArray(new String[filenameListTmp.size()]));
   }
   ...
   public void execute() throws BuildException {
      ...
      try {
         ...
         String[] var5 = this.filenameList;
         int var6 = var5.length;

         for(int var7 = 0; var7 < var6; ++var7) {
            String aFilenameList = var5[var7];
            File oldFile = new File(this.referenceDirectory + aFilenameList);
            File newFile = new File(this.testDirectory + aFilenameList);
