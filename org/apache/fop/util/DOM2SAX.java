            ...
            case 1:
               ...
               for(i = 0; i < length; ++i) {
                  ...
                  if (localName.startsWith("xmlns")) {
                     ...
                     colon = localName.lastIndexOf(58);
                     prefix = colon > 0 ? localName.substring(colon + 1) : "";
               ...
               for(i = 0; i < length; ++i) {
                  ...
                  if (!localName.startsWith("xmlns")) {
                     ...
                     if (uriAttr != null) {
                        colon = localName.lastIndexOf(58);
                        prefix = colon > 0 ? localName.substring(0, colon) : "";
                        if (this.startPrefixMapping(prefix, uriAttr)) {
                           pushedPrefixes.add(prefix);
                        }
                     }
               ...
               Iterator var20 = pushedPrefixes.iterator();

               while(var20.hasNext()) {
                  Object pushedPrefixe = var20.next();
                  this.endPrefixMapping((String)pushedPrefixe);
               }
            case 2:
            case 5:
            case 6:
