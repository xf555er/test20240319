...
public class AFMParser {
   ...
   public AFMFile parse(InputStream in, String afmFileName) throws IOException {
      ...
      AFMFile var4;
      try {
         var4 = this.parse(new BufferedReader(reader), afmFileName);
      } finally {
      ...
      while(true) {
         ...
         switch (parseMode) {
            case 0:
               ...
               break;
            case 1:
               key = this.parseCharMetrics(line, stack, afmFileName);
               break;
            default:
   ...
   private String parseCharMetrics(String line, Stack stack, String afmFileName) throws IOException {
      String trimmedLine = line.trim();
      if ("EndCharMetrics".equals(trimmedLine)) {
         return trimmedLine;
      } else {
   ...
   static {
      ...
      PARSE_MODE_CHANGES.put("StartCharMetrics", 1);
      PARSE_MODE_CHANGES.put("EndCharMetrics", 0);
   }
   ...
   private static class BooleanSetter extends AbstractValueHandler {
      ...
      public void parse(String line, int startpos, Stack stack) throws IOException {
         ...
         Object target = this.getContextObject(stack);
         Class c = target.getClass();

         try {
            Method mth = c.getMethod(this.method, Boolean.TYPE);
            mth.invoke(target, b);
         } catch (NoSuchMethodException var8) {
            throw new RuntimeException("Bean error: " + var8.getMessage(), var8);
         } catch (IllegalAccessException var9) {
            throw new RuntimeException("Bean error: " + var9.getMessage(), var9);
         } catch (InvocationTargetException var10) {
            throw new RuntimeException("Bean error: " + var10.getMessage(), var10);
         }
      }
   }
   ...
   private static class WritingDirDoubleSetter extends WritingDirNumberSetter {
      ...
      public void parse(String line, int startpos, Stack stack) throws IOException {
         ...
         this.setValue(this.getContextObject(stack), Double.TYPE, value);
      }
   }
   ...
   private static class IntegerSetter extends NumberSetter {
      ...
      public void parse(String line, int startpos, Stack stack) throws IOException {
         ...
         this.setValue(this.getContextObject(stack), Integer.TYPE, value);
      }
   }
   ...
   private static class NumberSetter extends BeanSetter {
      ...
      public void parse(String line, int startpos, Stack stack) throws IOException {
         ...
         this.setValue(this.getContextObject(stack), Number.class, num);
      }
   }
   ...
   private static class NamedCharacterSetter extends BeanSetter {
      ...
      public void parse(String line, int startpos, Stack stack) throws IOException {
         ...
         this.setValue(obj, NamedCharacter.class, ch);
      }
   }
   ...
   private static class StringSetter extends BeanSetter {
      ...
      public void parse(String line, int startpos, Stack stack) throws IOException {
         ...
         Object obj = stack.peek();
         this.setValue(obj, String.class, s);
      }
   }
   ...
   private abstract static class BeanSetter extends AbstractValueHandler {
      ...
      protected void setValue(Object target, Class argType, Object value) {
         ...
         try {
            Method mth = c.getMethod(this.method, argType);
            mth.invoke(target, value);
         } catch (NoSuchMethodException var6) {
            throw new RuntimeException("Bean error: " + var6.getMessage(), var6);
         } catch (IllegalAccessException var7) {
            throw new RuntimeException("Bean error: " + var7.getMessage(), var7);
   ...
   private abstract static class AbstractValueHandler implements ValueHandler {
      ...
      protected Number getNumberValue(String line, int startpos) {
         try {
            return this.getIntegerValue(line, startpos);
         } catch (NumberFormatException var4) {
            return this.getDoubleValue(line, startpos);
         }
      }
