...
public class FullyQualifiedNameTriplet extends AbstractTriplet {
   ...
   private String encoding = "Cp1146";
   ...
   public int getDataLength() {
      return 4 + this.fqName.length() * this.charlen;
   }
   ...
   public void writeToStream(OutputStream os) throws IOException {
      ...
      byte[] fqNameBytes;
      try {
         fqNameBytes = this.fqName.getBytes(this.encoding);
      } catch (UnsupportedEncodingException var5) {
         throw new IllegalArgumentException(this.encoding + " encoding failed");
      }
