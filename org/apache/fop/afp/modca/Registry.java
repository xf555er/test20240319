...
public final class Registry {
   ...
   private void init() {
      ...
      this.mimeObjectTypeMap.put("image/x-afp+truetype", new ObjectType((byte)51, new byte[]{6, 7, 43, 18, 0, 4, 1, 1, 51}, "TrueType/OpenType Font Resource Object", true, "image/x-afp+truetype"));
   }
