...
public class Base14FontCollection implements FontCollection {
   ...
   public int setup(int start, FontInfo fontInfo) {
      ...
      int italic = true;
      int bolditalic = true;
      FontMetricsMapper metric = new SystemFontMetricsMapper("SansSerif", 0, this.java2DFontMetrics);
      fontInfo.addMetrics("F1", metric);
      metric = new SystemFontMetricsMapper("SansSerif", 2, this.java2DFontMetrics);
      fontInfo.addMetrics("F2", metric);
      metric = new SystemFontMetricsMapper("SansSerif", 1, this.java2DFontMetrics);
      fontInfo.addMetrics("F3", metric);
      metric = new SystemFontMetricsMapper("SansSerif", 3, this.java2DFontMetrics);
      fontInfo.addMetrics("F4", metric);
      metric = new SystemFontMetricsMapper("Serif", 0, this.java2DFontMetrics);
      fontInfo.addMetrics("F5", metric);
      metric = new SystemFontMetricsMapper("Serif", 2, this.java2DFontMetrics);
      fontInfo.addMetrics("F6", metric);
      metric = new SystemFontMetricsMapper("Serif", 1, this.java2DFontMetrics);
      fontInfo.addMetrics("F7", metric);
      metric = new SystemFontMetricsMapper("Serif", 3, this.java2DFontMetrics);
      fontInfo.addMetrics("F8", metric);
      metric = new SystemFontMetricsMapper("MonoSpaced", 0, this.java2DFontMetrics);
      fontInfo.addMetrics("F9", metric);
      metric = new SystemFontMetricsMapper("MonoSpaced", 2, this.java2DFontMetrics);
      fontInfo.addMetrics("F10", metric);
      metric = new SystemFontMetricsMapper("MonoSpaced", 1, this.java2DFontMetrics);
      fontInfo.addMetrics("F11", metric);
      metric = new SystemFontMetricsMapper("MonoSpaced", 3, this.java2DFontMetrics);
