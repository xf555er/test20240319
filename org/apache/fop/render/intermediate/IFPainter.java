...
public interface IFPainter {
   ...
   void startGroup(AffineTransform[] var1, String var2) throws IFException;
   ...
   void drawText(int var1, int var2, int var3, int var4, int[][] var5, String var6, boolean var7) throws IFException;

   void clipRect(Rectangle var1) throws IFException;

   void clipBackground(Rectangle var1, BorderProps var2, BorderProps var3, BorderProps var4, BorderProps var5) throws IFException;

   boolean isBackgroundRequired(BorderProps var1, BorderProps var2, BorderProps var3, BorderProps var4);

   void fillRect(Rectangle var1, Paint var2) throws IFException;

   void drawBorderRect(Rectangle var1, BorderProps var2, BorderProps var3, BorderProps var4, BorderProps var5, Color var6) throws IFException;
