...
public abstract class AbstractXMLWritingIFDocumentHandler extends AbstractIFDocumentHandler {
   ...
   public void setResult(Result result) throws IFException {
      if (result instanceof SAXResult) {
         ...
         this.handler = new GenerationHelperContentHandler(saxResult.getHandler(), this.getMainNamespace(), this.getContext());
      } else {
         this.handler = new GenerationHelperContentHandler(this.createContentHandler(result), this.getMainNamespace(), this.getContext());
      }
