...
public class RTFHandler extends FOEventHandler {
   ...
   public RTFHandler(FOUserAgent userAgent, OutputStream os) {
      ...
      FontSetup.setup(this.fontInfo, (List)null, userAgent.getResourceResolver(), base14Kerning);
   }
         ...
         if (this.pagemaster == null) {
            ...
            if (this.pagemaster == null) {
               ...
               if (pageSeq.getMainFlow() != null) {
                  this.pagemaster = master.getNextSimplePageMaster(false, false, false, false, pageSeq.getMainFlow().getFlowName());
               }
            }
         }
   ...
   public void endBlock(Block bl) {
      if (!this.bDefer) {
         try {
            ...
            int breakValue = this.toRtfBreakValue(bl.getBreakAfter());
            textrun.popBlockAttributes(breakValue);
         } catch (IOException var7) {
            this.handleIOTrouble(var7);
         } catch (Exception var8) {
            log.error("startBlock:" + var8.getMessage());
   ...
   public void startColumn(TableColumn tc) {
      if (!this.bDefer) {
         try {
            ...
            this.builderContext.getTableContext().setNextColumnRowSpanning(0, (RtfAttributes)null);
   ...
   public void startHeader(TableHeader header) {
      this.builderContext.pushPart(header);
      this.startPart(header);
   }

   public void endHeader(TableHeader header) {
      this.builderContext.popPart(header.getClass(), this);
      this.endPart(header);
   }

   public void startFooter(TableFooter footer) {
      this.builderContext.pushPart(footer);
      this.startPart(footer);
   }

   public void endFooter(TableFooter footer) {
      this.builderContext.popPart(footer.getClass(), this);
      this.endPart(footer);
   }
   ...
   public void startBody(TableBody body) {
      this.builderContext.pushPart(body);
      this.startPart(body);
   }
      ...
      if (!this.bDefer) {
         try {
            ...
            if (numberRowsSpanned > 1) {
               ...
               tctx.setCurrentColumnRowSpanning(numberRowsSpanned, (RtfAttributes)null);
            }
   ...
   public void endCell(TableCell tc) {
      if (!this.bDefer) {
         try {
            RtfTableCell cell = (RtfTableCell)this.builderContext.getContainer(RtfTableCell.class, false, this);
            cell.finish();
         } catch (Exception var3) {
            log.error("endCell: " + var3.getMessage());
   ...
   public void startListLabel(ListItemLabel listItemLabel) {
      if (!this.bDefer) {
         try {
            ...
            log.error("startPageNumber: " + var5.getMessage());
            throw new RuntimeException(var5.getMessage());
         }
   ...
   public void image(ExternalGraphic eg) {
      if (!this.bDefer) {
         ...
         try {
            ...
            eventProducer.imageError(this, uri, var6, (Locator)null);
   ...
   public void startLeader(Leader l) {
      if (!this.bDefer) {
         try {
            ...
            log.error("startLeader: " + var6.getMessage());
            throw new RuntimeException(var6.getMessage());
         }
      }
   }
   ...
   public void text(FOText text, CharSequence characters) {
      if (!this.bDefer) {
         try {
            ...
            log.error("characters:" + var7.getMessage());
            throw new RuntimeException(var7.getMessage());
         }
   ...
   public void startPageNumberCitationLast(PageNumberCitationLast l) {
      if (!this.bDefer) {
         try {
            ...
            RtfTextrun textrun = container.getTextrun();
            textrun.addPageNumberCitation(l.getRefId());
         } catch (RtfException var4) {
            log.error("startPageNumberCitationLast: " + var4.getMessage());
            throw new RuntimeException(var4.getMessage());
         } catch (IOException var5) {
            log.error("startPageNumberCitationLast: " + var5.getMessage());
            throw new RuntimeException(var5.getMessage());
         }
      }
   }
   ...
   private void invokeDeferredEvent(FONode foNode, boolean bStart) {
      if (foNode instanceof PageSequence) {
         ...
         if (bStart) {
            this.startStatic((StaticContent)null);
         } else {
            this.endStatic((StaticContent)null);
         }
         ...
         if (bStart) {
            this.endInstreamForeignObject((InstreamForeignObject)foNode);
         }
         ...
         if (bStart) {
            ...
            this.text(text, text.getCharSequence());
         }
         ...
         if (bStart) {
            this.startListLabel((ListItemLabel)null);
         } else {
            this.endListLabel((ListItemLabel)null);
         }
