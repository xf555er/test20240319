...
public class RtfExternalGraphic extends RtfElement {
            ...
            if (this.url != null && linkToRoot != null) {
               ...
               if (this.imagedata == null) {
                  try {
                     ...
                     throw new ExternalGraphicException("The attribute 'src' of <fo:external-graphic> has a invalid value: '" + this.url + "' (" + var12 + ")");
                  }
               }
               ...
               if (this.imagedata != null) {
                  ...
                  if (this.imageformat != null && this.imageformat.getType() != -1 && !"".equals(this.imageformat.getRtfTag())) {
                     ...
                     byte[] var4 = this.imagedata;
                     int var5 = var4.length;

                     for(int var6 = 0; var6 < var5; ++var6) {
                        byte anImagedata = var4[var6];
                        int iData = anImagedata;
                        if (anImagedata < 0) {
                           iData = anImagedata + 256;
                        }
   ...
   private void writeSizeInfo() throws IOException {
      ...
      if (this.cropValues[0] != 0) {
         this.writeOneAttribute("piccropl", this.cropValues[0]);
      }

      if (this.cropValues[1] != 0) {
         this.writeOneAttribute("piccropt", this.cropValues[1]);
      }

      if (this.cropValues[2] != 0) {
         this.writeOneAttribute("piccropr", this.cropValues[2]);
      }

      if (this.cropValues[3] != 0) {
         this.writeOneAttribute("piccropb", this.cropValues[3]);
      }
