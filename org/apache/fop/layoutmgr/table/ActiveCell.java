...
class ActiveCell {
         ...
         if (el.isPenalty()) {
            ...
            if (el.isGlue()) {
               if (prevIsBox) {
                  ...
                  var5 = this.afterNextStep;
                  var5.contentLength = var5.contentLength + el.getWidth();
                  if (!boxFound) {
                     var5 = this.afterNextStep;
                     var5.condBeforeContentLength = var5.condBeforeContentLength + el.getWidth();
                  }
               }
   ...
   void nextRowStarts() {
      ++this.spanIndex;
      Step var1 = this.nextStep;
      var1.totalLength = var1.totalLength - this.bpAfterTrailing;
      var1 = this.afterNextStep;
      var1.totalLength = var1.totalLength - this.bpAfterTrailing;
   ...
   void endRow(int rowIndex) {
      if (this.endsOnRow(rowIndex)) {
         Step var2 = this.nextStep;
         var2.totalLength = var2.totalLength - this.bpAfterTrailing;
