...
public class ExternalDocumentLayoutManager extends AbstractPageSequenceLayoutManager {
   ...
   public void activateLayout() {
      ...
      String uri = URISpecification.getURL(this.getExternalDocument().getSrc());
   ...
   private void fillPage(String uri) {
      ...
      blockArea.setChangeBarList(this.getChangeBarList());
      ...
      InlineViewport vp = new InlineViewport(imageArea, this.fobj.getBidiLevel());
   ...
   protected Page createPage(int pageNumber, boolean isBlank) {
      ...
      CTM pageCTM = CTM.getCTMandRelDims(this.pageSeq.getReferenceOrientation(), WritingMode.LR_TB, referenceRect, reldims);
