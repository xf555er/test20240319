...
public class DefaultEventBroadcaster implements EventBroadcaster {
   ...
   private static synchronized EventProducerModel getEventProducerModel(Class clazz) {
      Iterator var1 = eventModels.iterator();

      EventProducerModel producerModel;
      do {
         if (!var1.hasNext()) {
         ...
         Object eventModel1 = var1.next();
         EventModel eventModel = (EventModel)eventModel1;
         producerModel = eventModel.getProducer(clazz);
      } while(producerModel == null);
         ...
         return (EventProducer)Proxy.newProxyInstance(clazz.getClassLoader(), new Class[]{clazz}, new InvocationHandler() {
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
               ...
               if (methodModel == null) {
                  ...
                  for(Iterator var9 = methodModel.getParameters().iterator(); var9.hasNext(); ++i) {
                     Object o = var9.next();
                     EventMethodModel.Parameter param = (EventMethodModel.Parameter)o;
