...
public final class FOPropertyMapping implements Constants {
   ...
   public static String getPropertyName(int id) {
      return (id & -512) != 0 && (id & 511) != 0 ? (String)propIds.get(id & 511) + "." + (String)propIds.get(id & -512) : (String)propIds.get(id);
   }
   ...
   private void createBorderPaddingBackgroundProperties() {
      ...
      m.setInherited(false);
      m.setDefault("black");
      m.addShorthand(generics[52]);
      m.addShorthand(generics[32]);
      m.addShorthand(generics[18]);
      corr = new CorrespondingPropertyMaker(m);
   ...
   private void createFontProperties() {
      ...
      m.setInherited(true);
      m.addEnum("normal", this.getEnumProperty(97, "NORMAL"));
      m.addEnum("italic", this.getEnumProperty(162, "ITALIC"));
      m.addEnum("oblique", this.getEnumProperty(163, "OBLIQUE"));
      m.addEnum("backslant", this.getEnumProperty(164, "BACKSLANT"));
      m.setDefault("normal");
      m.addShorthand(generics[100]);
      ...
      m.addEnum("bolder", this.getEnumProperty(165, "BOLDER"));
      m.addEnum("lighter", this.getEnumProperty(166, "LIGHTER"));
      m.addEnum("100", this.getEnumProperty(167, "100"));
      m.addEnum("200", this.getEnumProperty(168, "200"));
      m.addEnum("300", this.getEnumProperty(169, "300"));
      m.addEnum("400", this.getEnumProperty(170, "400"));
      m.addEnum("500", this.getEnumProperty(171, "500"));
      m.addEnum("600", this.getEnumProperty(172, "600"));
      m.addEnum("700", this.getEnumProperty(173, "700"));
      m.addEnum("800", this.getEnumProperty(174, "800"));
      m.addEnum("900", this.getEnumProperty(175, "900"));
      m.setDefault("400");
      m.addShorthand(generics[100]);
   ...
   private void createHyphenationProperties() {
      ...
      PropertyMaker m = new OptionalCharacterProperty.Maker(117);
      m.setInherited(true);
      m.setDefault("-");
   ...
   private Property makeWritingModeDependentEnum(int pv) {
      if (pv == 135) {
         ...
         return pv == 39 ? this.getEnumProperty(39, "END") : null;
      }
   }
         ...
         private Property calcRelative(PropertyList propertyList) throws PropertyException {
            ...
            if (corresponding == null) {
               ...
               if (correspondingValue == 70) {
                  ...
                  return FOPropertyMapping.this.getEnumProperty(135, "START");
               } else if (correspondingValue == 23) {
                  return FOPropertyMapping.this.getEnumProperty(23, "CENTER");
               } else if (correspondingValue == 73) {
                  return FOPropertyMapping.this.calcWritingModeDependent(73, propertyList.get(267).getEnum());
               } else {
                  return correspondingValue == 120 ? FOPropertyMapping.this.calcWritingModeDependent(120, propertyList.get(267).getEnum()) : null;
               }
            }
         }
      };
   ...
   private void createCharacterProperties() {
      ...
      PropertyMaker m = new TextDecorationMaker(248);
      m.setInherited(false);
      m.addEnum("none", this.getEnumProperty(95, "NONE"));
   ...
   private void createKeepsAndBreaksProperties() {
      ...
      PropertyMaker m = new LengthProperty.Maker(270);
      m.setInherited(true);
      m.setDefault("0pt");
      addPropertyMaker("fox:widow-content-limit", m);
      m = new LengthProperty.Maker(271);
      m.setInherited(true);
      m.setDefault("0pt");
   ...
   private void createDynamicProperties() {
      ...
      m.setInherited(false);
      m.addEnum("new", this.getEnumProperty(188, "NEW"));
      m.addEnum("replace", this.getEnumProperty(187, "REPLACE"));
      ...
      m = new StringProperty.Maker(238);
      m.setInherited(false);
   ...
   private void createMarkersProperties() {
      ...
      m.setInherited(false);
      m.addEnum("first-starting", this.getEnumProperty(189, "FIRST_STARTING"));
      m.addEnum("first-including-carryover", this.getEnumProperty(204, "FIRST_INCLUDING_CARRYOVER"));
      m.addEnum("last-starting", this.getEnumProperty(190, "LAST_STARTING"));
      m.addEnum("last-ending", this.getEnumProperty(191, "LAST_ENDING"));
      m.setDefault("first-starting");
      addPropertyMaker("retrieve-position-within-table", m);
      m = new EnumProperty.Maker(206);
      m.setInherited(false);
      m.addEnum("table", this.getEnumProperty(192, "TABLE"));
      m.addEnum("table-fragment", this.getEnumProperty(193, "TABLE_FRAGMENT"));
      m.addEnum("page", this.getEnumProperty(104, "PAGE"));
      m.setDefault("table");
   ...
   private void createNumberToStringProperties() {
      ...
      m = new StringProperty.Maker(288);
      m.setInherited(false);
      m.setDefault("");
   ...
   private void createPaginationAndLayoutProperties() {
      ...
      m.addEnum("any", this.getEnumProperty(8, "ANY"));
      m.addEnum("only", this.getEnumProperty(184, "ONLY"));
      m.setDefault("any");
   ...
   private void createWritingModeProperties() {
      ...
      m.addEnum("tb-lr", this.getEnumProperty(203, "TB_LR"));
   ...
   private void createChangeBarProperties() {
      PropertyMaker m = new StringProperty.Maker(63);
      m.setInherited(false);
      m.setDefault("");
      addPropertyMaker("change-bar-class", m);
      PropertyMaker m = new ColorProperty.Maker(64);
      m.setInherited(true);
      m.setDefault("black");
      addPropertyMaker("change-bar-color", m);
      PropertyMaker m = new EnumProperty.Maker(66);
      m.setInherited(true);
      m.setDefault("start");
      m.addEnum("start", this.getEnumProperty(135, "START"));
      m.addEnum("end", this.getEnumProperty(39, "END"));
      m.addEnum("left", this.getEnumProperty(73, "LEFT"));
      m.addEnum("right", this.getEnumProperty(120, "RIGHT"));
      m.addEnum("inside", this.getEnumProperty(68, "INSIDE"));
      m.addEnum("outside", this.getEnumProperty(102, "OUTSIDE"));
      m.addEnum("alternate", this.getEnumProperty(198, "ALTERNATE"));
      addPropertyMaker("change-bar-placement", m);
      m = new EnumProperty.Maker(67);
      m.useGeneric(this.genericBorderStyle);
      m.setInherited(true);
      m.setDefault("solid");
      addPropertyMaker("change-bar-style", m);
      PropertyMaker m = new LengthProperty.Maker(68);
      m.setInherited(true);
      m.setDefault("6pt");
      addPropertyMaker("change-bar-width", m);
      m = new LengthProperty.Maker(65);
      m.setInherited(true);
      m.setDefault("6pt");
   ...
   private void createMiscProperties() {
      ...
      m = new StringProperty.Maker(273);
      m.setInherited(false);
      m.setDefault("");
      addPropertyMaker("fox:alt-text", m);
      m = new StringProperty.Maker(294);
      m.setInherited(false);
      m.setDefault("");
      addPropertyMaker("fox:abbreviation", m);
      PropertyMaker m = new EnumProperty.Maker(291);
      m.setInherited(false);
      m.addEnum("select-first-fitting", this.getEnumProperty(205, "SELECT_FIRST_FITTING"));
      m.setDefault("select-first-fitting");
      addPropertyMaker("fox:auto-toggle", m);
      PropertyMaker m = new LengthProperty.Maker(292);
      m.setInherited(false);
      m.setDefault("0pt");
      addPropertyMaker("fox:background-image-width", m);
      m = new LengthProperty.Maker(293);
      m.setInherited(false);
      m.setDefault("0pt");
      addPropertyMaker("fox:background-image-height", m);
      PropertyMaker m = new CondLengthProperty.Maker(275);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[284]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-before-radius-start", m);
      m = new CondLengthProperty.Maker(276);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[285]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-before-radius-end", m);
      m = new CondLengthProperty.Maker(277);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[286]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-after-radius-start", m);
      m = new CondLengthProperty.Maker(278);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[287]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-after-radius-end", m);
      m = new CondLengthProperty.Maker(279);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[284]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-start-radius-before", m);
      m = new CondLengthProperty.Maker(280);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[286]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-start-radius-after", m);
      m = new CondLengthProperty.Maker(281);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[285]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-end-radius-before", m);
      m = new CondLengthProperty.Maker(282);
      m.useGeneric(this.genericCondCornerRadius);
      m.addShorthand(generics[287]);
      m.addShorthand(generics[283]);
      m.getSubpropMaker(1024).setDefault("discard");
      addPropertyMaker("fox:border-end-radius-after", m);
      m = new LengthProperty.Maker(196);
      m.setInherited(true);
      m.setDefault("6pt");
      m.setPercentBase(5);
      ...
      m = new EnumProperty.Maker(217);
      m.useGeneric(this.genericBoolean);
      m.setInherited(true);
      m.setDefault("true");
      addPropertyMaker("score-spaces", m);
      PropertyMaker m = new URIProperty.Maker(232);
      m.setInherited(false);
      m.setDefault("");
      ...
      m = new StringProperty.Maker(290);
      m.setInherited(false);
      m.setDefault("");
   ...
   private void createShorthandProperties() {
      ...
      m.setInherited(true);
      m.addEnum("caption", this.getEnumProperty(178, "CAPTION"));
      m.addEnum("icon", this.getEnumProperty(179, "ICON"));
      m.addEnum("message-box", this.getEnumProperty(181, "MESSAGE_BOX"));
      m.addEnum("menu", this.getEnumProperty(180, "MENU"));
      m.addEnum("small-caption", this.getEnumProperty(182, "SMALL_CAPTION"));
      m.addEnum("status-bar", this.getEnumProperty(183, "STATUS_BAR"));
      m.setDefault("");
      ...
      m.addEnum("avoid", this.getEnumProperty(176, "AVOID"));
      m.addEnum("left", this.getEnumProperty(73, "LEFT"));
      m.addEnum("right", this.getEnumProperty(120, "RIGHT"));
      m.setDefault("auto");
      ...
      m.setInherited(true);
      m.addEnum("normal", this.getEnumProperty(97, "NORMAL"));
      m.addEnum("pre", this.getEnumProperty(177, "PRE"));
      ...
      PropertyMaker m = new URIProperty.Maker(274);
      m.setInherited(true);
      m.setDefault("");
