...
public class XMLWhiteSpaceHandler {
   ...
   public void handleWhiteSpace(FObjMixed fo, FONode firstTextNode, FONode nextChild) {
      ...
      if (firstTextNode == null) {
         ...
         if (firstTextNode.siblings != null && firstTextNode.siblings[0] != null && firstTextNode.siblings[0].getNameId() == 15) {
            this.inWhiteSpace = ((Float)firstTextNode.siblings[0]).getInWhiteSpace();
         }
         ...
         if (nextChild instanceof Float) {
            ((Float)nextChild).setInWhiteSpace(this.inWhiteSpace);
         }
   ...
   private void addPendingInline() {
      ...
      this.pendingInlines.add(new PendingInline(this.firstWhiteSpaceInSeq));
   }
