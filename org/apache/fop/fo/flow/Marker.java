...
public class Marker extends FObjMixed {
   ...
   public void bind(PropertyList pList) throws FOPException {
      if (this.findAncestor(16) < 0) {
         this.invalidChildError(this.locator, this.getParent().getName(), "http://www.w3.org/1999/XSL/Format", this.getLocalName(), "rule.markerDescendantOfFlow");
      }
   ...
   public static final class MarkerAttribute {
      ...
      private static MarkerAttribute getInstance(String namespace, String qname, String name, String value) {
         return (MarkerAttribute)CACHE.fetch(new MarkerAttribute(namespace, qname, name, value));
      }
      ...
      public boolean equals(Object o) {
         if (this == o) {
            ...
            return attr.namespace != null && attr.namespace.equals(this.namespace) && attr.qname != null && attr.qname.equals(this.qname) && attr.name != null && attr.name.equals(this.name) && attr.value != null && attr.value.equals(this.value);
         }
      }
   }
