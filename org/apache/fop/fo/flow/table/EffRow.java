...
public class EffRow {
   ...
   public EffRow(int index, int bodyType, List gridUnits) {
      ...
      Iterator var4 = gridUnits.iterator();
   ...
   public Keep getKeepWithPrevious() {
      ...
      Iterator var3 = this.gridUnits.iterator();

      while(var3.hasNext()) {
         Object gridUnit = var3.next();
   ...
   public int getBreakBefore() {
      int breakBefore = 9;
      Iterator var2 = this.gridUnits.iterator();

      while(var2.hasNext()) {
         Object gridUnit = var2.next();
         GridUnit gu = (GridUnit)gridUnit;
         if (gu.isPrimary()) {
