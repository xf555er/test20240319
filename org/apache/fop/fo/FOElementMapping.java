...
public class FOElementMapping extends ElementMapping {
   ...
   protected void initialize() {
      if (this.foObjs == null) {
         ...
         this.foObjs.put("change-bar-begin", new ChangeBarBeginMaker());
         this.foObjs.put("change-bar-end", new ChangeBarEndMaker());
      }
   ...
   static class ChangeBarEndMaker extends ElementMapping.Maker {
      public FONode make(FONode parent) {
         return new ChangeBarEnd(parent);
      }
   }

   static class ChangeBarBeginMaker extends ElementMapping.Maker {
      public FONode make(FONode parent) {
         return new ChangeBarBegin(parent);
      }
   }
   ...
   static class PageSequenceMasterMaker extends ElementMapping.Maker {
      public FONode make(FONode parent) {
         return new PageSequenceMaster(parent, BlockLevelEventProducer.Provider.get(parent.getUserAgent().getEventBroadcaster()));
      }
   }
