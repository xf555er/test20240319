...
public class LengthRangeProperty extends Property implements CompoundDatatype {
   ...
   public int hashCode() {
      int prime = true;
      int result = 1;
      result = 31 * result + this.bfSet;
      result = 31 * result + (this.consistent ? 1231 : 1237);
      result = 31 * result + CompareUtil.getHashCode(this.minimum);
      result = 31 * result + CompareUtil.getHashCode(this.optimum);
      result = 31 * result + CompareUtil.getHashCode(this.maximum);
      return result;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof LengthRangeProperty)) {
         return false;
      } else {
         LengthRangeProperty other = (LengthRangeProperty)obj;
         return this.bfSet == other.bfSet && this.consistent == other.consistent && CompareUtil.equal(this.minimum, other.minimum) && CompareUtil.equal(this.optimum, other.optimum) && CompareUtil.equal(this.maximum, other.maximum);
      }
   }
