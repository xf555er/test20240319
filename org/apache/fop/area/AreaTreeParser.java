...
public class AreaTreeParser {
   ...
   private static class Handler extends DefaultHandler {
         ...
         while(true) {
            ...
            if (value != null) {
               ...
               if (cl == Integer.class) {
                  ...
                  if (Trait.PROD_ID.equals(trait) && !this.idFirstsAssigned.contains(value) && this.currentPageViewport != null) {
            ...
            } else if (Trait.FONT.equals(trait)) {
      ...
      static {
         SUBSET_COMMON = new Object[]{Trait.PROD_ID, Trait.LAYER};
      ...
      private class InlineViewportMaker extends AbstractMaker {
         ...
         public void startElement(Attributes attributes) {
            ...
            InlineViewport viewport = new InlineViewport((Area)null, level);
      ...
      private class ContainerMaker extends AbstractMaker {
         ...
         public void startElement(Attributes attributes) {
            ...
            AreaTreeParser.Handler.transferForeignObjects(attributes, container);
      ...
      private class SpaceMaker extends AbstractMaker {
         ...
         public void endElement() {
            ...
            if (Handler.this.content.position() > 0) {
               ...
               SpaceArea spacex = new SpaceArea(offset, level, Handler.this.content.charAt(0), adjustable);
               AbstractTextArea text = Handler.this.getCurrentText();
               spacex.setParentArea(text);
               text.addChildArea(spacex);
            } else {
               Space space = new Space();
               Handler.this.setAreaAttributes(Handler.this.lastAttributes, space);
               Handler.this.setTraits(Handler.this.lastAttributes, space, AreaTreeParser.Handler.SUBSET_COMMON);
               Handler.this.setTraits(Handler.this.lastAttributes, space, AreaTreeParser.Handler.SUBSET_BOX);
               Handler.this.setTraits(Handler.this.lastAttributes, space, AreaTreeParser.Handler.SUBSET_COLOR);
      ...
      private class WordMaker extends AbstractMaker {
         ...
         public void endElement() {
            ...
            Handler.this.content.flip();
            WordArea word = new WordArea(offset, level, Handler.this.content.toString().trim(), letterAdjust, (int[])null, gposAdjustments, reversed);
            AbstractTextArea text = Handler.this.getCurrentText();
      ...
      private class InlineBlockMaker extends AbstractMaker {
         ...
         public void startElement(Attributes attributes) {
            ...
            AreaTreeParser.Handler.transferForeignObjects(attributes, block);
            Handler.this.setAreaAttributes(attributes, block);
            Handler.this.setTraits(attributes, block, AreaTreeParser.Handler.SUBSET_COMMON);
            Handler.this.setTraits(attributes, block, AreaTreeParser.Handler.SUBSET_BOX);
            Handler.this.setTraits(attributes, block, AreaTreeParser.Handler.SUBSET_COLOR);
            Area parent = (Area)Handler.this.areaStack.peek();
      ...
      private class BlockMaker extends AbstractMaker {
         ...
         public void startElement(Attributes attributes) {
            ...
            if (attributes.getValue("visibility") != null) {
               ((Block)block).addTrait(Trait.VISIBILITY, Visibility.valueOf(attributes.getValue("visibility")));
            }
