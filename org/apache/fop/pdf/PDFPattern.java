...
public class PDFPattern extends PDFPathPaint {
   ...
   public int output(OutputStream stream) throws IOException {
      ...
      if (this.patternType == 1) {
         ...
         p.append("/XStep " + PDFNumber.doubleOut(this.xStep) + " \n");
         p.append("/YStep " + PDFNumber.doubleOut(this.yStep) + " \n");
         if (this.matrix != null) {
         ...
         if (this.patternDataStream != null) {
            ...
            pdfStream.setObjectNumber(this.getObjectNumber());
            pdfStream.getFilterList().addDefaultFilters(this.getDocument().getFilterMap(), "content");
            this.getDocument().applyEncryption(pdfStream);
