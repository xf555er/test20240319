            ...
            do {
               ...
               for(int i = 0; i < entriesThisSection; ++i) {
                  ...
                  if (Character.codePointAt(charArray, charIndex) > 65535) {
                     StringBuilder var10000 = (new StringBuilder()).append(Integer.toHexString(charArray[charIndex]));
                     ++charIndex;
                     String pairs = var10000.append(Integer.toHexString(charArray[charIndex])).toString();
