...
public class LengthBase implements PercentBase {
   ...
   public int hashCode() {
      int prime = true;
      int result = 1;
      result = 31 * result + CompareUtil.getHashCode(this.baseLength);
      result = 31 * result + this.baseType;
      result = 31 * result + CompareUtil.getHashCode(this.fobj);
      return result;
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof LengthBase)) {
         return false;
      } else {
         LengthBase other = (LengthBase)obj;
         return CompareUtil.equal(this.baseLength, other.baseLength) && this.baseType == other.baseType && CompareUtil.equal(this.fobj, other.fobj);
      }
   }
}
