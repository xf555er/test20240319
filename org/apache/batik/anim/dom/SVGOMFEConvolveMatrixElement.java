...
public class SVGOMFEConvolveMatrixElement extends SVGOMFilterPrimitiveStandardAttributes implements SVGFEConvolveMatrixElement {
   ...
   static {
      ...
      t.put((Object)null, "order", new TraitInformation(true, 4));
      t.put((Object)null, "kernelUnitLength", new TraitInformation(true, 4));
      t.put((Object)null, "kernelMatrix", new TraitInformation(true, 13));
      t.put((Object)null, "divisor", new TraitInformation(true, 2));
      t.put((Object)null, "bias", new TraitInformation(true, 2));
      t.put((Object)null, "targetX", new TraitInformation(true, 1));
      t.put((Object)null, "targetY", new TraitInformation(true, 1));
      t.put((Object)null, "edgeMode", new TraitInformation(true, 15));
      t.put((Object)null, "preserveAlpha", new TraitInformation(true, 49));
