...
public class SVGOMFilterElement extends SVGStylableElement implements SVGFilterElement {
   ...
   static {
      ...
      t.put((Object)null, "filterUnits", new TraitInformation(true, 15));
      t.put((Object)null, "primitiveUnits", new TraitInformation(true, 15));
      ...
      t.put((Object)null, "filterRes", new TraitInformation(true, 4));
