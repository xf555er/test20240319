...
public class SVGOMTextPathElement extends SVGOMTextContentElement implements SVGTextPathElement {
   ...
   private void initializeLiveAttributes() {
      ...
      this.startOffset = this.createLiveAnimatedLength((String)null, "startOffset", "0", (short)0, false);
   ...
   static {
      ...
      t.put((Object)null, "method", new TraitInformation(true, 15));
      t.put((Object)null, "spacing", new TraitInformation(true, 15));
      t.put((Object)null, "startOffset", new TraitInformation(true, 3));
