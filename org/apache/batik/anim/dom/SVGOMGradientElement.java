...
public abstract class SVGOMGradientElement extends SVGStylableElement implements SVGGradientElement {
   ...
   static {
      ...
      t.put((Object)null, "gradientUnits", new TraitInformation(true, 15));
      t.put((Object)null, "spreadMethod", new TraitInformation(true, 15));
      t.put((Object)null, "gradientTransform", new TraitInformation(true, 9));
