...
public class SVGOMPatternElement extends SVGStylableElement implements SVGPatternElement {
   ...
   static {
      ...
      t.put((Object)null, "patternUnits", new TraitInformation(true, 15));
      t.put((Object)null, "patternContentUnits", new TraitInformation(true, 15));
      t.put((Object)null, "patternTransform", new TraitInformation(true, 9));
