...
public abstract class SVGOMComponentTransferFunctionElement extends SVGOMElement implements SVGComponentTransferFunctionElement {
   ...
   static {
      ...
      t.put((Object)null, "tableValues", new TraitInformation(true, 13));
      t.put((Object)null, "slope", new TraitInformation(true, 2));
      t.put((Object)null, "intercept", new TraitInformation(true, 2));
      t.put((Object)null, "amplitude", new TraitInformation(true, 2));
      t.put((Object)null, "exponent", new TraitInformation(true, 2));
      t.put((Object)null, "offset", new TraitInformation(true, 2));
