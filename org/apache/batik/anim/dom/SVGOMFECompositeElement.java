...
public class SVGOMFECompositeElement extends SVGOMFilterPrimitiveStandardAttributes implements SVGFECompositeElement {
   ...
   static {
      ...
      t.put((Object)null, "k1", new TraitInformation(true, 2));
      t.put((Object)null, "k2", new TraitInformation(true, 2));
      t.put((Object)null, "k3", new TraitInformation(true, 2));
      t.put((Object)null, "k4", new TraitInformation(true, 2));
