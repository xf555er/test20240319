...
public class BatikStarElementBridge extends SVGDecoratedShapeElementBridge implements BatikExtConstants {
   ...
   protected void buildShape(BridgeContext ctx, Element e, ShapeNode shapeNode) {
      ...
      if (s.length() == 0) {
         ...
         s = e.getAttributeNS((String)null, "ir");
         if (s.length() == 0) {
            throw new BridgeException(ctx, e, "attribute.missing", new Object[]{"ir", s});
         } else {
            float ir = org.apache.batik.bridge.UnitProcessor.svgOtherLengthToUserSpace(s, "ir", uctx);
            int sides = convertSides(e, "sides", 3, ctx);
            GeneralPath gp = new GeneralPath();
            double SECTOR = 6.283185307179586 / (double)sides;
