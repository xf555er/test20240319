...
public class SVGCSSEngine extends CSSEngine {
   ...
   public SVGCSSEngine(Document doc, ParsedURL uri, ExtendedParser p, CSSContext ctx) {
      super(doc, uri, p, SVG_VALUE_MANAGERS, SVG_SHORTHAND_MANAGERS, (String[])null, (String)null, "style", (String)null, "class", true, (String)null, ctx);
   ...
   public SVGCSSEngine(Document doc, ParsedURL uri, ExtendedParser p, ValueManager[] vms, ShorthandManager[] sms, CSSContext ctx) {
      super(doc, uri, p, mergeArrays(SVG_VALUE_MANAGERS, vms), mergeArrays(SVG_SHORTHAND_MANAGERS, sms), (String[])null, (String)null, "style", (String)null, "class", true, (String)null, ctx);
      this.lineHeightIndex = this.fontSizeIndex;
   }
   ...
   protected SVGCSSEngine(Document doc, ParsedURL uri, ExtendedParser p, ValueManager[] vms, ShorthandManager[] sms, String[] pe, String sns, String sln, String cns, String cln, boolean hints, String hintsNS, CSSContext ctx) {
      super(doc, uri, p, mergeArrays(SVG_VALUE_MANAGERS, vms), mergeArrays(SVG_SHORTHAND_MANAGERS, sms), pe, sns, sln, cns, cln, hints, hintsNS, ctx);
      this.lineHeightIndex = this.fontSizeIndex;
   }
