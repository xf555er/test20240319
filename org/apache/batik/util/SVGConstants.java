...
public interface SVGConstants extends CSSConstants, XMLConstants {
   ...
   String SVG_CLIP_PATH_ATTRIBUTE = "clip-path";
   String SVG_CLIP_PATH_UNITS_ATTRIBUTE = "clipPathUnits";
   String SVG_COLOR_INTERPOLATION_ATTRIBUTE = "color-interpolation";
   String SVG_COLOR_RENDERING_ATTRIBUTE = "color-rendering";
   ...
   String SVG_ENABLE_BACKGROUND_ATTRIBUTE = "enable-background";
   ...
   String SVG_FILL_OPACITY_ATTRIBUTE = "fill-opacity";
   String SVG_FILL_RULE_ATTRIBUTE = "fill-rule";
   String SVG_FILTER_ATTRIBUTE = "filter";
   String SVG_FILTER_RES_ATTRIBUTE = "filterRes";
   String SVG_FILTER_UNITS_ATTRIBUTE = "filterUnits";
   String SVG_FLOOD_COLOR_ATTRIBUTE = "flood-color";
   String SVG_FLOOD_OPACITY_ATTRIBUTE = "flood-opacity";
   String SVG_FORMAT_ATTRIBUTE = "format";
   String SVG_FONT_FAMILY_ATTRIBUTE = "font-family";
   String SVG_FONT_SIZE_ATTRIBUTE = "font-size";
   String SVG_FONT_STRETCH_ATTRIBUTE = "font-stretch";
   String SVG_FONT_STYLE_ATTRIBUTE = "font-style";
   String SVG_FONT_VARIANT_ATTRIBUTE = "font-variant";
   String SVG_FONT_WEIGHT_ATTRIBUTE = "font-weight";
   ...
   String SVG_IMAGE_RENDERING_ATTRIBUTE = "image-rendering";
   ...
   String SVG_MASK_ATTRIBUTE = "mask";
   ...
   String SVG_OPACITY_ATTRIBUTE = "opacity";
   ...
   String SVG_SHAPE_RENDERING_ATTRIBUTE = "shape-rendering";
   ...
   String SVG_STROKE_DASHARRAY_ATTRIBUTE = "stroke-dasharray";
   String SVG_STROKE_DASHOFFSET_ATTRIBUTE = "stroke-dashoffset";
   String SVG_STROKE_LINECAP_ATTRIBUTE = "stroke-linecap";
   String SVG_STROKE_LINEJOIN_ATTRIBUTE = "stroke-linejoin";
   String SVG_STROKE_MITERLIMIT_ATTRIBUTE = "stroke-miterlimit";
   String SVG_STROKE_OPACITY_ATTRIBUTE = "stroke-opacity";
   String SVG_STROKE_WIDTH_ATTRIBUTE = "stroke-width";
   ...
   String SVG_TEXT_RENDERING_ATTRIBUTE = "text-rendering";
   ...
   String SVG_CLIP_PATH_CLIP_PATH_UNITS_DEFAULT_VALUE = "userSpaceOnUse";
   ...
   String SVG_FE_COMPOSITE_OPERATOR_DEFAULT_VALUE = "over";
   String SVG_FE_CONVOLVE_MATRIX_EDGE_MODE_DEFAULT_VALUE = "duplicate";
   ...
   String SVG_FILTER_FILTER_UNITS_DEFAULT_VALUE = "userSpaceOnUse";
   ...
   String SVG_FILTER_PRIMITIVE_UNITS_DEFAULT_VALUE = "userSpaceOnUse";
   String SVG_FILTER_WIDTH_DEFAULT_VALUE = "120%";
   String SVG_FILTER_X_DEFAULT_VALUE = "-10%";
   String SVG_FILTER_Y_DEFAULT_VALUE = "-10%";
   String SVG_FONT_FACE_FONT_STRETCH_DEFAULT_VALUE = "normal";
   String SVG_FONT_FACE_FONT_STYLE_DEFAULT_VALUE = "all";
   String SVG_FONT_FACE_FONT_VARIANT_DEFAULT_VALUE = "normal";
   String SVG_FONT_FACE_FONT_WEIGHT_DEFAULT_VALUE = "all";
   ...
   String SVG_MASK_MASK_UNITS_DEFAULT_VALUE = "userSpaceOnUse";
   ...
   String SVG_SCRIPT_TYPE_DEFAULT_VALUE = "text/ecmascript";
