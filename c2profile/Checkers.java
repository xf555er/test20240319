...
public class Checkers {
   ...
   public static final boolean isKeyloggerMethod(String var0) {
      Set var1 = CommonUtils.toSet("GetAsyncKeyState, SetWindowsHookEx");
      return var1.contains(var0);
   }

   public static final boolean isAllocatorRDLL(String var0) {
      Set var1 = CommonUtils.toSet("VirtualAlloc, HeapAlloc, MapViewOfFile");
      return var1.contains(var0);
   }
}
