...
public class TeamServer extends Starter {
   ...
   private final void B() {
      ...
      try {
         ...
         this.c2profile.addParameter(".watermarkHash", this.auth.getWatermarkHash());
   ...
   private static final void A() {
      ...
      while(var2.hasNext()) {
         ...
         if (var3 != null && var3.toLowerCase().contains("-javaagent:")) {
            CommonUtils.print_error("The Cobalt Strike Team Server process cannot be started with a javaagent.");
            System.exit(1);
         }
      }
