...
public class Listeners implements ServerHook {
   ...
   public void call(Request var1, ManageUser var2) {
      ...
      if (var1.is("listeners.create", 2)) {
         ...
         CommonUtils.print_warn("Listeners: listeners.remove: isBeacon: " + isBeacon(var4));
         if (isBeacon(var4)) {
         ...
         CommonUtils.print_warn("Listeners: listeners.restart: isBeacon: " + isBeacon(var4));
         if (isBeacon(var4)) {
         ...
         CommonUtils.print_warn("Listeners: listeners.stop: isBeacon: " + isBeacon(var4));
         if (isBeacon(var4)) {
            this.resources.call("beacons.stop", CommonUtils.args(var4));
         }
