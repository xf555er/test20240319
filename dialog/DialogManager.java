...
public class DialogManager {
   ...
   public DialogRow interfaces(String var1, String var2, TeamQueue var3, DataManager var4) {
      ...
      var7.addActionListener(new _A((JComboBox)var6.c[1], var3, var4));
      var6.last(var7);
      return var6;
   }
   ...
   public DialogRow list(final String var1, String var2, String var3, int var4) {
      ...
      DialogRow var19 = new DialogRow(new JLabel(var2), var6, var17);
      this.rows.add(var19);
      if (this.group != null) {
   ...
   private static class _A implements ActionListener, Callback {
      protected JComboBox ī;
      protected TeamQueue Ĭ;
      protected DataManager ĭ;
      ...
      public void actionPerformed(ActionEvent var1) {
         InterfaceDialog var2 = new InterfaceDialog(this.Ĭ, this.ĭ);
         var2.notify(this);
         var2.show();
      }
      ...
      public void result(String var1, final Object var2) {
         CommonUtils.runSafe(new Runnable() {
            public void run() {
               _A.this.ī.addItem(var2 + "");
               _A.this.ī.setSelectedItem(var2 + "");
            }
         });
      }
   }
