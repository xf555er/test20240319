...
public class BeaconErrors {
   public static String toString(int var0, int var1, int var2, String var3) {
      switch (var0) {
         ...
         case 76:
            return "could not resolve API " + var3;
         case 77:
            return "relocation truncated to fit (distance between executable code and other data is >4GB)";
         case 78:
            return "no slot for function (reduce number of Win32 APIs called)";
         case 79:
            return "un-implemented relocation type: " + var1;
      }
   }
}
