...
public class PayloadGeneratorStageDialog implements DialogListener, SafeDialogCallback {
   ...
   public void dialogAction(ActionEvent var1, Map var2) {
      ...
      ScListener var6 = ListenerUtils.getListener(this.client, var5);
      if (var6 == null) {
         ...
         if (this.stager.length != 0) {
            Map var7 = DialogUtils.toMap("ASPX: aspx, C: c, C#: cs, HTML Application: hta, Java: java, Perl: pl, PowerShell: ps1, PowerShell Command: txt, Python: py, Raw: bin, Ruby: rb, COM Scriptlet: sct, Veil: txt, VBA: vba");
            String var8 = DialogUtils.string(var2, "format");
            String var9 = "payload." + var7.get(var8);
            SafeDialogs.saveFile((JFrame)null, var9, this);
         }
      }
   }
