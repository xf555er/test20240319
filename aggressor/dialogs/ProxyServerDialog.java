...
public class ProxyServerDialog extends AObject implements DialogListener {
   ...
   public void show() {
      ...
      this.dialog.add(DialogUtils.description("<html><body><font color=\"red\">WARNING:</font> These values are placed inside of your Beacon payload AND they are recoverable.</body></html>"), "North");
