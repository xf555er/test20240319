...
class FactoryFinder {
   ...
   private static ClassLoader findClassLoader() throws ConfigurationError {
      ...
      try {
         ...
         return (class$javax$xml$transform$FactoryFinder == null ? (class$javax$xml$transform$FactoryFinder = class$("javax.xml.transform.FactoryFinder")) : class$javax$xml$transform$FactoryFinder).getClassLoader();
      }
