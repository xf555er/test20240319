...
public class ListenerUtils {
   ...
   public static Map dialogToMap(Map var0) {
      ...
      if ("Beacon HTTP".equals(var3)) {
         ...
         var1.put("maxretry", DialogUtils.string(var0, "http_retry"));
         ...
         var1.put("maxretry", DialogUtils.string(var0, "https_retry"));
         ...
         var1.put("maxretry", DialogUtils.string(var0, "dns_retry"));
   ...
   public static Map mapToDialog(Map var0) {
      ...
      if ("windows/beacon_http/reverse_http".equals(var3)) {
         ...
         var1.put("http_retry", var0.get("maxretry"));
         ...
         var1.put("https_retry", var0.get("maxretry"));
         ...
         var1.put("dns_retry", var0.get("maxretry"));
