...
public class DefaultDigestAlgorithmIdentifierFinder implements DigestAlgorithmIdentifierFinder {
   ...
   private static void addDigestAlgId(ASN1ObjectIdentifier var0, boolean var1) {
      AlgorithmIdentifier var2;
      if (var1) {
         var2 = new AlgorithmIdentifier(var0, DERNull.INSTANCE);
      } else {
         var2 = new AlgorithmIdentifier(var0);
      }

      digestOidToAlgIds.put(var0, var2);
   }
   ...
   public AlgorithmIdentifier find(AlgorithmIdentifier var1) {
      ...
      if (var2.equals(EdECObjectIdentifiers.id_Ed448)) {
         ...
         if (var2.equals(PKCSObjectIdentifiers.id_RSASSA_PSS)) {
            var3 = RSASSAPSSparams.getInstance(var1.getParameters()).getHashAlgorithm().getAlgorithm();
         } else if (var2.equals(EdECObjectIdentifiers.id_Ed25519)) {
            var3 = NISTObjectIdentifiers.id_sha512;
         } else {
            var3 = (ASN1ObjectIdentifier)digestOids.get(var1.getAlgorithm());
         }

         return this.find(var3);
      }
   }
   ...
   public AlgorithmIdentifier find(ASN1ObjectIdentifier var1) {
      if (var1 == null) {
         ...
         AlgorithmIdentifier var2 = (AlgorithmIdentifier)digestOidToAlgIds.get(var1);
         return var2 == null ? new AlgorithmIdentifier(var1) : var2;
      }
   }
