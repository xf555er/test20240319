...
public class QTESLAKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCqTESLAPrivateKey) && !(var1 instanceof BCqTESLAPublicKey)) {
