...
import net.jsign.bouncycastle.pqc.asn1.RainbowPrivateKey;
import net.jsign.bouncycastle.pqc.crypto.rainbow.Layer;
import net.jsign.bouncycastle.pqc.crypto.rainbow.util.RainbowUtil;
import net.jsign.bouncycastle.pqc.jcajce.spec.RainbowPrivateKeySpec;
...
public class BCRainbowPrivateKey implements PrivateKey {
   ...
   public int hashCode() {
      ...
      var1 = var1 * 37 + net.jsign.bouncycastle.util.Arrays.hashCode(this.A1inv);
      var1 = var1 * 37 + net.jsign.bouncycastle.util.Arrays.hashCode(this.b1);
      var1 = var1 * 37 + net.jsign.bouncycastle.util.Arrays.hashCode(this.A2inv);
      var1 = var1 * 37 + net.jsign.bouncycastle.util.Arrays.hashCode(this.b2);
      var1 = var1 * 37 + net.jsign.bouncycastle.util.Arrays.hashCode(this.vi);
   ...
   public byte[] getEncoded() {
      ...
      PrivateKeyInfo var2;
      try {
         AlgorithmIdentifier var3 = new AlgorithmIdentifier(PQCObjectIdentifiers.rainbow, DERNull.INSTANCE);
