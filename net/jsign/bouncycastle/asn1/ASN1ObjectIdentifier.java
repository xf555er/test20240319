...
public class ASN1ObjectIdentifier extends ASN1Primitive {
   ...
   public static ASN1ObjectIdentifier getInstance(Object var0) {
      if (var0 != null && !(var0 instanceof ASN1ObjectIdentifier)) {
         ...
         if (var0 instanceof byte[]) {
            ...
            try {
               return (ASN1ObjectIdentifier)fromByteArray(var4);
   ...
   public static ASN1ObjectIdentifier getInstance(ASN1TaggedObject var0, boolean var1) {
      ...
      return !var1 && !(var2 instanceof ASN1ObjectIdentifier) ? fromOctetString(ASN1OctetString.getInstance(var2).getOctets()) : getInstance(var2);
   }
   ...
   void encode(ASN1OutputStream var1, boolean var2) throws IOException {
      var1.writeEncoded(var2, 6, this.getBody());
   }
   ...
   boolean asn1Equals(ASN1Primitive var1) {
      if (var1 == this) {
         ...
         return !(var1 instanceof ASN1ObjectIdentifier) ? false : this.identifier.equals(((ASN1ObjectIdentifier)var1).identifier);
      }
   }
   ...
   private static boolean isValidIdentifier(String var0) {
      if (var0.length() >= 3 && var0.charAt(1) == '.') {
         ...
         return var1 >= '0' && var1 <= '2' ? isValidBranchID(var0, 2) : false;
      } else {
         return false;
      }
   }
   ...
   public ASN1ObjectIdentifier intern() {
      OidHandle var1 = new OidHandle(this.getBody());
   ...
   static ASN1ObjectIdentifier fromOctetString(byte[] var0) {
      ...
      ASN1ObjectIdentifier var2 = (ASN1ObjectIdentifier)pool.get(var1);
      return var2 == null ? new ASN1ObjectIdentifier(var0) : var2;
   }
