...
public class DERIA5String extends ASN1Primitive implements ASN1String {
   ...
   public static DERIA5String getInstance(ASN1TaggedObject var0, boolean var1) {
      ...
      return !var1 && !(var2 instanceof DERIA5String) ? new DERIA5String(ASN1OctetString.getInstance(var2).getOctets()) : getInstance(var2);
   }
   ...
   void encode(ASN1OutputStream var1, boolean var2) throws IOException {
      var1.writeEncoded(var2, 22, this.string);
   }
