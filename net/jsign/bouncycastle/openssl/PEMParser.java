...
import net.jsign.bouncycastle.asn1.pkcs.RSAPrivateKey;
import net.jsign.bouncycastle.asn1.pkcs.RSAPublicKey;
import net.jsign.bouncycastle.asn1.sec.ECPrivateKey;
import net.jsign.bouncycastle.asn1.x509.AlgorithmIdentifier;
import net.jsign.bouncycastle.asn1.x509.DSAParameter;
...
import net.jsign.bouncycastle.pkcs.PKCS10CertificationRequest;
import net.jsign.bouncycastle.pkcs.PKCS8EncryptedPrivateKeyInfo;
import net.jsign.bouncycastle.util.encoders.Hex;
import net.jsign.bouncycastle.util.io.pem.PemHeader;
import net.jsign.bouncycastle.util.io.pem.PemObject;
import net.jsign.bouncycastle.util.io.pem.PemObjectParser;
import net.jsign.bouncycastle.util.io.pem.PemReader;
...
public class PEMParser extends PemReader {
   ...
   private class ECCurveParamsParser implements PemObjectParser {
      ...
      public Object parseObject(PemObject var1) throws IOException {
         try {
            ...
            if (var2 instanceof ASN1ObjectIdentifier) {
               return ASN1Primitive.fromByteArray(var1.getContent());
            } else {
      ...
      // $FF: synthetic method
      ECCurveParamsParser(Object var2) {
         this();
      }
   }
   ...
   private class ECDSAKeyPairParser implements PEMKeyPairParser {
      ...
      // $FF: synthetic method
      ECDSAKeyPairParser(Object var2) {
         this();
      }
   }
   ...
   private class PKCS10CertificationRequestParser implements PemObjectParser {
      ...
      // $FF: synthetic method
      PKCS10CertificationRequestParser(Object var2) {
         this();
      }
   }
   ...
   private class X509AttributeCertificateParser implements PemObjectParser {
      ...
      // $FF: synthetic method
      X509AttributeCertificateParser(Object var2) {
         this();
      }
   }
   ...
   private class X509CertificateParser implements PemObjectParser {
      ...
      // $FF: synthetic method
      X509CertificateParser(Object var2) {
         this();
      }
   }
   ...
   private class X509TrustedCertificateParser implements PemObjectParser {
      ...
      // $FF: synthetic method
      X509TrustedCertificateParser(Object var2) {
         this();
      }
   }
}
