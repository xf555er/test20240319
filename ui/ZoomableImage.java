...
public class ZoomableImage extends JLabel {
   ...
   public ZoomableImage() {
      ...
      var1.add(this.A("25%", 0.25));
      var1.add(this.A("50%", 0.5));
      var1.add(this.A("75%", 0.75));
      var1.add(this.A("100%", 1.0));
      var1.add(this.A("125%", 1.25));
      var1.add(this.A("150%", 1.5));
      var1.add(this.A("200%", 2.0));
      var1.add(this.A("250%", 2.5));
