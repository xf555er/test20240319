         ...
         if (var6 == null || this.classRef != null && (var6.getModifiers() & 8) != 8) {
            if (var6 == null && !var1.getCurrentFrame().isEmpty()) {
               ...
               try {
                  Field var15;
                  try {
                     var15 = var3.getDeclaredField(this.name);
                  } catch (NoSuchFieldException var11) {
                     var15 = var3.getField(this.name);
                  }
                  ...
                  if (var15 != null) {
                     ...
                     var5 = ObjectUtilities.BuildScalar(true, var15.get(var2));
                  } else {
            ...
            MethodCallRequest var7 = new MethodCallRequest(var1, this.getLineNumber(), var6, var4, this.name, var3);
            var7.CallFunction();
            return null;
         }
      }
